...
- `precision = 0` produces an exact requested alpha to two decimal places.
- Higher values of `precision` allow small, controlled variation in alpha.
- For example, `precision = 2` corresponds roughly to two-decimal reproducibility.
