...
are equal. 
Setting 'variance = 0.6' or more may be infeasible, so the function should gracefully adjust the `variance` parameter downwards to achieve PD status.
...
- **_sort_cors_**: Logical. Deprecated. No longer has any effect.
