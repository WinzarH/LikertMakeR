...
```{r fig1, fig.height=3, fig.width=5, fig.align='center', echo = FALSE, crop = TRUE, fig.cap="Example: 4-item, 1-5 Likert scale", fig.alt="Histogram of 4-item, 1-5 Likert scale"}
## distribution of x
hist(x1,
...
```{r fig2, fig.height=3, fig.width=5, fig.align='center', echo = FALSE, crop = TRUE, fig.cap="Example: likelihood-of-purchase scale", fig.alt="Histogram of likelihood-of-purchase scale"}
## generate histogram
hist(x2,
  cex.axis = 0.5, cex.main = 0.75,
...
```{r fig3, fig.height=3, fig.width=5, fig.align='center', echo = TRUE, crop = TRUE, fig.alt="Scree plot of eigenvalues"}
...
```{r fig4, fig.height=3, fig.width=5, fig.align='center', echo = TRUE, crop = TRUE, fig.alt="Cronbach's Alpha and Scree plot of eigenvalues"}
...
```{r fig5, fig.height=5, fig.width=5, fig.align='center', echo=FALSE, warning=FALSE, crop = TRUE, fig.cap="Summary of dataframe from makeItems() function", fig.alt="Correlation matrix"}
# Correlation panel
...
```{r summatedScale_histogram, echo=FALSE, fig.height=3, fig.width=5, fig.align='center', crop = TRUE, fig.cap="Summated scale distribution", fig.alt="Histogram of summated scale"}
...
```{r makeItemsScale_example_1, fig.height=3, fig.width=5, fig.align='center', crop = TRUE, fig.alt="Scree plot of eigenvalues"}
...
```{r makeItemsScale_example_2, fig.height=3, fig.width=5, fig.align='center', crop = TRUE, fig.alt="Scree plot of eigenvalues"}
## apply makeItemsScale() function
...
```{r makeItemsScale_example_3, fig.height=3, fig.width=5, fig.align='center', crop = TRUE, fig.alt="Scree plot of eigenvalues"}
## apply makeItemsScale() function
...
```{r fig6, fig.height=9, fig.width=9, fig.align='center', echo=FALSE, warning=FALSE,  crop = TRUE, fig.alt="Correlation Matrix"}
# Correlation panel
panel.cor <- function(x, y) {
  usr <- par("usr")
  on.exit(par(usr))
...
```{r fig7, fig.height=3, fig.width=5, fig.align='center', echo = TRUE,  crop = TRUE, fig.alt="Scree plot of eigenvalues"}
...
```{r fig7a, fig.height=3, fig.width=5, fig.align='center', echo = TRUE,  crop = TRUE, fig.alt="Scree plot of eigenvalues"}
...
```{r fig8, fig.height=3, fig.width=5, fig.align='center', echo = TRUE, crop = TRUE, fig.alt="Scree plot of eigenvalues"}
