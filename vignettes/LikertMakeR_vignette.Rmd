...
-   **_lfast()_** draws a random sample from a scaled *Beta* distribution. It is very fast but does not guarantee exact mean and standard deviation. Recommended for relatively large sample sizes. 
...
```{r fig6, fig.height=8, fig.width=8, fig.align='center', echo = FALSE}
...
```{r  fig7, fig.height = 7, fig.width = 7, fig.align = 'center', echo = FALSE}
...
```{r fig8, fig.height=8, fig.width=8, fig.align='center', echo = FALSE}
...
```{r  fig9, fig.height = 7, fig.width = 7, fig.align = 'center', echo = FALSE}
