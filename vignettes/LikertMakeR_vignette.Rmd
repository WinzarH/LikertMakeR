...
```{r fig7, fig.height=4, fig.width=4, fig.align='center', echo = TRUE}
...
This is a two-step process:
  ...
  1. apply **_makeCorrAlpha()_** to genereate a correlation matrix from 
   desired alpha,
...
## Generate Items
myItems <- makeItems(n, lowerbound, upperbound, myMeans, mySds, myCorr)
...
```{r fig9, fig.height=5, fig.width=5, fig.align='center', echo=FALSE, warning=FALSE}
...
```{r fig10, fig.height=4, fig.width=4, fig.align='center', echo = TRUE}
