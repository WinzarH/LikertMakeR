...
Observations from this data-frame are:
...
For example, **_lexact()_** executed first example, above, with 
the following sample-size & time combinations on the author's 
...
The **_lcor()_** function in example_1 above had the 
