...
![LikertMakeR_Logo](LikertMakeR_3.png){width=25%}
...
```{r fig1, fig.height=5, fig.width=5, fig.align='center', echo = FALSE, crop = TRUE, fig.cap="Example: 4-item, 1-5 Likert scale", fig.alt="Histogram of 4-item, 1-5 Likert scale"}
## distribution of x
hist(x1,
...
```{r fig2, fig.height=5, fig.width=5, fig.align='center', echo = FALSE, crop = TRUE, fig.cap="Example: likelihood-of-purchase scale", fig.alt="Histogram of likelihood-of-purchase scale"}
## generate histogram
hist(x2,
  cex.axis = 0.5, cex.main = 0.75,
...
```{r fig3, fig.height=5, fig.width=5, fig.align='center', echo = TRUE, crop = TRUE, fig.alt="Scree plot of eigenvalues"}
...
```{r fig4, fig.height=5, fig.width=5, fig.align='center', echo = TRUE, crop = TRUE, fig.alt="Cronbach's Alpha and Scree plot of eigenvalues"}
...
```{r test_makeCorrLoadings, echo=TRUE, fig.alt="Scree plot of item-correlation matrix"}
...
```{r test_orthogonal, echo=TRUE, fig.alt="Scree plot of orthogonal-items correlation matrix"}
...
fig.height=5, fig.width=5, fig.align='center', crop = TRUE, 
...
```{r summatedScale_histogram, echo=FALSE, 
fig.height=5, fig.width=5, fig.align='center', crop = TRUE, 
...
```{r makeItemsScale_example_1, fig.height=5, fig.width=5, fig.align='center', crop = TRUE, fig.alt="Scree plot of eigenvalues"}
...
fig.height=9, fig.width=9, fig.align='center',crop = TRUE, 
fig.alt="Correlation Matrix"}
