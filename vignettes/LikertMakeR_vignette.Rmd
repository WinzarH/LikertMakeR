...
**_lexact()_** can take time to complete the optimisation task. 

**_lexact()_** executed the above example with the following sample-size & time combinations on my Windows 11 (Intel(R) i7-12700H 2.30 GHz) laptop.
...
##### a 7-point negative-to-positive scale with 6 items
...
pairs(new3,
  upper.panel = NULL,
  cex = 1.5, pch = 24, bg = "sky blue", horOdd = TRUE,
...
x1 <- lexact(n, 4.50, 1.00, 1, 7, 1)
x2 <- lexact(n, 5.50, 0.70, 1, 7, 1)
x3 <- lexact(n, 5.25, 1.25, 1, 7, 1)
x4 <- lexact(n, 2.50, 1.25, 1, 7, 1)
x5 <- lexact(n, 4.50, 1.50, 1, 7, 1)
...
tgt5 <- matrix(
  c(
     ...
     0.75,  1.00,  0.50,  0.25, -0.50,
     0.50,  0.50,  1.00,  0.25, -0.50,
