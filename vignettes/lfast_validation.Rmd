...
alt_texts <- c("First image description", "Second image description", "Third image description")

# Conditional rendering
if (knitr::is_html_output()) {
  cat('<div style="display: flex; justify-content: space-around; align-items: flex-start; margin-bottom: 1em;">\n')
...
# colnames(facet_df) <- paste("Facet", 1:n_cols)
...
knitr::include_graphics(c(
  "vignette_files/young_highly_educated_men_dims_histograms.png",
  "vignette_files/young_educated_women_dims_histograms.png",
  "vignette_files/under_18_highschool_dims_histograms.png"
))
```
...
knitr::include_graphics(c(
  "vignette_files/young_highly_educated_men_facets_histograms.png",
  "vignette_files/young_educated_women_facets_histograms.png",
  "vignette_files/under_18_highschool_facets_histograms.png"
))
```
...
knitr::include_graphics(c(
  "vignette_files/selected_items_youngmen.png",
  "vignette_files/selected_items_youngwomen.png",
  "vignette_files/selected_items_highschool.png"
))
```
...
The following tables list the dimension under consideration and the proportion of cases in each of the three samples that were _'statistically significant'_ ($\rho$\ <\ 0.05). 
...
dim_BWS <- readRDS("vignette_files/sig_table_dimensions_BWS.rds")
dim_N <- readRDS("vignette_files/sig_table_dimensions_Neuhauser.rds")
...
dim_BWS <- readRDS("vignette_files/sig_table_facets_BWS.rds")
dim_N <- readRDS("vignette_files/sig_table_facets_Neuhauser.rds")
...
for (i in seq_len(nrow(dim_BWS))) {
  for (j in seq_len(ncol(dim_BWS))) {
    ...
    if (bws > threshold) {
      bws_str <- if (is_html) paste0("<strong>", bws_str, "</strong>") else paste0("**", bws_str, "**")
    }
    if (neu > threshold) {
      neu_str <- if (is_html) paste0("<strong>", neu_str, "</strong>") else paste0("**", neu_str, "**")
    }
...
When the _BWS_ test is applied to the larger sample, all simulations are significantly different from the original data. 
This is probably due to the smaller standard error produced by a larger sample.

Interestingly, the _Neuhäuser_ test, which is less sensitive to outliers, suggested that all simulations are good representations of the original.

The facet, _Introspection_, stands out as one that is rarely accurately reproduced by the `LikertMakeR::lfast()` function, using the _BWS_ test, regardless of sample size. 
...
The following chart shows _kernel density_ plots for facet _Introspection_ in the three samples. 

Each of the 1024 synthetic dataframes is represented by a `r colorize("grey/black line", "#999999")`, and the original _"true"_ dataframe is represented by a `r colorize("blue/cyan line", "#00BFFF")`.
...
knitr::include_graphics(c(
  "vignette_files/Introspection_Density_young_highly_educated_men.png",
  "vignette_files/Introspection_Density_young_educated_women.png",
  "vignette_files/Introspection_Density_under_18_highschool.png"
))
```
...
The original, true, data are highly left-skewed, and this has been nicely captured by the synthetic data. 
...
The following chart shows _kernel density_ plots for facet _Compassion_ in the three samples. 

Again, each of the 1024 synthetic dataframes is represented by a `r colorize("grey/black line", "#999999")`, and the original _"true"_ dataframe is represented by a `r colorize("blue/cyan line", "#00BFFF")`.
...
knitr::include_graphics(c(
  "vignette_files/Compassion_Density_young_highly_educated_men.png",
  "vignette_files/Compassion_Density_young_educated_women.png",
  "vignette_files/Compassion_Density_under_18_highschool.png"
))
```
...
For this factor the _BWS test_ showed no cases where the synthetic data were significantly different from the original data for the smaller sample.
But for the medium and large samples, the original data are not unimodal, and the _BWS test_ suggests that all synthetic replications are different from the original.
...
knitr::include_graphics(c(
  "vignette_files/Humor_Density_young_highly_educated_men.png",
  "vignette_files/Humor_Density_young_educated_women.png",
  "vignette_files/Humor_Density_under_18_highschool.png"
))
```
...
knitr::include_graphics(c(
  "vignette_files/Intellect_Density_young_highly_educated_men.png",
  "vignette_files/Intellect_Density_young_educated_women.png",
  "vignette_files/Intellect_Density_under_18_highschool.png"
))
```
...
knitr::include_graphics(c(
  "vignette_files/SelfControl_Density_young_highly_educated_men.png",
  "vignette_files/SelfControl_Density_young_educated_women.png",
  "vignette_files/SelfControl_Density_under_18_highschool.png"
))
```
...
knitr::include_graphics(c(
  "vignette_files/EasyGoingness_Density_young_highly_educated_men.png",
  "vignette_files/EasyGoingness_Density_young_educated_women.png",
  "vignette_files/EasyGoingness_Density_under_18_highschool.png"
))
```
...
knitr::include_graphics(c(
  "vignette_files/Perfectionism_Density_young_highly_educated_men.png",
  "vignette_files/Perfectionism_Density_young_educated_women.png",
  "vignette_files/Perfectionism_Density_under_18_highschool.png"
))
```
...
In almost all cases, the _Baumgartner–Weiß–Schindler_ (BWS) test showed a statistically significant difference between actual data and synthetic data. In most cases, however, the _Neuhäuser_ test, which is more robust to outliers, was not statistically significant. 

The appendix table shows summary results for the three data sets for all 135 items, indicating the proportion of cases where distribution comparison tests were  _'statistically significant'_ ($\rho$\ <\ 0.05).
...
knitr::include_graphics(c(
  "vignette_files/young_highly_educated_men_histograms.png"
))
```
...
knitr::include_graphics(c(
  "vignette_files/young_educated_women_histograms.png"
))
```
...
knitr::include_graphics(c(
  "vignette_files/under_18_highschool_histograms.png"
))
```
...
knitr::include_graphics(c(
  "vignette_files/q_1685_Density_young_highly_educated_men.png",
  "vignette_files/q_1685_Density_young_educated_women.png",
  "vignette_files/q_1685_Density_under_18_highschool.png"
))
```
...
knitr::include_graphics(c(
  "vignette_files/q_1896_Density_young_highly_educated_men.png",
  "vignette_files/q_1896_Density_young_educated_women.png",
  "vignette_files/q_1896_Density_under_18_highschool.png"
))
```
...
knitr::include_graphics(c(
  "vignette_files/q_1989_Density_young_highly_educated_men.png",
  "vignette_files/q_1989_Density_young_educated_women.png",
  "vignette_files/q_1989_Density_under_18_highschool.png"
))
```
...
knitr::include_graphics(c(
  "vignette_files/q_755_Density_young_highly_educated_men.png",
  "vignette_files/q_755_Density_young_educated_women.png",
  "vignette_files/q_755_Density_under_18_highschool.png"
))
```
...
dim_BWS <- readRDS("vignette_files/sig_table_items_BWS.rds")
dim_N <- readRDS("vignette_files/sig_table_items_Neuhauser.rds")
