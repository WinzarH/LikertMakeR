...
by _Dwivedi et al. (2018)_, (@nte-dwivedi). 
Using only the statistics reported in their 
...
_Dwivedi et al. (2018)_, @nte-dwivedi, sought to understand social
...
::: {#nte-dwivedi .callout-note appearance="default" icon=false}
