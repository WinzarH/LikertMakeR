...
#>  $ var1: num  3 3 3 2 2 3 3 1 3 3 ...
#>  $ var2: num  2 5 5 3 3 3 3 2 3 3 ...
#>  $ var3: num  3 5 5 3 2 4 1 1 3 1 ...
#>  $ var4: num  3 4 5 4 3 4 3 2 3 3 ...
...
cor(df) |> round(3)
#>       var1  var2  var3  var4
#> var1 1.000 0.250 0.361 0.448
#> var2 0.250 1.000 0.711 0.750
#> var3 0.361 0.711 1.000 0.836
#> var4 0.448 0.750 0.836 1.000
```
...
head(df)
#>     BT       BS   BL      BLY
#> 1 4.25 4.333333 4.75 4.000000
#> 2 3.50 4.000000 2.25 4.000000
#> 3 3.75 4.000000 3.75 4.333333
#> 4 4.50 4.333333 4.50 5.000000
#> 5 3.75 4.333333 3.50 4.000000
#> 6 3.25 3.333333 2.50 3.333333
tail(df)
#>       BT       BS   BL      BLY
#> 251 4.75 4.666667 4.75 4.666667
#> 252 4.75 4.666667 4.75 4.666667
#> 253 3.75 4.000000 3.00 3.000000
#> 254 3.50 3.333333 3.00 3.000000
#> 255 3.75 4.333333 3.75 4.000000
#> 256 3.50 4.000000 4.25 4.000000
...
#>  $ X1: num  2.17 3.5 3.17 3 1.17 ...
#>  $ X2: num  3.5 4 2.83 1.83 3.67 ...
...
#>   ..$ time_1: num [1:32] 2.5 1.25 2.75 1.75 2 1.5 1 1.25 2 1 ...
#>   ..$ time_2: num [1:32] 2.5 1.5 2.25 3.5 2 2.75 1.5 1.5 3 1.5 ...
#>   ..$ time_3: num [1:32] 3.5 2.75 2.25 4.75 3 2.75 2.25 2.5 2.75 2.5 ...
#>   ..$ time_4: num [1:32] 3.5 3.25 1.75 3.75 3.25 2.25 1.25 3.25 4.5 3.5 ...
...
#> [4,] 0.44 0.63 0.68 1.00 0.79
#> [5,] 0.50 0.65 0.68 0.79 1.00
...
cor(Att_3) |> round(2)
#>      [,1] [,2] [,3] [,4] [,5] [,6]
#> [1,] 1.00 0.33 0.36 0.42 0.47 0.48
#> [2,] 0.33 1.00 0.50 0.53 0.57 0.63
#> [3,] 0.36 0.50 1.00 0.65 0.71 0.79
#> [4,] 0.42 0.53 0.65 1.00 0.82 0.83
#> [5,] 0.47 0.57 0.71 0.82 1.00 0.85
#> [6,] 0.48 0.63 0.79 0.83 0.85 1.00
...
#>  $ A1_1 : num  2 2 3 2 2 1 2 2 4 3 ...
#>  $ A1_2 : num  3 3 2 2 2 3 2 3 3 3 ...
#>  $ A1_3 : num  4 4 2 1 2 4 4 4 3 4 ...
#>  $ A1_4 : num  4 4 3 2 2 4 4 4 3 4 ...
#>  $ A2_1 : num  3 2 2 2 1 2 3 2 3 3 ...
#>  $ A2_2 : num  2 3 3 1 2 4 2 3 2 3 ...
#>  $ A2_3 : num  3 4 2 2 2 3 3 3 4 4 ...
#>  $ A2_4 : num  2 4 3 2 2 3 3 3 4 4 ...
#>  $ A2_5 : num  3 4 3 2 3 4 4 3 4 4 ...
#>  $ A3_1 : num  3 4 3 3 3 2 3 3 2 2 ...
#>  $ A3_2 : num  3 3 3 3 2 2 3 2 2 2 ...
#>  $ A3_3 : num  3 3 3 3 3 3 3 3 4 2 ...
#>  $ A3_4 : num  4 4 4 2 4 2 4 4 4 1 ...
#>  $ A3_5 : num  4 4 4 3 4 3 4 4 4 3 ...
#>  $ A3_6 : num  4 4 4 3 4 3 4 4 4 2 ...
#>  $ Int_1: num  9 7 0 2 0 2 4 2 3 5 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 7.11 2.30 1.21 1.00 0.84 0.63 0.55 0.49 0.40 0.36 0.29 0.22 0.18 0.17 0.14
    #> [16] 0.11
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.95 2.26 1.05 1.00 0.69 0.62 0.54 0.40 0.36 0.30 0.23 0.18 0.17 0.14 0.11
