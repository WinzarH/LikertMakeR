...
#>  $ var1: num  3 2 2 3 4 4 3 2 2 3 ...
#>  $ var2: num  3 5 2 1 4 4 3 2 4 4 ...
#>  $ var3: num  5 5 2 2 5 5 2 4 5 4 ...
#>  $ var4: num  4 5 3 3 4 4 3 4 4 4 ...
```
...
head(df)
#>     BT       BS   BL      BLY
#> 1 4.50 4.666667 3.75 4.333333
#> 2 3.50 3.666667 3.50 3.666667
#> 3 4.50 4.333333 4.00 4.666667
#> 4 4.00 2.000000 3.50 3.000000
#> 5 4.25 4.666667 4.25 4.666667
#> 6 3.75 4.333333 3.00 4.333333
tail(df)
#>       BT       BS   BL      BLY
#> 251 2.25 3.666667 2.00 3.333333
#> 252 4.25 4.666667 4.00 4.333333
#> 253 3.75 3.666667 3.75 3.333333
#> 254 4.25 4.333333 4.50 3.666667
#> 255 2.50 3.000000 3.50 3.666667
#> 256 4.75 5.000000 4.00 5.000000
...
#>   ..$ time_1: num [1:32] 1 1.25 2.75 1 2.75 4 1.75 2.5 2.5 1.25 ...
#>   ..$ time_2: num [1:32] 1.25 1.25 3 1.25 3.75 2.5 2.75 3.5 3 1.5 ...
#>   ..$ time_3: num [1:32] 2.25 1.75 2.5 3.5 4.25 2 3.25 3.75 2.5 1.5 ...
#>   ..$ time_4: num [1:32] 3.25 1.5 2 2.75 2.5 1.5 3.5 2.5 3 2.25 ...
...
#> item02   0.53   1.00   0.72   0.85   0.47   0.41
#> item03   0.79   0.72   1.00   0.70   0.71   0.66
#> item04   0.43   0.85   0.70   1.00   0.43   0.47
...
#>  $ A1_1 : num  2 3 2 2 2 2 1 4 2 2 ...
#>  $ A1_2 : num  3 4 2 2 1 2 2 2 1 2 ...
#>  $ A1_3 : num  4 4 3 2 1 2 3 2 2 3 ...
#>  $ A1_4 : num  3 5 3 4 2 3 3 4 2 3 ...
#>  $ A2_1 : num  2 3 2 2 1 3 3 2 2 2 ...
#>  $ A2_2 : num  3 3 2 3 1 2 2 2 2 3 ...
#>  $ A2_3 : num  3 2 3 4 2 3 4 3 2 3 ...
#>  $ A2_4 : num  3 3 2 3 2 3 3 3 1 3 ...
#>  $ A2_5 : num  4 4 4 4 3 3 4 3 3 3 ...
#>  $ A3_1 : num  2 4 2 3 2 3 2 2 2 3 ...
#>  $ A3_2 : num  1 4 2 3 1 2 1 2 2 2 ...
#>  $ A3_3 : num  2 4 2 4 1 3 3 3 2 3 ...
#>  $ A3_4 : num  1 4 2 4 1 2 2 3 3 2 ...
#>  $ A3_5 : num  3 5 2 5 3 4 3 4 3 4 ...
#>  $ A3_6 : num  3 4 4 3 3 4 4 3 3 4 ...
#>  $ Int_1: num  0 5 7 4 2 1 4 2 0 0 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.94 2.25 1.08 0.92 0.89 0.67 0.62 0.53 0.50 0.41 0.35 0.25 0.21 0.16 0.12
    #> [16] 0.10
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.79 2.21 0.99 0.90 0.68 0.66 0.54 0.53 0.48 0.35 0.27 0.22 0.16 0.12 0.11
...
#>              lambda6    0.797       4    64
#>        ordinal_alpha    0.775       4    64
#>  ordinal_omega_total    0.856       4    64
#>                                                notes
...
#>                alpha    0.800    0.698    0.854       4    64
#>          omega_total    0.871    0.817    0.902       4    64
#>        ordinal_alpha    0.775    0.610    0.816       4    64
#>  ordinal_omega_total    0.856    0.775    0.880       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
