...
#>  $ var1: num  2 2 4 4 2 1 3 2 3 3 ...
#>  $ var2: num  4 2 5 1 3 4 4 3 3 2 ...
#>  $ var3: num  3 3 5 2 1 5 4 3 3 2 ...
#>  $ var4: num  4 3 5 3 3 5 4 3 4 3 ...
```
...
head(df)
#>     BT       BS   BL      BLY
#> 1 4.25 4.333333 2.75 4.666667
#> 2 4.25 4.333333 4.00 5.000000
#> 3 3.00 3.000000 3.00 4.333333
#> 4 4.00 4.666667 2.50 3.666667
#> 5 3.75 4.000000 3.25 3.333333
#> 6 3.75 4.000000 3.50 4.000000
tail(df)
#>       BT       BS   BL      BLY
#> 251 4.50 4.666667 4.00 4.666667
#> 252 3.25 3.000000 3.00 3.666667
#> 253 2.50 3.333333 2.50 3.000000
#> 254 2.50 3.666667 4.00 2.666667
...
#>  $ X1: num  2.5 2.5 2.83 1.33 1.83 ...
#>  $ X2: num  1.83 2.33 3.17 3.5 3.33 ...
...
#>   ..$ time_1: num [1:32] 3.5 1.25 2 2.75 2 2.5 1.75 1.5 1.75 3 ...
#>   ..$ time_2: num [1:32] 2.5 2 1.5 3 3.25 3.25 3.5 2 2 3.75 ...
#>   ..$ time_3: num [1:32] 3.5 1.5 2.75 3.75 4.25 2.75 4.25 3.75 2.25 3.75 ...
#>   ..$ time_4: num [1:32] 2.75 1.25 2 4 3.5 2 4.25 3.25 3 2.5 ...
...
cor(Att_2) |> round(2)
#>        item01 item02 item03 item04 item05
#> item01   1.00   0.59   0.68   0.54   0.50
#> item02   0.59   1.00   0.60   0.48   0.44
#> item03   0.68   0.60   1.00   0.55   0.51
...
#> item02   0.69   1.00   0.77   0.70   0.69   0.58
#> item03   0.64   0.77   1.00   0.65   0.63   0.53
...
#>  $ A1_1 : num  3 2 3 2 2 1 3 4 2 3 ...
#>  $ A1_2 : num  2 2 3 2 1 2 3 3 3 4 ...
#>  $ A1_3 : num  3 3 2 2 3 3 3 5 4 4 ...
#>  $ A1_4 : num  3 3 4 2 2 3 4 4 4 4 ...
#>  $ A2_1 : num  3 1 2 2 2 2 4 4 2 4 ...
#>  $ A2_2 : num  3 1 3 2 2 1 3 4 2 3 ...
#>  $ A2_3 : num  3 3 3 2 2 2 4 4 3 4 ...
#>  $ A2_4 : num  3 2 3 2 3 1 5 5 3 3 ...
#>  $ A2_5 : num  3 2 3 4 2 3 5 4 3 4 ...
#>  $ A3_1 : num  2 3 4 1 2 2 3 3 2 4 ...
#>  $ A3_2 : num  2 3 3 2 2 2 3 3 2 3 ...
#>  $ A3_3 : num  1 4 5 2 2 2 4 4 2 4 ...
#>  $ A3_4 : num  3 4 5 2 3 4 3 3 2 4 ...
#>  $ A3_5 : num  3 4 4 3 3 4 4 4 2 4 ...
#>  $ A3_6 : num  4 4 4 3 3 2 4 4 3 4 ...
#>  $ Int_1: num  0 3 8 5 0 1 6 1 9 8 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.98 2.24 1.16 0.77 0.66 0.55 0.52 0.48 0.45 0.42 0.40 0.38 0.35 0.25 0.23
    #> [16] 0.17
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.81 2.20 0.86 0.74 0.65 0.55 0.50 0.46 0.42 0.40 0.39 0.35 0.26 0.23 0.18
...
#>                alpha    0.799    0.703    0.859       4    64
#>          omega_total    0.870    0.819    0.905       4    64
#>        ordinal_alpha    0.760    0.629    0.794       4    64
#>  ordinal_omega_total    0.848    0.783    0.866       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
