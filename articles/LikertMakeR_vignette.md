...
#>  $ var1: num  3 2 3 3 2 4 2 2 3 4 ...
#>  $ var2: num  3 3 4 5 1 3 4 1 4 3 ...
#>  $ var3: num  3 3 5 3 1 5 5 1 5 3 ...
#>  $ var4: num  4 4 5 4 2 4 4 2 4 4 ...
```
...
head(df)
#>     BT       BS   BL      BLY
#> 1 2.50 3.000000 2.75 3.000000
#> 2 4.25 4.333333 3.50 4.666667
#> 3 3.00 3.666667 3.25 4.000000
#> 4 4.00 4.333333 3.25 3.666667
#> 5 3.00 3.333333 1.75 4.000000
#> 6 4.50 4.333333 4.75 4.333333
tail(df)
#>       BT       BS   BL      BLY
#> 251 4.50 4.666667 4.00 4.666667
#> 252 3.75 3.000000 1.50 3.333333
#> 253 2.50 3.000000 3.00 3.333333
#> 254 3.75 3.666667 3.75 4.666667
#> 255 4.00 4.666667 4.50 5.000000
#> 256 4.00 4.000000 3.25 3.666667
...
#>  $ X1: num  2.67 2.83 2.83 3.17 3 ...
#>  $ X2: num  2.33 3.5 2.83 3.83 3.33 ...
...
#>   ..$ time_1: num [1:32] 1.25 2 1.25 1.75 2.25 3.25 1.25 1.25 1 3.5 ...
#>   ..$ time_2: num [1:32] 1.5 4 3 2.5 2 3.5 3.5 1.5 2 3.25 ...
#>   ..$ time_3: num [1:32] 1.75 4.5 3.75 2.25 1.5 4.5 3.75 3 3 3.75 ...
#>   ..$ time_4: num [1:32] 1.5 2.75 4 3.25 1.25 2.75 3.75 4.25 2.75 3.5 ...
...
#>  $ A1_1 : num  3 3 3 3 3 4 3 2 2 4 ...
#>  $ A1_2 : num  3 2 3 2 2 3 3 2 1 2 ...
#>  $ A1_3 : num  3 3 3 3 4 4 4 2 2 3 ...
#>  $ A1_4 : num  3 3 3 4 4 4 5 4 3 4 ...
#>  $ A2_1 : num  3 3 3 3 3 4 4 2 2 3 ...
#>  $ A2_2 : num  3 2 3 3 4 4 4 2 2 2 ...
#>  $ A2_3 : num  3 3 3 3 4 4 4 2 2 3 ...
#>  $ A2_4 : num  5 3 3 4 4 4 4 2 2 3 ...
#>  $ A2_5 : num  4 3 4 4 4 4 4 3 2 3 ...
#>  $ A3_1 : num  3 2 2 1 3 3 3 3 2 3 ...
#>  $ A3_2 : num  3 2 2 2 2 3 3 2 2 4 ...
#>  $ A3_3 : num  4 3 3 2 3 4 3 2 3 4 ...
#>  $ A3_4 : num  4 2 2 2 2 4 3 4 3 4 ...
#>  $ A3_5 : num  4 2 3 3 3 5 4 3 4 4 ...
#>  $ A3_6 : num  4 3 3 2 4 4 4 3 4 4 ...
#>  $ Int_1: num  1 1 0 9 1 8 1 7 1 2 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.95 2.27 1.07 0.76 0.67 0.62 0.57 0.54 0.44 0.43 0.39 0.33 0.30 0.25 0.22
    #> [16] 0.18
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.79 2.23 0.79 0.75 0.65 0.59 0.56 0.50 0.44 0.39 0.33 0.31 0.26 0.23 0.18
...
#>                alpha    0.800    0.709    0.845       4    64
#>          omega_total    0.870    0.823    0.896       4    64
#>        ordinal_alpha    0.766    0.630    0.811       4    64
#>  ordinal_omega_total    0.851    0.783    0.876       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
