...
#>  $ var1: num  3 2 3 2 2 3 3 3 3 2 ...
#>  $ var2: num  2 3 3 4 3 1 4 2 4 4 ...
#>  $ var3: num  2 4 5 5 1 3 5 1 5 3 ...
#>  $ var4: num  3 4 4 4 3 3 4 2 4 4 ...
```
...
#> 2 3.75 4.333333 4.25 3.666667
#> 3 3.25 3.666667 3.75 4.666667
#> 4 4.00 4.333333 4.00 4.333333
#> 5 3.50 4.333333 4.50 4.000000
#> 6 4.25 4.666667 4.25 4.333333
tail(df)
#>       BT       BS   BL      BLY
#> 251 4.25 4.333333 3.75 4.666667
#> 252 2.75 3.000000 1.50 3.333333
#> 253 2.50 3.333333 2.25 3.333333
#> 254 4.50 4.333333 4.00 4.666667
#> 255 4.75 4.666667 3.75 4.333333
#> 256 3.00 3.000000 2.75 3.666667
...
#>  $ X1: num  2.5 2.67 2 2.17 2 ...
#>  $ X2: num  2.33 2.83 3.67 3 4.83 ...
...
#>   ..$ time_1: num [1:32] 1 1.5 1 1.25 2.25 2 3.25 1.25 1.5 2.5 ...
#>   ..$ time_2: num [1:32] 1.25 3 1.5 2 2 2 4 2.5 2.5 4.5 ...
#>   ..$ time_3: num [1:32] 1.75 4.5 2.25 1.5 3.75 4.5 4 2.75 3.5 4.75 ...
#>   ..$ time_4: num [1:32] 3 3.25 2.5 2.75 4 3.25 2.75 2 3 4.25 ...
...
#>  $ A1_1 : num  3 3 2 3 2 2 3 2 2 2 ...
#>  $ A1_2 : num  4 2 1 3 2 2 2 2 1 2 ...
#>  $ A1_3 : num  4 4 2 3 2 3 3 3 2 4 ...
#>  $ A1_4 : num  4 4 4 4 3 4 4 4 2 4 ...
#>  $ A2_1 : num  3 3 2 4 3 3 3 2 2 3 ...
#>  $ A2_2 : num  4 4 2 3 2 3 2 1 3 3 ...
#>  $ A2_3 : num  3 4 3 4 4 4 3 3 2 4 ...
#>  $ A2_4 : num  5 4 3 4 4 3 3 2 3 4 ...
#>  $ A2_5 : num  4 4 4 5 3 4 4 2 2 5 ...
#>  $ A3_1 : num  3 2 2 3 3 3 3 3 2 2 ...
#>  $ A3_2 : num  3 2 1 4 3 2 3 3 1 2 ...
#>  $ A3_3 : num  4 3 3 4 3 4 4 4 1 3 ...
#>  $ A3_4 : num  4 2 3 4 2 4 2 4 3 2 ...
#>  $ A3_5 : num  4 4 3 4 3 3 4 3 2 4 ...
#>  $ A3_6 : num  4 4 3 4 4 4 4 4 2 4 ...
#>  $ Int_1: num  8 1 0 7 2 2 1 1 1 2 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.93 2.26 1.07 0.70 0.66 0.63 0.57 0.54 0.48 0.42 0.39 0.32 0.30 0.27 0.24
    #> [16] 0.20
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.78 2.22 0.77 0.68 0.65 0.62 0.55 0.54 0.46 0.39 0.32 0.30 0.28 0.24 0.20
...
#>                alpha    0.801    0.734    0.860       4    64
#>          omega_total    0.871    0.834    0.907       4    64
#>        ordinal_alpha    0.756    0.671    0.804       4    64
#>  ordinal_omega_total    0.846    0.803    0.873       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
