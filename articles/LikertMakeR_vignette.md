...
#>  $ var1: num  4 4 2 2 3 5 1 2 2 2 ...
#>  $ var2: num  3 5 4 2 3 4 3 4 3 2 ...
#>  $ var3: num  5 5 3 2 4 5 3 4 3 2 ...
#>  $ var4: num  4 5 4 3 4 5 3 4 3 3 ...
...
head(df)
#>     BT       BS   BL      BLY
#> 1 4.25 4.000000 3.50 4.000000
#> 2 4.25 4.333333 2.75 4.333333
#> 3 4.25 4.333333 4.25 4.666667
#> 4 3.00 3.666667 3.75 3.333333
#> 5 4.50 4.666667 4.00 5.000000
#> 6 4.25 4.333333 3.50 4.333333
tail(df)
#>       BT       BS   BL      BLY
#> 251 2.25 3.333333 2.00 3.333333
#> 252 4.25 4.333333 4.00 4.000000
#> 253 4.50 4.666667 3.25 4.000000
#> 254 2.75 3.666667 3.25 2.000000
#> 255 2.25 3.333333 3.00 3.000000
#> 256 4.25 4.333333 4.00 4.000000
...
#>   ..$ time_1: num [1:32] 2.5 2.75 2.75 1.5 1.75 2 1.75 2.25 1.5 1 ...
#>   ..$ time_2: num [1:32] 2.25 3 3 2.5 2.75 2.75 3.5 3.75 1.25 2.25 ...
#>   ..$ time_3: num [1:32] 2.5 4.5 4.25 2.5 3.25 2 4.5 3.5 1.25 3.5 ...
#>   ..$ time_4: num [1:32] 4 3.25 2.25 2.5 3.5 2.25 2.75 3 2 3.5 ...
...
cor(Att_3) |> round(2)
#>        item01 item02 item03 item04 item05 item06
#> item01   1.00   0.53   0.77   0.43   0.69   0.63
#> item02   0.53   1.00   0.71   0.86   0.47   0.41
#> item03   0.77   0.71   1.00   0.70   0.70   0.66
#> item04   0.43   0.86   0.70   1.00   0.43   0.46
#> item05   0.69   0.47   0.70   0.43   1.00   0.43
#> item06   0.63   0.41   0.66   0.46   0.43   1.00
...
#>  $ A1_1 : num  2 2 3 3 2 4 2 2 3 2 ...
#>  $ A1_2 : num  3 2 3 2 2 3 2 2 1 3 ...
#>  $ A1_3 : num  3 3 2 3 2 3 3 2 2 4 ...
#>  $ A1_4 : num  4 3 4 3 3 4 3 3 3 3 ...
#>  $ A2_1 : num  3 3 3 2 2 2 3 3 2 2 ...
#>  $ A2_2 : num  3 2 2 1 2 3 3 3 2 3 ...
#>  $ A2_3 : num  3 3 3 3 3 3 2 3 3 3 ...
#>  $ A2_4 : num  3 3 3 2 3 2 4 3 3 2 ...
#>  $ A2_5 : num  5 5 3 3 3 4 4 4 4 3 ...
#>  $ A3_1 : num  3 2 4 2 3 3 3 2 3 2 ...
#>  $ A3_2 : num  2 2 3 2 2 4 3 1 2 2 ...
#>  $ A3_3 : num  3 2 4 3 3 5 4 2 3 3 ...
#>  $ A3_4 : num  2 2 3 3 3 5 4 2 3 2 ...
#>  $ A3_5 : num  4 3 5 4 4 5 4 4 4 4 ...
#>  $ A3_6 : num  4 3 4 4 4 5 4 2 5 2 ...
#>  $ Int_1: num  5 4 0 4 2 1 6 4 1 7 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.96 2.21 1.13 0.96 0.76 0.69 0.59 0.54 0.48 0.46 0.38 0.24 0.22 0.16 0.13
    #> [16] 0.09
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.80 2.18 0.98 0.85 0.74 0.65 0.59 0.51 0.47 0.39 0.24 0.22 0.16 0.14 0.09
