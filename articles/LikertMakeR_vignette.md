...
#>  $ var1: num  2 2 2 1 3 2 3 2 2 3 ...
#>  $ var2: num  4 5 4 3 4 5 4 3 3 3 ...
#>  $ var3: num  4 5 5 2 5 3 4 3 1 2 ...
#>  $ var4: num  4 4 4 3 5 3 4 4 3 3 ...
...
head(df)
#>     BT       BS   BL      BLY
#> 1 4.00 4.000000 4.75 4.666667
#> 2 3.75 3.666667 3.25 3.333333
#> 3 4.00 4.333333 4.00 4.333333
#> 4 3.00 4.000000 3.00 4.000000
#> 5 3.75 3.333333 2.00 2.666667
#> 6 4.50 4.666667 4.50 4.333333
tail(df)
#>      BT       BS   BL      BLY
#> 251 4.5 4.333333 4.00 4.333333
#> 252 4.5 4.333333 3.75 4.000000
#> 253 4.5 4.666667 4.25 4.000000
#> 254 3.0 3.333333 3.50 4.333333
#> 255 3.5 3.666667 3.50 3.666667
#> 256 3.0 3.333333 2.00 4.000000
...
#>  $ X1: num  2.17 2.67 2.83 3.17 2.67 ...
#>  $ X2: num  2.5 3.5 3.5 3.5 1.83 ...
...
#>   ..$ time_1: num [1:32] 2.5 1.5 2.25 1.25 2.75 1.25 3 3 2.5 1.5 ...
#>   ..$ time_2: num [1:32] 2.75 3 2.5 1.25 2.5 1.25 4 3 3.5 3.25 ...
#>   ..$ time_3: num [1:32] 2 4 3 1.75 3.25 1.5 4.5 3.5 3.5 3.75 ...
#>   ..$ time_4: num [1:32] 1.5 4 2.5 3.5 3.25 1.25 3.5 4.5 2.25 4 ...
...
cor(Att_3) |> round(2)
#>        item01 item02 item03 item04 item05 item06
#> item01   1.00   0.53   0.77   0.43   0.71   0.64
#> item02   0.53   1.00   0.71   0.87   0.47   0.41
#> item03   0.77   0.71   1.00   0.71   0.71   0.66
#> item04   0.43   0.87   0.71   1.00   0.43   0.46
#> item05   0.71   0.47   0.71   0.43   1.00   0.42
#> item06   0.64   0.41   0.66   0.46   0.42   1.00
...
#>  $ A1_1 : num  2 3 3 3 2 3 3 2 2 2 ...
#>  $ A1_2 : num  2 2 3 3 3 3 4 2 3 2 ...
#>  $ A1_3 : num  3 2 4 4 3 3 4 3 4 1 ...
#>  $ A1_4 : num  3 4 4 4 4 4 4 4 3 3 ...
#>  $ A2_1 : num  2 3 3 3 2 3 3 2 2 2 ...
#>  $ A2_2 : num  2 4 3 2 2 3 3 2 2 1 ...
#>  $ A2_3 : num  3 3 3 3 3 3 3 2 3 1 ...
#>  $ A2_4 : num  3 4 3 3 3 3 4 3 2 1 ...
#>  $ A2_5 : num  3 5 3 4 3 4 4 3 3 3 ...
#>  $ A3_1 : num  1 3 3 3 2 2 3 3 4 1 ...
#>  $ A3_2 : num  1 4 3 3 2 3 3 3 3 2 ...
#>  $ A3_3 : num  1 4 4 4 3 3 4 3 4 2 ...
#>  $ A3_4 : num  2 5 4 4 2 4 4 3 4 3 ...
#>  $ A3_5 : num  3 4 4 4 4 3 4 4 4 3 ...
#>  $ A3_6 : num  2 4 4 5 3 3 4 4 5 3 ...
#>  $ Int_1: num  4 0 1 4 9 2 9 4 1 0 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.95 2.22 1.06 1.00 0.82 0.71 0.59 0.56 0.48 0.45 0.33 0.25 0.20 0.16 0.14
    #> [16] 0.09
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.79 2.19 1.03 0.82 0.73 0.68 0.59 0.56 0.45 0.33 0.25 0.20 0.16 0.14 0.09
