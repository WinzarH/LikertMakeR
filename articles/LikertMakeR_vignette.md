...
#>  $ var1: num  4 3 4 4 3 4 3 1 3 3 ...
#>  $ var2: num  5 2 3 3 2 5 4 2 3 2 ...
#>  $ var3: num  5 1 3 4 2 5 4 1 2 3 ...
#>  $ var4: num  5 3 4 4 3 5 4 2 3 3 ...
...
head(df)
#>     BT       BS   BL      BLY
#> 1 4.25 4.333333 4.50 4.000000
#> 2 3.00 3.000000 2.50 2.666667
#> 3 3.25 4.000000 3.00 3.666667
#> 4 4.00 4.333333 4.25 5.000000
#> 5 3.75 4.333333 2.25 4.333333
#> 6 4.75 4.333333 4.00 5.000000
tail(df)
#>       BT       BS   BL      BLY
#> 251 3.75 4.333333 3.50 3.666667
#> 252 3.50 4.000000 3.50 4.000000
#> 253 3.75 4.000000 3.50 4.000000
#> 254 4.25 4.000000 2.75 4.333333
#> 255 4.00 4.000000 4.25 4.000000
#> 256 4.25 4.000000 4.25 4.333333
...
#>  $ X1: num  2.33 3.5 2.83 3 2.33 ...
#>  $ X2: num  3.67 3.67 2.83 1.67 1.33 ...
...
#>   ..$ time_1: num [1:32] 3 1 3.25 1.25 1 1.75 1.75 1.25 2.75 1.75 ...
#>   ..$ time_2: num [1:32] 2.5 1.25 3.5 2.25 2.5 2.75 1.25 1.5 3.5 1.5 ...
#>   ..$ time_3: num [1:32] 3 1.75 4.75 3.25 4.5 2 1.5 2 3.25 1.75 ...
#>   ..$ time_4: num [1:32] 1.75 1.25 4.5 3.75 3.75 2 2.25 3.5 4 1.5 ...
...
cor(Att_3) |> round(2)
#>      [,1] [,2] [,3] [,4] [,5] [,6]
#> [1,] 1.00 0.33 0.37 0.42 0.47 0.48
#> [2,] 0.33 1.00 0.50 0.53 0.57 0.63
#> [3,] 0.37 0.50 1.00 0.65 0.71 0.77
#> [4,] 0.42 0.53 0.65 1.00 0.82 0.83
#> [5,] 0.47 0.57 0.71 0.82 1.00 0.85
#> [6,] 0.48 0.63 0.77 0.83 0.85 1.00
...
#>  $ A1_1 : num  3 2 3 3 2 3 4 3 2 3 ...
#>  $ A1_2 : num  3 2 1 2 1 3 3 3 3 2 ...
#>  $ A1_3 : num  4 2 3 3 2 4 4 4 3 1 ...
#>  $ A1_4 : num  4 3 3 3 2 4 5 4 3 2 ...
#>  $ A2_1 : num  2 2 2 1 2 4 3 3 2 3 ...
#>  $ A2_2 : num  3 1 2 4 1 4 3 3 2 2 ...
#>  $ A2_3 : num  4 3 2 3 2 4 4 4 3 2 ...
#>  $ A2_4 : num  4 2 2 3 2 4 4 3 3 3 ...
#>  $ A2_5 : num  4 2 3 4 2 5 4 4 3 3 ...
#>  $ A3_1 : num  4 2 4 3 2 2 3 3 2 2 ...
#>  $ A3_2 : num  2 2 3 4 3 4 3 3 4 2 ...
#>  $ A3_3 : num  3 2 3 4 2 3 3 4 3 1 ...
#>  $ A3_4 : num  4 1 4 4 3 4 4 3 4 1 ...
#>  $ A3_5 : num  4 2 4 4 3 4 4 4 4 2 ...
#>  $ A3_6 : num  4 2 4 5 3 4 4 4 4 2 ...
#>  $ Int_1: num  9 5 0 5 0 6 1 3 2 2 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 7.09 2.29 1.15 0.99 0.85 0.75 0.53 0.45 0.40 0.35 0.29 0.25 0.21 0.16 0.14
    #> [16] 0.11
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.93 2.26 1.09 0.92 0.76 0.61 0.48 0.41 0.36 0.32 0.25 0.21 0.16 0.14 0.11
