...
#>  $ var1: num  3 1 3 4 2 2 1 3 2 4 ...
#>  $ var2: num  2 5 2 4 3 4 4 1 4 3 ...
#>  $ var3: num  2 4 5 5 1 5 5 1 3 3 ...
#>  $ var4: num  3 4 4 4 3 4 4 3 4 3 ...
```
...
head(df)
#>     BT       BS  BL      BLY
#> 1 3.75 3.333333 3.0 3.000000
#> 2 4.25 4.333333 4.5 3.666667
#> 3 4.25 4.666667 4.0 4.000000
#> 4 4.25 4.666667 4.5 4.666667
#> 5 3.50 3.666667 3.5 3.666667
#> 6 3.00 4.000000 3.5 4.333333
tail(df)
#>       BT       BS   BL      BLY
#> 251 4.25 4.666667 4.50 4.666667
#> 252 3.25 3.000000 2.75 2.666667
#> 253 2.50 3.000000 3.00 3.333333
#> 254 4.00 4.333333 4.00 4.000000
#> 255 3.75 4.333333 4.00 4.333333
#> 256 4.00 4.333333 4.00 4.666667
...
#>  $ X1: num  2.17 2.67 2.33 3 3 ...
#>  $ X2: num  1.83 2.67 2.67 3.5 1.67 ...
...
#>   ..$ time_1: num [1:32] 2.25 1.5 1 1 1.25 1.5 1.25 2 2.25 1.25 ...
#>   ..$ time_2: num [1:32] 3.5 2 1.5 2.5 2.5 2.5 2 2.75 3.5 1.5 ...
#>   ..$ time_3: num [1:32] 3.25 3.5 3 3.5 2.5 4 2.75 1.75 4.5 1.5 ...
#>   ..$ time_4: num [1:32] 2.75 4.75 2.5 3.75 3 3.25 3 3 2.25 2.75 ...
...
#>  $ A1_1 : num  2 3 2 2 3 3 2 2 3 2 ...
#>  $ A1_2 : num  3 2 3 1 4 2 2 3 3 3 ...
#>  $ A1_3 : num  3 3 3 2 4 3 3 3 3 3 ...
#>  $ A1_4 : num  3 3 4 3 5 3 3 4 3 4 ...
#>  $ A2_1 : num  2 2 2 2 3 2 4 4 3 2 ...
#>  $ A2_2 : num  2 2 2 2 4 2 2 4 2 2 ...
#>  $ A2_3 : num  2 2 2 3 4 3 2 4 4 3 ...
#>  $ A2_4 : num  2 3 4 3 3 2 5 3 4 2 ...
#>  $ A2_5 : num  3 3 3 3 5 3 4 4 3 3 ...
#>  $ A3_1 : num  3 2 1 3 2 2 3 4 2 3 ...
#>  $ A3_2 : num  4 2 3 3 3 3 2 4 3 2 ...
#>  $ A3_3 : num  3 3 3 4 4 4 3 3 2 2 ...
#>  $ A3_4 : num  5 3 2 3 4 4 2 5 3 2 ...
#>  $ A3_5 : num  4 3 3 4 3 4 4 4 4 3 ...
#>  $ A3_6 : num  5 3 3 4 4 4 4 4 3 3 ...
#>  $ Int_1: num  6 0 5 0 5 6 6 9 0 5 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.96 2.25 1.14 0.73 0.64 0.60 0.55 0.50 0.46 0.42 0.38 0.37 0.31 0.26 0.24
    #> [16] 0.17
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.80 2.22 0.90 0.70 0.63 0.56 0.50 0.47 0.42 0.39 0.38 0.32 0.27 0.26 0.17
...
#>                alpha    0.800    0.735    0.851       4    64
#>          omega_total    0.870    0.835    0.900       4    64
#>        ordinal_alpha    0.755    0.640    0.801       4    64
#>  ordinal_omega_total    0.845    0.788    0.870       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
