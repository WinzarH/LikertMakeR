...
#>  $ var1: num  2 2 4 2 1 2 2 2 2 3 ...
#>  $ var2: num  2 4 3 4 3 3 5 3 4 4 ...
#>  $ var3: num  2 4 5 2 3 3 5 1 4 3 ...
#>  $ var4: num  3 4 5 3 3 4 5 3 4 4 ...
```
...
head(df)
#>     BT       BS   BL      BLY
#> 1 3.00 3.333333 2.75 3.333333
#> 2 4.50 4.333333 3.50 4.666667
#> 3 3.50 4.000000 3.75 4.333333
#> 4 4.50 4.333333 3.75 4.333333
#> 5 4.75 4.333333 4.50 4.333333
#> 6 2.50 3.000000 3.00 4.000000
tail(df)
#>       BT       BS   BL      BLY
#> 251 4.50 4.666667 4.50 5.000000
#> 252 3.75 3.666667 2.75 4.666667
#> 253 3.00 3.666667 3.50 3.333333
#> 254 4.25 4.666667 3.75 4.666667
#> 255 4.00 5.000000 2.75 3.666667
#> 256 4.00 4.000000 3.75 4.666667
...
#>  $ X1: num  3.17 2.17 2.83 2 3 ...
#>  $ X2: num  2.33 2.83 3.67 2.83 4.83 ...
...
#>   ..$ time_1: num [1:32] 2.5 1.25 2.5 3.5 1.5 2.25 2.75 1.25 1 1.75 ...
#>   ..$ time_2: num [1:32] 3 1.5 4.5 4 1.5 3.5 3 2 2 3.25 ...
#>   ..$ time_3: num [1:32] 3 3.5 4 3 1 4 2.25 2.75 1.75 4.5 ...
#>   ..$ time_4: num [1:32] 2.75 3.25 3.5 1.5 1.5 3.25 2 2.5 2.5 4.25 ...
...
#>  $ A1_1 : num  3 2 3 3 2 3 1 2 2 1 ...
#>  $ A1_2 : num  2 2 2 2 3 2 3 3 2 2 ...
#>  $ A1_3 : num  3 2 4 3 3 3 2 3 2 1 ...
#>  $ A1_4 : num  4 2 3 4 4 4 2 5 2 3 ...
#>  $ A2_1 : num  2 1 2 3 3 2 2 2 2 2 ...
#>  $ A2_2 : num  3 1 2 3 3 2 2 3 3 2 ...
#>  $ A2_3 : num  3 3 3 4 3 3 2 3 3 2 ...
#>  $ A2_4 : num  3 2 2 4 2 3 2 3 2 2 ...
#>  $ A2_5 : num  3 2 3 4 4 4 3 4 2 2 ...
#>  $ A3_1 : num  2 3 2 3 2 3 3 3 1 2 ...
#>  $ A3_2 : num  1 3 2 3 2 3 2 4 2 1 ...
#>  $ A3_3 : num  3 4 3 4 2 3 3 4 3 1 ...
#>  $ A3_4 : num  2 4 4 4 2 3 4 4 2 2 ...
#>  $ A3_5 : num  3 3 4 4 4 4 4 4 3 2 ...
#>  $ A3_6 : num  2 4 3 4 3 4 4 4 2 2 ...
#>  $ Int_1: num  6 1 10 9 3 8 1 9 0 3 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.96 2.24 1.08 0.74 0.67 0.61 0.60 0.53 0.46 0.43 0.41 0.34 0.28 0.27 0.20
    #> [16] 0.19
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.80 2.20 0.77 0.73 0.66 0.60 0.54 0.50 0.44 0.41 0.35 0.32 0.27 0.23 0.19
...
#>                alpha    0.801    0.717    0.867       4    64
#>          omega_total    0.871    0.827    0.909       4    64
#>        ordinal_alpha    0.763    0.642    0.821       4    64
#>  ordinal_omega_total    0.849    0.789    0.882       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
