...
#>  $ var1: num  3 4 2 2 4 2 2 3 2 4 ...
#>  $ var2: num  3 4 5 1 4 5 2 4 4 3 ...
#>  $ var3: num  4 5 5 3 5 5 1 4 3 4 ...
#>  $ var4: num  4 5 5 3 5 4 3 4 4 4 ...
```
...
head(df)
#>     BT       BS   BL      BLY
#> 1 4.75 4.333333 4.00 4.666667
#> 2 3.50 3.666667 3.00 3.333333
#> 3 4.50 4.333333 4.50 4.000000
#> 4 3.25 3.666667 3.00 3.000000
#> 5 3.75 4.000000 3.25 3.666667
#> 6 3.75 3.333333 4.00 4.000000
tail(df)
#>       BT       BS   BL      BLY
#> 251 4.00 4.000000 3.75 3.666667
#> 252 4.25 3.666667 3.50 3.333333
#> 253 4.75 4.666667 4.50 5.000000
#> 254 3.00 4.000000 3.25 3.000000
#> 255 3.50 3.333333 3.25 3.000000
#> 256 4.00 4.666667 3.75 5.000000
...
#>   ..$ time_1: num [1:32] 2.75 2.5 3 1.25 3 1 2 1.75 1.5 1.5 ...
#>   ..$ time_2: num [1:32] 2.5 3.5 3 2.25 3.5 1.25 2.75 2.75 3 2.25 ...
#>   ..$ time_3: num [1:32] 2.5 3.25 4.25 3.5 3.25 1.25 4.25 4.75 2.5 1.75 ...
#>   ..$ time_4: num [1:32] 2 3.5 4 2.5 3.5 1.75 2.75 3.5 2.25 1.5 ...
...
#>  $ A1_1 : num  2 3 2 2 2 2 3 3 2 2 ...
#>  $ A1_2 : num  2 3 2 2 2 1 4 2 1 2 ...
#>  $ A1_3 : num  2 4 2 2 4 2 4 3 2 2 ...
#>  $ A1_4 : num  4 4 3 3 2 3 5 3 3 3 ...
#>  $ A2_1 : num  2 3 2 2 2 2 4 3 1 2 ...
#>  $ A2_2 : num  1 2 2 1 2 2 4 1 2 2 ...
#>  $ A2_3 : num  2 4 3 3 2 3 3 4 2 3 ...
#>  $ A2_4 : num  2 4 3 2 2 1 3 3 1 3 ...
#>  $ A2_5 : num  2 4 3 2 3 3 4 4 3 4 ...
#>  $ A3_1 : num  4 3 1 2 2 2 2 2 2 2 ...
#>  $ A3_2 : num  4 4 2 1 1 2 3 2 4 2 ...
#>  $ A3_3 : num  4 4 2 2 3 3 3 2 4 2 ...
#>  $ A3_4 : num  4 4 2 2 2 2 4 2 5 3 ...
#>  $ A3_5 : num  4 4 3 3 3 4 4 4 4 2 ...
#>  $ A3_6 : num  5 4 3 2 4 3 3 2 4 4 ...
#>  $ Int_1: num  2 4 3 4 2 1 6 7 1 0 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.96 2.25 1.08 0.95 0.80 0.68 0.65 0.56 0.47 0.40 0.36 0.24 0.21 0.17 0.13
    #> [16] 0.09
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.80 2.21 0.98 0.82 0.68 0.65 0.62 0.56 0.46 0.37 0.24 0.21 0.17 0.13 0.09
...
#>                alpha    0.800    0.715    0.869       4    64
#>          omega_total    0.871    0.826    0.911       4    64
#>        ordinal_alpha    0.770    0.619    0.820       4    64
#>  ordinal_omega_total    0.853    0.777    0.882       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
