...
#>  $ var1: num  2 2 4 2 3 2 3 3 2 4 ...
#>  $ var2: num  2 4 4 2 2 4 3 2 4 3 ...
#>  $ var3: num  3 3 5 2 1 5 4 3 5 3 ...
#>  $ var4: num  3 4 5 3 3 4 4 3 4 3 ...
```
...
head(df)
#>     BT       BS   BL      BLY
#> 1 3.50 4.000000 1.75 3.000000
#> 2 4.25 4.666667 4.00 5.000000
#> 3 3.75 3.666667 3.00 3.333333
#> 4 4.00 4.666667 3.50 4.333333
#> 5 4.00 4.000000 3.00 3.666667
#> 6 3.50 3.333333 3.50 3.666667
tail(df)
#>       BT       BS   BL      BLY
#> 251 4.75 4.666667 4.25 4.666667
#> 252 3.75 4.000000 2.75 3.666667
#> 253 3.00 3.666667 3.50 3.666667
#> 254 4.25 4.000000 3.25 4.000000
#> 255 4.25 4.333333 4.25 4.000000
#> 256 4.00 4.333333 4.00 4.000000
...
#>  $ X1: num  2 2.83 1.5 3 3.5 ...
#>  $ X2: num  2.33 4.83 1 3.83 2.83 ...
...
#>   ..$ time_1: num [1:32] 1 1.5 2.25 3.25 1.75 2.25 2.75 1 2 1.25 ...
#>   ..$ time_2: num [1:32] 1.25 2.25 3 4 1.75 3.5 2.5 1.5 3 3.25 ...
#>   ..$ time_3: num [1:32] 2.5 3 3 3.75 1 4.5 3.75 2.75 3.75 4.5 ...
#>   ..$ time_4: num [1:32] 2.75 4 3 2.5 1.5 3.25 2 2.75 3 4.25 ...
...
#>  $ A1_1 : num  2 2 3 1 2 4 3 3 3 2 ...
#>  $ A1_2 : num  3 2 2 2 2 2 4 2 2 1 ...
#>  $ A1_3 : num  3 3 4 2 3 4 4 4 3 2 ...
#>  $ A1_4 : num  3 3 4 2 3 5 4 4 3 3 ...
#>  $ A2_1 : num  3 2 3 2 1 2 3 3 2 2 ...
#>  $ A2_2 : num  3 2 3 2 1 4 3 4 2 2 ...
#>  $ A2_3 : num  3 2 4 2 2 4 3 5 2 3 ...
#>  $ A2_4 : num  3 1 3 2 1 4 4 4 3 2 ...
#>  $ A2_5 : num  4 2 4 2 3 4 4 4 4 2 ...
#>  $ A3_1 : num  3 3 3 2 2 3 2 3 3 2 ...
#>  $ A3_2 : num  3 3 2 2 2 2 2 2 3 2 ...
#>  $ A3_3 : num  4 4 2 2 3 4 2 3 4 3 ...
#>  $ A3_4 : num  4 3 2 3 3 4 4 4 3 4 ...
#>  $ A3_5 : num  3 3 3 3 4 4 4 3 4 4 ...
#>  $ A3_6 : num  4 4 3 3 4 4 3 4 3 3 ...
#>  $ Int_1: num  0 5 7 5 10 8 5 1 1 2 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.96 2.26 1.07 0.70 0.67 0.61 0.56 0.50 0.48 0.44 0.40 0.33 0.30 0.29 0.23
    #> [16] 0.22
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.80 2.23 0.79 0.67 0.64 0.59 0.54 0.48 0.44 0.42 0.35 0.31 0.29 0.23 0.22
...
#>                alpha    0.801    0.719    0.870       4    64
#>          omega_total    0.871    0.827    0.911       4    64
#>        ordinal_alpha    0.768    0.677    0.827       4    64
#>  ordinal_omega_total    0.852    0.805    0.886       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
