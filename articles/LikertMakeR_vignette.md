...
#>  $ var1: num  5 4 3 1 3 2 1 2 2 4 ...
#>  $ var2: num  3 4 3 3 3 5 2 1 4 4 ...
#>  $ var3: num  3 5 2 3 3 5 4 1 3 5 ...
#>  $ var4: num  4 5 3 3 3 4 4 2 4 5 ...
```
...
head(df)
#>     BT       BS   BL      BLY
#> 1 4.50 4.666667 4.00 4.666667
#> 2 3.50 4.333333 3.50 3.666667
#> 3 4.25 4.000000 4.00 5.000000
#> 4 3.25 3.666667 2.25 3.000000
#> 5 4.50 4.333333 4.75 4.666667
#> 6 4.25 4.333333 2.25 4.333333
tail(df)
#>       BT       BS   BL      BLY
#> 251 3.75 4.333333 3.25 3.333333
#> 252 3.75 4.000000 3.75 3.666667
#> 253 4.50 4.666667 4.25 4.333333
#> 254 3.50 3.333333 3.00 3.666667
#> 255 4.25 3.666667 3.25 3.333333
#> 256 4.50 4.333333 4.25 5.000000
...
#>  $ X1: num  2.17 2.67 3.17 2.67 2 ...
#>  $ X2: num  3.5 3.5 3.5 2.33 2.5 ...
...
#>   ..$ time_1: num [1:32] 1.5 1.5 2.5 1 3 1 2.5 4 1.5 1.75 ...
#>   ..$ time_2: num [1:32] 3.5 2 3 2 2.75 1.25 2.25 4 1.5 2.25 ...
#>   ..$ time_3: num [1:32] 3.5 1.5 2.5 3.25 4.25 2 2.5 3.75 1.25 3.75 ...
#>   ..$ time_4: num [1:32] 3.5 1.5 2 3.5 4 1.25 2.25 3.5 2.25 2.25 ...
...
#> item04   0.43   0.86   0.71   1.00   0.42   0.47
#> item05   0.71   0.47   0.71   0.42   1.00   0.42
#> item06   0.63   0.41   0.66   0.47   0.42   1.00
...
#>  $ A1_1 : num  3 2 2 2 2 3 3 4 2 2 ...
#>  $ A1_2 : num  3 3 1 2 1 3 3 3 3 2 ...
#>  $ A1_3 : num  3 2 1 3 2 3 3 4 3 2 ...
#>  $ A1_4 : num  4 4 3 2 2 4 3 4 4 3 ...
#>  $ A2_1 : num  2 3 2 2 2 3 3 3 2 2 ...
#>  $ A2_2 : num  2 3 2 2 1 2 4 3 2 3 ...
#>  $ A2_3 : num  3 3 2 3 3 4 3 3 3 3 ...
#>  $ A2_4 : num  3 3 1 3 2 4 3 4 4 3 ...
#>  $ A2_5 : num  4 4 3 4 3 4 3 4 2 3 ...
#>  $ A3_1 : num  3 3 1 2 2 2 2 2 3 2 ...
#>  $ A3_2 : num  3 2 2 2 2 1 3 3 3 2 ...
#>  $ A3_3 : num  3 3 2 3 2 2 3 3 3 2 ...
#>  $ A3_4 : num  3 2 2 2 2 1 4 4 3 2 ...
#>  $ A3_5 : num  5 4 3 4 3 3 2 3 4 2 ...
#>  $ A3_6 : num  4 4 2 2 2 3 4 4 4 3 ...
#>  $ Int_1: num  7 4 0 1 3 2 6 6 6 0 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.94 2.28 1.12 0.93 0.84 0.67 0.61 0.55 0.51 0.39 0.33 0.25 0.20 0.17 0.12
    #> [16] 0.10
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.78 2.25 0.94 0.84 0.80 0.67 0.58 0.54 0.41 0.34 0.25 0.20 0.17 0.12 0.10
...
#>                alpha    0.800    0.718    0.862       4    64
#>          omega_total    0.871    0.828    0.907       4    64
#>        ordinal_alpha    0.761    0.648    0.815       4    64
#>  ordinal_omega_total    0.849    0.792    0.879       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
