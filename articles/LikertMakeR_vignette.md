...
#>  $ var1: num  3 4 3 4 1 2 3 1 4 2 ...
#>  $ var2: num  2 3 3 2 1 2 3 3 3 2 ...
#>  $ var3: num  1 4 3 2 1 2 3 4 1 3 ...
#>  $ var4: num  3 4 3 3 3 3 4 4 3 4 ...
```
...
head(df)
#>     BT       BS   BL      BLY
#> 1 3.75 4.000000 2.75 4.333333
#> 2 4.25 4.333333 3.25 4.000000
#> 3 4.00 4.333333 3.50 4.000000
#> 4 4.00 4.333333 4.25 4.666667
#> 5 3.00 3.666667 1.75 2.666667
#> 6 4.50 4.666667 3.50 4.666667
tail(df)
#>       BT       BS   BL      BLY
#> 251 4.50 4.666667 4.00 5.000000
#> 252 4.25 3.000000 3.00 3.333333
#> 253 2.50 3.333333 2.50 3.000000
#> 254 3.75 4.000000 3.25 3.333333
#> 255 4.50 5.000000 4.25 4.333333
...
#>  $ X1: num  2.83 1.83 3.33 2.83 1.83 ...
...
#>   ..$ time_1: num [1:32] 1.25 1.75 2.5 2.5 1.75 1 2.25 2.75 2.5 1.5 ...
#>   ..$ time_2: num [1:32] 3 2.75 1.25 3.75 3.25 1.5 3 2.75 2 3 ...
#>   ..$ time_3: num [1:32] 3.75 3.5 1.5 4.25 3.75 1.25 2 3.25 3 2 ...
#>   ..$ time_4: num [1:32] 4.25 2.25 2.5 3 3.5 1.75 2.25 2 2.5 2 ...
...
#>  $ A1_1 : num  2 3 3 3 3 2 4 3 3 3 ...
#>  $ A1_2 : num  2 3 4 3 3 2 3 3 2 4 ...
#>  $ A1_3 : num  1 3 3 2 3 4 3 4 4 4 ...
#>  $ A1_4 : num  3 4 4 4 4 4 4 4 4 4 ...
#>  $ A2_1 : num  2 4 3 3 4 3 3 3 3 3 ...
#>  $ A2_2 : num  2 3 4 4 4 3 3 3 3 3 ...
#>  $ A2_3 : num  2 4 3 4 4 3 4 3 3 3 ...
#>  $ A2_4 : num  1 5 4 3 4 3 4 2 3 3 ...
#>  $ A2_5 : num  3 4 4 4 4 3 4 4 3 4 ...
#>  $ A3_1 : num  1 4 3 3 3 3 3 2 3 3 ...
#>  $ A3_2 : num  1 4 3 4 4 2 3 2 3 4 ...
#>  $ A3_3 : num  2 4 4 4 4 3 4 3 4 4 ...
#>  $ A3_4 : num  1 4 4 5 5 2 4 3 4 5 ...
#>  $ A3_5 : num  3 4 4 5 4 3 5 4 4 5 ...
#>  $ A3_6 : num  4 4 3 5 5 3 5 3 4 4 ...
#>  $ Int_1: num  0 6 0 6 0 5 6 6 2 4 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.97 2.26 1.06 0.77 0.67 0.63 0.56 0.51 0.44 0.41 0.40 0.33 0.30 0.28 0.25
    #> [16] 0.18
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.81 2.22 0.78 0.71 0.65 0.63 0.53 0.46 0.42 0.40 0.36 0.31 0.29 0.26 0.18
...
#>                alpha    0.799    0.702    0.860       4    64
#>          omega_total    0.870    0.818    0.906       4    64
#>        ordinal_alpha    0.764    0.629    0.816       4    64
#>  ordinal_omega_total    0.850    0.783    0.879       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
