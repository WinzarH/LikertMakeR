...
#>  $ var1: num  4 3 1 2 4 3 2 1 2 5 ...
#>  $ var2: num  3 4 3 3 3 4 2 3 3 3 ...
#>  $ var3: num  5 5 2 3 5 4 3 1 3 4 ...
#>  $ var4: num  4 5 3 4 4 4 3 3 3 4 ...
...
head(df)
#>     BT       BS   BL      BLY
#> 1 4.50 4.333333 4.75 4.333333
#> 2 4.75 4.666667 4.25 5.000000
#> 3 4.75 4.333333 4.50 4.333333
#> 4 4.50 4.666667 3.25 3.333333
#> 5 3.75 4.000000 3.00 4.333333
#> 6 3.50 4.333333 3.50 3.333333
tail(df)
#>       BT       BS   BL      BLY
#> 251 3.75 3.333333 2.50 3.333333
#> 252 4.25 4.333333 3.25 4.000000
#> 253 3.00 3.666667 3.00 3.333333
#> 254 4.50 5.000000 2.75 5.000000
#> 255 2.50 3.000000 2.50 3.333333
#> 256 3.00 4.333333 3.75 4.000000
...
#>   ..$ time_1: num [1:32] 2.25 1 3 2.75 1.25 1.75 2.75 2.5 2.75 2.25 ...
#>   ..$ time_2: num [1:32] 3 1.25 2.5 1.5 2.25 3.5 4 3.5 3 3 ...
#>   ..$ time_3: num [1:32] 4.25 2 1.75 2 3.75 3 4.75 4 2.5 1.25 ...
#>   ..$ time_4: num [1:32] 3.5 1.25 2 2.25 3.5 3.25 4 2.5 2.75 1.5 ...
...
cor(Att_3) |> round(2)
#>        item01 item02 item03 item04 item05 item06
#> item01   1.00   0.52   0.79   0.43   0.71   0.64
#> item02   0.52   1.00   0.72   0.86   0.47   0.41
#> item03   0.79   0.72   1.00   0.70   0.71   0.65
#> item04   0.43   0.86   0.70   1.00   0.43   0.46
#> item05   0.71   0.47   0.71   0.43   1.00   0.42
#> item06   0.64   0.41   0.65   0.46   0.42   1.00
...
#>  $ A1_1 : num  3 2 3 2 2 4 1 2 2 1 ...
#>  $ A1_2 : num  3 3 4 2 1 2 2 3 3 1 ...
#>  $ A1_3 : num  3 4 3 3 2 4 2 4 3 1 ...
#>  $ A1_4 : num  4 4 5 3 2 3 2 3 4 3 ...
#>  $ A2_1 : num  3 4 3 2 2 3 1 3 3 2 ...
#>  $ A2_2 : num  2 3 3 2 2 3 1 3 3 1 ...
#>  $ A2_3 : num  3 4 3 3 3 4 1 4 4 3 ...
#>  $ A2_4 : num  3 4 4 3 3 3 2 4 3 2 ...
#>  $ A2_5 : num  3 4 4 3 3 3 3 4 4 2 ...
#>  $ A3_1 : num  4 2 2 2 2 3 3 3 2 2 ...
#>  $ A3_2 : num  3 2 3 3 1 4 3 3 2 2 ...
#>  $ A3_3 : num  4 2 3 3 2 5 3 4 3 2 ...
#>  $ A3_4 : num  4 2 3 4 1 5 3 4 3 2 ...
#>  $ A3_5 : num  4 3 3 3 3 5 4 4 3 3 ...
#>  $ A3_6 : num  4 3 3 4 2 5 3 4 4 2 ...
#>  $ Int_1: num  4 0 7 4 2 4 0 4 1 0 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.92 2.26 1.17 0.98 0.74 0.68 0.57 0.56 0.47 0.42 0.36 0.25 0.21 0.17 0.13
    #> [16] 0.10
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.76 2.22 1.02 0.86 0.71 0.64 0.57 0.51 0.46 0.38 0.26 0.21 0.17 0.13 0.10
