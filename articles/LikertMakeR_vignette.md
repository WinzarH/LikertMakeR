...
#>  $ var1: num  2 3 1 3 5 2 2 5 3 4 ...
#>  $ var2: num  4 5 2 3 3 5 2 4 1 4 ...
#>  $ var3: num  5 5 1 3 5 5 2 3 1 5 ...
#>  $ var4: num  4 5 3 4 4 4 3 4 3 4 ...
...
head(df)
#>     BT       BS   BL      BLY
#> 1 4.25 4.333333 3.75 4.000000
#> 2 4.25 4.333333 3.50 4.333333
#> 3 4.75 4.666667 4.25 4.333333
#> 4 3.25 3.666667 4.00 3.666667
#> 5 4.00 4.666667 4.50 5.000000
#> 6 4.25 4.000000 3.50 3.666667
tail(df)
#>       BT       BS   BL      BLY
#> 251 3.50 4.000000 2.75 4.333333
#> 252 4.25 4.000000 3.50 4.666667
#> 253 4.50 4.666667 3.75 4.000000
#> 254 2.50 3.666667 3.25 3.666667
#> 255 4.25 4.333333 3.50 4.333333
#> 256 4.50 4.666667 3.50 4.333333
...
#>  $ X1: num  2 2.67 1.67 2 2.67 ...
#>  $ X2: num  3 3.17 2.5 2.5 1.83 ...
...
#>   ..$ time_1: num [1:32] 1.5 2.75 2.75 1.25 3 2.5 2.5 2.5 1.5 1 ...
#>   ..$ time_2: num [1:32] 2.75 3.5 3 1.75 3 1.75 4 2.75 3.75 2 ...
#>   ..$ time_3: num [1:32] 3.5 4.25 2.5 2 3.25 3.5 4.5 3.5 3.75 2.5 ...
#>   ..$ time_4: num [1:32] 2.75 3.5 1.5 3.25 2.5 2 4 3 3.5 2.25 ...
...
#> item04   0.43   0.86   0.70   1.00   0.44   0.47
#> item05   0.71   0.47   0.70   0.44   1.00   0.42
...
#>  $ A1_1 : num  2 2 2 4 2 3 3 2 3 2 ...
#>  $ A1_2 : num  3 2 1 4 3 3 4 2 3 2 ...
#>  $ A1_3 : num  3 2 3 4 3 3 5 4 2 3 ...
#>  $ A1_4 : num  4 3 2 4 4 4 4 3 4 3 ...
#>  $ A2_1 : num  2 2 2 3 3 3 3 2 3 1 ...
#>  $ A2_2 : num  2 2 2 2 2 4 4 2 2 1 ...
#>  $ A2_3 : num  3 3 2 4 3 3 4 2 3 2 ...
#>  $ A2_4 : num  3 3 2 4 3 3 4 2 3 2 ...
#>  $ A2_5 : num  3 3 3 4 3 4 4 2 4 2 ...
#>  $ A3_1 : num  2 3 1 3 2 3 3 2 2 2 ...
#>  $ A3_2 : num  3 3 2 4 3 3 3 3 3 2 ...
#>  $ A3_3 : num  3 3 2 4 3 3 3 3 3 2 ...
#>  $ A3_4 : num  3 4 2 4 3 3 4 4 4 2 ...
#>  $ A3_5 : num  4 3 2 4 3 3 4 3 3 3 ...
#>  $ A3_6 : num  3 5 2 4 3 4 4 4 4 2 ...
#>  $ Int_1: num  4 4 4 4 4 0 7 7 7 2 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.97 2.25 1.24 0.85 0.76 0.63 0.61 0.58 0.53 0.42 0.32 0.23 0.21 0.16 0.13
    #> [16] 0.10
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.81 2.21 1.06 0.81 0.67 0.63 0.59 0.57 0.46 0.33 0.23 0.22 0.17 0.14 0.10
