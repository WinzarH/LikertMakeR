...
#>  $ var1: num  3 2 3 2 2 4 5 3 2 4 ...
#>  $ var2: num  4 5 1 3 4 3 4 4 3 4 ...
#>  $ var3: num  5 5 1 3 5 5 3 4 2 5 ...
#>  $ var4: num  5 5 3 4 4 4 4 4 3 4 ...
```
...
head(df)
#>     BT       BS   BL      BLY
#> 1 4.50 4.333333 3.75 4.666667
#> 2 3.00 3.000000 3.25 3.333333
#> 3 4.00 4.666667 4.25 4.333333
#> 4 4.00 4.333333 4.50 4.000000
#> 5 4.50 4.666667 4.50 4.666667
#> 6 4.75 4.666667 4.50 4.666667
tail(df)
#>       BT       BS   BL      BLY
#> 251 3.00 4.000000 2.00 3.333333
#> 252 4.50 4.333333 4.00 4.333333
#> 253 4.50 4.000000 4.25 4.666667
#> 254 2.75 3.666667 2.25 3.333333
#> 255 3.00 2.666667 3.00 2.000000
#> 256 3.50 4.000000 2.50 4.000000
...
#>  $ X1: num  2 2.67 3.17 2.83 2.67 ...
#>  $ X2: num  3.5 3.5 3.5 2.33 1.83 ...
...
#>   ..$ time_1: num [1:32] 1.25 2.25 1.75 1.25 2.5 1.5 1.75 3 1.25 1.5 ...
#>   ..$ time_2: num [1:32] 2.5 3 2 1.25 2.5 2.75 2.5 3 1.75 1.5 ...
#>   ..$ time_3: num [1:32] 3.5 2.5 1.5 2 2 3.5 2 4.25 3 3.25 ...
#>   ..$ time_4: num [1:32] 4 3.25 2.25 1.75 2.25 3.5 2.25 3 2.75 4 ...
...
cor(Att_3) |> round(2)
#>        item01 item02 item03 item04 item05 item06
#> item01   1.00   0.53   0.80   0.43   0.71   0.63
#> item02   0.53   1.00   0.72   0.87   0.47   0.41
#> item03   0.80   0.72   1.00   0.71   0.71   0.66
#> item04   0.43   0.87   0.71   1.00   0.43   0.46
#> item05   0.71   0.47   0.71   0.43   1.00   0.42
#> item06   0.63   0.41   0.66   0.46   0.42   1.00
...
#>  $ A1_1 : num  3 2 2 2 2 4 3 1 2 2 ...
#>  $ A1_2 : num  3 2 1 2 1 3 3 1 2 1 ...
#>  $ A1_3 : num  3 3 2 3 2 3 3 1 3 2 ...
#>  $ A1_4 : num  5 2 3 3 2 4 4 3 3 3 ...
#>  $ A2_1 : num  3 3 2 2 2 3 2 2 2 2 ...
#>  $ A2_2 : num  3 3 2 3 2 3 1 2 4 1 ...
#>  $ A2_3 : num  3 2 2 3 3 3 3 1 3 2 ...
#>  $ A2_4 : num  4 3 1 2 3 3 3 2 3 2 ...
#>  $ A2_5 : num  4 4 3 3 3 4 4 2 4 4 ...
#>  $ A3_1 : num  2 2 2 3 1 4 4 2 2 3 ...
#>  $ A3_2 : num  2 1 1 2 2 4 4 2 2 2 ...
#>  $ A3_3 : num  2 2 2 3 1 4 4 3 2 3 ...
#>  $ A3_4 : num  3 1 2 2 3 5 4 3 2 2 ...
#>  $ A3_5 : num  3 2 3 4 1 5 4 3 3 4 ...
#>  $ A3_6 : num  4 3 3 4 3 4 4 3 3 3 ...
#>  $ Int_1: num  4 2 0 9 1 3 5 0 2 0 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.94 2.25 1.16 0.92 0.83 0.64 0.61 0.56 0.47 0.44 0.33 0.25 0.22 0.16 0.13
    #> [16] 0.09
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.78 2.22 0.95 0.92 0.74 0.63 0.58 0.52 0.47 0.33 0.25 0.22 0.17 0.13 0.09
...
#>                alpha    0.800    0.700    0.861       4    64
#>          omega_total    0.871    0.817    0.907       4    64
#>        ordinal_alpha    0.773    0.634    0.829       4    64
#>  ordinal_omega_total    0.855    0.785    0.887       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
