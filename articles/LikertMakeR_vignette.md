...
#>  $ var1: num  2 2 1 3 2 2 3 1 3 3 ...
#>  $ var2: num  2 4 4 3 2 4 4 2 3 3 ...
#>  $ var3: num  1 5 3 4 2 5 3 1 4 3 ...
#>  $ var4: num  3 4 4 4 3 4 4 2 4 4 ...
```
...
head(df)
#>     BT       BS   BL      BLY
#> 1 4.00 4.333333 3.50 4.666667
#> 2 4.00 4.000000 3.50 3.333333
#> 3 3.00 3.666667 2.75 2.666667
#> 4 3.50 4.000000 3.75 2.666667
#> 5 3.75 3.666667 2.75 4.000000
#> 6 3.75 4.000000 3.50 3.666667
tail(df)
#>       BT       BS   BL      BLY
#> 251 4.50 4.666667 4.00 4.666667
#> 252 4.00 4.666667 4.00 4.333333
#> 253 3.25 4.000000 3.50 3.000000
#> 254 3.50 4.000000 3.25 3.333333
#> 255 4.50 5.000000 4.50 4.666667
#> 256 3.75 4.333333 3.25 3.333333
...
#> t = -2.5073, df = 19, p-value = 0.02141
#> alternative hypothesis: true mean difference is not equal to 0
#> 95 percent confidence interval:
#>  -0.91737903 -0.08262097
#> sample estimates:
#> mean difference 
#>            -0.5
```
...
#>   ..$ time_1: num [1:32] 1.75 1.25 2.5 1.5 1 2.75 2 2 3 2.75 ...
#>   ..$ time_2: num [1:32] 2.5 3.25 3.75 1.5 3.25 3.5 2.5 2.75 3.25 2.75 ...
#>   ..$ time_3: num [1:32] 3 4.5 4 2.75 3.5 4 2.5 1.75 2.5 4.75 ...
#>   ..$ time_4: num [1:32] 3.75 4.5 3.5 3.5 3.25 3.75 3.5 1.25 2.5 4 ...
...
cor(Att_3) |> round(2)
#>        item01 item02 item03 item04 item05 item06
#> item01   1.00   0.47   0.68   0.67   0.61   0.55
...
#> item06   0.55   0.45   0.64   0.63   0.58   1.00
...
#>  $ A1_1 : num  3 3 2 3 2 2 2 2 2 3 ...
#>  $ A1_2 : num  4 3 2 3 2 2 2 1 2 2 ...
#>  $ A1_3 : num  4 3 2 3 2 3 1 3 3 3 ...
#>  $ A1_4 : num  5 3 3 4 3 4 4 2 3 3 ...
#>  $ A2_1 : num  3 3 2 3 1 2 2 2 2 3 ...
#>  $ A2_2 : num  2 3 2 2 2 3 2 2 1 2 ...
#>  $ A2_3 : num  4 4 3 3 2 3 3 2 3 3 ...
#>  $ A2_4 : num  3 3 3 3 2 3 3 2 2 3 ...
#>  $ A2_5 : num  4 3 3 3 3 4 3 3 3 4 ...
#>  $ A3_1 : num  3 2 2 2 2 2 2 2 2 2 ...
#>  $ A3_2 : num  3 4 2 3 2 2 1 2 2 3 ...
#>  $ A3_3 : num  4 4 3 3 3 3 2 2 3 2 ...
#>  $ A3_4 : num  4 3 3 2 2 2 2 3 3 3 ...
#>  $ A3_5 : num  4 4 3 4 3 3 3 3 3 4 ...
#>  $ A3_6 : num  5 4 4 3 3 3 3 3 3 3 ...
#>  $ Int_1: num  3 5 2 9 6 1 6 4 4 5 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.96 2.26 1.10 0.74 0.70 0.59 0.53 0.49 0.46 0.46 0.38 0.35 0.30 0.25 0.23
    #> [16] 0.19
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.80 2.22 0.84 0.74 0.63 0.58 0.50 0.48 0.46 0.38 0.37 0.31 0.26 0.23 0.20
...
#>                alpha    0.800    0.713    0.847       4    64
#>          omega_total    0.870    0.824    0.897       4    64
#>        ordinal_alpha    0.765    0.670    0.798       4    64
#>  ordinal_omega_total    0.850    0.802    0.869       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
