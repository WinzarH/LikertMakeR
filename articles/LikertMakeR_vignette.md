...
#>  $ var1: num  3 3 4 2 1 3 3 1 2 4 ...
#>  $ var2: num  2 3 4 5 3 3 4 3 3 3 ...
#>  $ var3: num  2 2 3 3 1 2 5 1 3 4 ...
...
head(df)
#>     BT       BS   BL      BLY
#> 1 3.00 4.000000 3.00 3.666667
#> 2 4.25 4.000000 4.00 4.000000
#> 3 3.75 3.333333 3.50 3.666667
#> 4 4.25 4.333333 4.00 4.333333
#> 5 4.50 4.333333 3.25 3.666667
#> 6 4.25 4.333333 3.75 4.000000
tail(df)
#>       BT       BS   BL      BLY
#> 251 4.50 4.666667 5.00 4.666667
#> 252 3.00 3.000000 2.00 4.000000
#> 253 3.50 3.666667 2.50 3.333333
#> 254 3.75 3.666667 3.50 4.333333
#> 255 3.50 4.000000 3.75 3.333333
#> 256 3.00 4.000000 3.75 3.666667
...
#>  $ X1: num  3.17 2.33 3 2.17 2.67 ...
#>  $ X2: num  2.33 2.83 4.83 4 3.67 ...
...
#>   ..$ time_1: num [1:32] 1.25 1.25 1.75 1 2.25 2.25 4 2 2.5 1.5 ...
#>   ..$ time_2: num [1:32] 1.5 2.75 1.5 2 3.5 2.25 4.5 2 2 3.25 ...
#>   ..$ time_3: num [1:32] 1.75 3.75 2.75 2.5 2.5 3.75 4 3 3 3.5 ...
#>   ..$ time_4: num [1:32] 2.75 4.25 2.75 1.5 2.5 3.25 2.5 2.75 1.5 3.75 ...
...
#>  $ A1_1 : num  4 3 2 2 2 2 1 1 2 2 ...
#>  $ A1_2 : num  3 2 1 3 3 2 2 1 2 2 ...
#>  $ A1_3 : num  4 3 2 2 3 2 2 2 3 3 ...
#>  $ A1_4 : num  3 3 3 3 3 3 2 3 2 4 ...
#>  $ A2_1 : num  3 2 2 2 2 2 1 3 3 3 ...
#>  $ A2_2 : num  3 1 2 2 2 3 1 2 2 4 ...
#>  $ A2_3 : num  3 3 2 3 3 3 2 4 3 4 ...
#>  $ A2_4 : num  3 3 2 2 2 3 2 2 3 3 ...
#>  $ A2_5 : num  4 4 3 4 2 4 3 3 2 4 ...
#>  $ A3_1 : num  2 3 2 2 3 3 2 3 2 3 ...
#>  $ A3_2 : num  2 4 2 2 4 3 2 2 2 3 ...
#>  $ A3_3 : num  3 4 2 2 3 3 2 3 4 3 ...
#>  $ A3_4 : num  4 4 2 1 4 3 2 3 2 4 ...
#>  $ A3_5 : num  3 4 2 3 4 3 3 4 3 5 ...
#>  $ A3_6 : num  3 4 2 2 5 4 2 3 3 4 ...
#>  $ Int_1: num  1 1 0 9 7 2 1 1 1 1 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.95 2.30 1.13 0.69 0.63 0.62 0.59 0.51 0.46 0.41 0.38 0.31 0.30 0.27 0.24
    #> [16] 0.22
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.79 2.26 0.78 0.68 0.62 0.61 0.58 0.50 0.46 0.38 0.32 0.31 0.27 0.24 0.22
...
#>              lambda6    0.758       4    64
#>        ordinal_alpha    0.768       4    64
#>  ordinal_omega_total    0.852       4    64
#>                                                notes
...
#>                alpha    0.801    0.709    0.864       4    64
#>          omega_total    0.871    0.821    0.908       4    64
#>        ordinal_alpha    0.768    0.640    0.836       4    64
#>  ordinal_omega_total    0.852    0.788    0.891       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
