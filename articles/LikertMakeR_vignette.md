...
#>  $ var1: num  3 4 2 4 3 3 2 2 1 4 ...
#>  $ var2: num  3 4 5 4 3 3 3 4 2 2 ...
#>  $ var3: num  5 5 5 4 4 4 4 4 1 1 ...
#>  $ var4: num  4 5 4 4 4 4 4 4 3 3 ...
```
...
#> 2 3.75 3.333333 3.25 3.000000
#> 3 4.00 4.000000 3.50 3.666667
#> 4 3.00 3.666667 2.25 2.666667
#> 5 3.50 3.333333 3.50 3.666667
#> 6 4.25 4.000000 4.25 4.000000
tail(df)
#>       BT       BS   BL      BLY
#> 251 3.25 3.333333 2.00 3.333333
#> 252 4.75 5.000000 4.75 5.000000
#> 253 3.00 3.666667 3.25 3.666667
#> 254 3.75 4.000000 4.50 3.666667
#> 255 3.75 3.666667 4.25 4.000000
#> 256 3.75 4.000000 3.00 4.333333
...
#>   ..$ time_1: num [1:32] 2.75 2.75 1.5 1.25 2.25 2.5 1.75 3 1.75 1 ...
#>   ..$ time_2: num [1:32] 3 3.5 2.75 1.75 2.25 3.25 3 3 1.75 1.75 ...
#>   ..$ time_3: num [1:32] 3.5 4.25 3 3.5 3.25 2.5 3 3.75 2.5 1.25 ...
#>   ..$ time_4: num [1:32] 3 3.5 3 3.5 2.5 1.25 1.75 3.5 2.75 1.5 ...
...
#> item03   0.80   0.72   1.00   0.71   0.71   0.65
#> item04   0.43   0.87   0.71   1.00   0.43   0.46
#> item05   0.71   0.47   0.71   0.43   1.00   0.43
#> item06   0.64   0.41   0.65   0.46   0.43   1.00
...
#>  $ A1_1 : num  3 2 2 3 3 2 2 3 2 2 ...
#>  $ A1_2 : num  4 2 1 3 2 2 3 3 2 1 ...
#>  $ A1_3 : num  3 3 2 4 3 2 4 2 3 2 ...
#>  $ A1_4 : num  5 2 3 4 4 3 4 4 3 3 ...
#>  $ A2_1 : num  3 2 2 2 1 2 3 4 1 3 ...
#>  $ A2_2 : num  3 2 2 3 2 1 3 3 2 2 ...
#>  $ A2_3 : num  3 2 3 3 3 2 3 4 3 2 ...
#>  $ A2_4 : num  3 3 2 3 2 2 4 4 2 3 ...
#>  $ A2_5 : num  3 4 3 4 3 2 4 4 3 4 ...
#>  $ A3_1 : num  4 1 3 3 2 2 3 2 2 2 ...
#>  $ A3_2 : num  2 2 2 4 2 2 2 3 2 1 ...
#>  $ A3_3 : num  4 1 3 4 2 2 3 3 2 2 ...
#>  $ A3_4 : num  2 2 2 4 2 2 2 4 3 1 ...
#>  $ A3_5 : num  4 3 4 4 3 3 4 4 3 3 ...
#>  $ A3_6 : num  4 2 4 3 4 2 4 2 4 2 ...
#>  $ Int_1: num  4 4 1 7 9 1 6 4 5 0 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.98 2.27 1.11 0.95 0.85 0.63 0.61 0.56 0.50 0.41 0.31 0.25 0.20 0.17 0.13
    #> [16] 0.08
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.82 2.24 1.00 0.85 0.75 0.62 0.60 0.51 0.46 0.31 0.25 0.21 0.17 0.13 0.08
...
#>                alpha    0.800    0.701    0.873       4    64
#>          omega_total    0.871    0.819    0.914       4    64
#>        ordinal_alpha    0.768    0.613    0.833       4    64
#>  ordinal_omega_total    0.852    0.776    0.889       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
