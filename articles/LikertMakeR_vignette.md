...
#>  $ var1: num  2 3 3 3 2 2 1 2 2 3 ...
#>  $ var2: num  4 5 4 3 2 4 4 1 4 4 ...
#>  $ var3: num  2 4 5 5 1 4 4 2 5 3 ...
#>  $ var4: num  3 4 5 4 3 4 4 3 4 4 ...
```
...
head(df)
#>     BT       BS   BL      BLY
#> 1 3.00 3.666667 2.75 3.000000
#> 2 4.00 5.000000 3.75 4.333333
#> 3 4.25 4.000000 4.25 3.666667
#> 4 4.50 4.666667 4.75 4.666667
#> 5 4.25 4.333333 4.00 3.333333
#> 6 3.75 3.666667 3.50 4.333333
tail(df)
#>       BT       BS   BL      BLY
#> 251 4.25 4.000000 3.75 3.666667
#> 252 3.00 3.000000 1.50 3.000000
#> 253 2.50 3.333333 3.50 3.333333
#> 254 3.75 4.666667 3.75 4.666667
#> 255 4.25 4.666667 4.25 4.333333
#> 256 3.00 3.000000 2.75 2.666667
...
#>  $ X1: num  2.17 3 3 2.33 3 ...
#>  $ X2: num  2.33 2.83 4 3.83 4.83 ...
...
#>   ..$ time_1: num [1:32] 1.75 4 1.5 3.25 1.25 1.25 2.5 2 1 2.5 ...
#>   ..$ time_2: num [1:32] 2.25 2 3 3.5 1.5 1.5 2.5 1.5 1.75 4 ...
#>   ..$ time_3: num [1:32] 2.25 3.75 4.5 3.25 1 2.75 2.5 1 3 4.5 ...
#>   ..$ time_4: num [1:32] 3.25 3.25 3 1.75 2 3 2 2.75 3.5 3.75 ...
...
#>  $ A1_1 : num  3 2 2 1 4 3 3 3 2 2 ...
#>  $ A1_2 : num  2 2 2 2 3 4 1 3 2 2 ...
#>  $ A1_3 : num  4 2 3 2 3 4 2 4 2 2 ...
#>  $ A1_4 : num  3 3 3 4 4 4 2 4 2 4 ...
#>  $ A2_1 : num  3 1 2 3 3 4 2 3 2 2 ...
#>  $ A2_2 : num  2 1 2 2 2 3 2 3 3 2 ...
#>  $ A2_3 : num  2 2 3 2 3 3 2 3 2 2 ...
#>  $ A2_4 : num  2 2 3 3 3 4 3 4 2 2 ...
#>  $ A2_5 : num  3 3 3 3 4 4 4 4 3 2 ...
#>  $ A3_1 : num  3 3 3 4 3 4 2 3 1 2 ...
#>  $ A3_2 : num  3 3 3 2 3 4 2 3 2 2 ...
#>  $ A3_3 : num  3 3 3 4 4 4 3 4 2 3 ...
#>  $ A3_4 : num  3 3 5 4 3 4 3 4 2 3 ...
#>  $ A3_5 : num  4 4 4 3 3 4 4 3 3 3 ...
#>  $ A3_6 : num  4 4 4 4 4 5 4 4 3 3 ...
#>  $ Int_1: num  4 1 0 6 9 5 1 2 1 2 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.94 2.27 1.08 0.73 0.65 0.63 0.61 0.50 0.48 0.43 0.37 0.34 0.32 0.26 0.20
    #> [16] 0.19
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.78 2.24 0.76 0.67 0.64 0.62 0.59 0.50 0.46 0.39 0.34 0.32 0.28 0.20 0.20
...
#>                alpha    0.801    0.702    0.870       4    64
#>          omega_total    0.871    0.820    0.912       4    64
#>        ordinal_alpha    0.770    0.622    0.838       4    64
#>  ordinal_omega_total    0.854    0.780    0.892       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
