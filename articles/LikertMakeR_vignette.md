...
#>  $ var1: num  4 4 1 4 5 4 2 2 1 3 ...
#>  $ var2: num  4 4 4 3 3 5 3 3 2 1 ...
#>  $ var3: num  5 5 5 1 5 5 3 5 2 3 ...
#>  $ var4: num  5 5 5 3 5 5 3 4 3 3 ...
```
...
head(df)
#>     BT       BS   BL      BLY
#> 1 4.25 4.333333 3.25 4.666667
#> 2 4.00 4.333333 4.25 4.333333
#> 3 4.50 4.666667 4.25 4.666667
#> 4 3.00 3.333333 3.00 3.000000
#> 5 4.50 4.333333 3.75 4.000000
#> 6 4.25 4.000000 4.00 4.666667
tail(df)
#>       BT       BS   BL      BLY
#> 251 3.00 3.333333 2.00 2.666667
#> 252 4.25 4.333333 3.75 4.666667
#> 253 4.75 4.666667 3.75 4.333333
#> 254 3.00 3.666667 4.00 4.000000
#> 255 4.00 4.333333 3.50 4.333333
#> 256 4.50 4.666667 3.50 4.666667
...
#>   ..$ time_1: num [1:32] 1.25 1.75 2.75 2.75 1.5 1.5 1.5 3 2.25 2 ...
#>   ..$ time_2: num [1:32] 1.5 1.75 3.5 2.75 1.5 3 2.5 3.75 2.25 1.25 ...
#>   ..$ time_3: num [1:32] 2 3.25 3 2 1.75 3 3.25 4.75 2.5 2.25 ...
#>   ..$ time_4: num [1:32] 2.25 3 2.25 2.75 2.25 4 2.5 3 1.75 1.5 ...
...
cor(Att_3) |> round(2)
#>        item01 item02 item03 item04 item05 item06
#> item01   1.00   0.54   0.80   0.43   0.71   0.64
#> item02   0.54   1.00   0.71   0.86   0.47   0.42
#> item03   0.80   0.71   1.00   0.70   0.71   0.65
#> item04   0.43   0.86   0.70   1.00   0.43   0.47
#> item05   0.71   0.47   0.71   0.43   1.00   0.43
#> item06   0.64   0.42   0.65   0.47   0.43   1.00
...
#>  $ A1_1 : num  2 4 2 2 4 3 3 3 2 2 ...
#>  $ A1_2 : num  1 3 3 2 2 3 4 3 2 2 ...
#>  $ A1_3 : num  2 3 3 2 3 4 4 3 3 2 ...
#>  $ A1_4 : num  2 5 4 3 3 4 5 4 3 3 ...
#>  $ A2_1 : num  1 3 2 1 3 3 3 2 3 2 ...
#>  $ A2_2 : num  2 4 2 1 3 3 4 4 3 3 ...
#>  $ A2_3 : num  2 4 2 2 4 3 4 4 4 2 ...
#>  $ A2_4 : num  2 4 3 2 4 4 4 3 4 2 ...
#>  $ A2_5 : num  2 4 4 2 4 3 5 3 4 3 ...
#>  $ A3_1 : num  2 4 2 2 2 4 2 3 2 2 ...
#>  $ A3_2 : num  2 4 3 3 1 3 2 4 2 2 ...
#>  $ A3_3 : num  2 4 3 2 2 5 3 4 3 1 ...
#>  $ A3_4 : num  2 5 3 3 2 4 3 4 3 2 ...
#>  $ A3_5 : num  3 4 3 2 3 4 3 4 3 2 ...
#>  $ A3_6 : num  3 5 3 3 4 5 4 4 4 3 ...
#>  $ Int_1: num  0 4 0 2 5 4 8 5 1 5 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.96 2.24 1.07 0.95 0.80 0.70 0.60 0.57 0.49 0.42 0.36 0.24 0.21 0.16 0.14
    #> [16] 0.09
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.79 2.20 0.95 0.82 0.71 0.70 0.57 0.55 0.49 0.37 0.25 0.21 0.16 0.14 0.09
...
#>              lambda6    0.797       4    64
#>        ordinal_alpha    0.776       4    64
#>  ordinal_omega_total    0.857       4    64
#>                                                notes
...
#>                alpha    0.800    0.698    0.847       4    64
#>          omega_total    0.871    0.817    0.898       4    64
#>        ordinal_alpha    0.776    0.650    0.809       4    64
#>  ordinal_omega_total    0.857    0.793    0.875       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
