...
#>  $ var1: num  1 4 3 3 2 3 1 2 2 2 ...
#>  $ var2: num  3 4 4 2 3 3 5 3 3 1 ...
#>  $ var3: num  2 3 4 3 1 4 4 3 2 2 ...
#>  $ var4: num  3 4 4 3 3 4 4 3 3 3 ...
```
...
head(df)
#>     BT       BS   BL      BLY
#> 1 4.25 3.666667 2.75 3.333333
#> 2 4.25 4.333333 4.50 5.000000
#> 3 4.25 4.333333 2.75 4.000000
#> 4 4.25 4.333333 3.25 4.000000
#> 5 3.25 3.666667 3.75 4.000000
#> 6 3.00 4.000000 1.75 3.000000
tail(df)
#>       BT       BS   BL      BLY
#> 251 4.50 4.666667 4.00 4.666667
#> 252 2.75 3.000000 1.50 2.666667
#> 253 2.50 3.333333 3.00 3.333333
#> 254 3.75 3.000000 4.00 3.333333
#> 255 4.00 4.333333 4.75 4.333333
#> 256 2.75 3.000000 3.25 2.666667
...
#>  $ X1: num  1.67 2.83 2.83 2.17 3.17 ...
#>  $ X2: num  2.33 2.83 3.67 3.83 4 ...
...
#>   ..$ time_1: num [1:32] 1.25 1.25 1.5 3.25 1 2.75 1.25 1.25 1 3.5 ...
#>   ..$ time_2: num [1:32] 1.5 2.25 2.5 4 1.5 3 1.5 1.75 2 3.5 ...
#>   ..$ time_3: num [1:32] 2 2.75 3 3.75 3 3.75 2.5 3.25 3.75 4 ...
#>   ..$ time_4: num [1:32] 2.75 2.75 2 1.5 3.75 3.25 2 3.5 3 4.25 ...
...
#>  $ A1_1 : num  1 3 2 3 3 3 2 1 2 3 ...
#>  $ A1_2 : num  1 3 2 3 2 4 2 3 2 3 ...
#>  $ A1_3 : num  3 5 3 3 4 4 2 2 2 3 ...
#>  $ A1_4 : num  3 4 4 4 3 3 3 4 3 2 ...
#>  $ A2_1 : num  2 3 2 3 2 3 2 2 3 2 ...
#>  $ A2_2 : num  2 3 1 3 3 3 1 3 3 2 ...
#>  $ A2_3 : num  3 3 2 2 3 3 2 3 3 2 ...
#>  $ A2_4 : num  2 4 2 2 3 3 2 3 4 3 ...
#>  $ A2_5 : num  3 5 2 3 4 2 2 3 4 4 ...
#>  $ A3_1 : num  2 2 3 3 3 3 2 2 1 3 ...
#>  $ A3_2 : num  1 2 3 3 2 4 2 2 2 3 ...
#>  $ A3_3 : num  2 2 3 3 3 4 3 3 2 4 ...
#>  $ A3_4 : num  2 2 4 4 2 3 4 4 2 2 ...
#>  $ A3_5 : num  2 3 4 5 4 4 3 3 3 5 ...
#>  $ A3_6 : num  1 2 4 4 4 5 3 3 3 4 ...
#>  $ Int_1: num  5 5 0 9 3 8 2 2 1 7 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.97 2.23 1.07 0.73 0.68 0.60 0.52 0.49 0.49 0.42 0.40 0.35 0.30 0.27 0.27
    #> [16] 0.21
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.81 2.19 0.79 0.72 0.64 0.60 0.49 0.49 0.43 0.40 0.36 0.32 0.27 0.27 0.21
...
#>                alpha    0.801    0.728    0.869       4    64
#>          omega_total    0.871    0.831    0.911       4    64
#>        ordinal_alpha    0.762    0.632    0.815       4    64
#>  ordinal_omega_total    0.849    0.784    0.879       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
