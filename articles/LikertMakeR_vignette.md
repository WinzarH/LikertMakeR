...
#>  $ var1: num  2 3 3 3 2 2 3 3 3 2 ...
#>  $ var2: num  2 3 3 4 4 2 4 3 3 4 ...
#>  $ var3: num  1 3 4 4 4 4 5 3 4 3 ...
#>  $ var4: num  3 4 4 4 4 4 4 4 4 4 ...
```
...
#> var3 0.350 0.70 1.000 0.829
#> var4 0.448 0.75 0.829 1.000
```
...
head(df)
#>     BT       BS   BL      BLY
#> 1 3.75 4.000000 2.25 3.000000
#> 2 4.25 4.666667 4.50 5.000000
#> 3 4.00 4.000000 3.75 3.333333
#> 4 4.25 4.333333 3.50 4.333333
#> 5 3.00 3.666667 1.75 4.333333
#> 6 4.25 4.000000 3.50 4.000000
tail(df)
#>       BT       BS   BL      BLY
#> 251 4.25 4.333333 4.75 4.666667
#> 252 2.75 3.000000 1.50 2.666667
#> 253 4.25 4.333333 3.25 4.333333
#> 254 3.50 3.666667 3.00 4.000000
#> 255 4.50 4.666667 4.50 5.000000
#> 256 3.75 3.000000 3.00 3.666667
...
#>  $ X1: num  2.5 4 2 2 2.33 ...
#>  $ X2: num  2.83 3.5 2.5 3.5 2.67 ...
...
#>   ..$ time_1: num [1:32] 2.5 2.5 3.25 2.5 1.75 1.5 1.5 2 3.25 1 ...
#>   ..$ time_2: num [1:32] 3.75 3 3 3.5 2.75 2 1.75 3 4.25 1.25 ...
#>   ..$ time_3: num [1:32] 3.5 3.25 3.25 4.5 3.25 3 3 2.25 3.5 1.25 ...
#>   ..$ time_4: num [1:32] 3.5 3.5 3 3.5 3.25 3.25 3 1.75 2 3.25 ...
...
#>  $ A1_1 : num  2 3 2 2 3 3 2 2 3 3 ...
#>  $ A1_2 : num  2 4 2 2 2 2 3 2 2 4 ...
#>  $ A1_3 : num  2 3 4 4 3 3 3 3 4 3 ...
#>  $ A1_4 : num  3 4 3 2 4 3 4 3 4 4 ...
#>  $ A2_1 : num  2 3 2 3 2 3 3 3 2 3 ...
#>  $ A2_2 : num  2 2 2 2 4 3 2 2 3 3 ...
#>  $ A2_3 : num  3 4 3 3 3 3 2 3 3 4 ...
#>  $ A2_4 : num  3 3 4 2 3 3 4 2 2 4 ...
#>  $ A2_5 : num  3 4 3 3 3 4 3 3 3 5 ...
#>  $ A3_1 : num  3 3 3 2 2 2 4 3 3 4 ...
#>  $ A3_2 : num  2 3 3 2 3 3 3 2 3 3 ...
#>  $ A3_3 : num  3 4 3 2 3 2 4 4 4 4 ...
#>  $ A3_4 : num  2 4 3 1 3 4 3 4 5 4 ...
#>  $ A3_5 : num  3 4 3 3 3 3 4 4 5 4 ...
#>  $ A3_6 : num  3 5 3 2 3 4 4 4 5 4 ...
#>  $ Int_1: num  1 7 3 0 3 0 10 0 9 9 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.96 2.23 1.07 0.95 0.79 0.65 0.52 0.50 0.41 0.39 0.32 0.30 0.25 0.24 0.22
    #> [16] 0.20
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.80 2.19 0.96 0.82 0.65 0.64 0.50 0.42 0.40 0.32 0.31 0.30 0.25 0.24 0.20
...
#>                alpha    0.799    0.722    0.858       4    64
#>          omega_total    0.870    0.829    0.905       4    64
#>        ordinal_alpha    0.753    0.654    0.814       4    64
#>  ordinal_omega_total    0.844    0.794    0.878       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
