...
#>  $ var1: num  3 4 2 3 2 3 2 3 1 3 ...
#>  $ var2: num  3 4 3 3 3 5 3 3 5 4 ...
#>  $ var3: num  1 5 4 4 5 5 2 5 5 5 ...
#>  $ var4: num  3 5 4 4 4 4 3 4 4 5 ...
```
...
head(df)
#>     BT       BS   BL      BLY
#> 1 4.50 4.333333 3.75 4.333333
#> 2 4.25 4.333333 4.00 4.333333
#> 3 4.50 4.333333 4.25 4.666667
#> 4 3.00 3.000000 3.00 3.000000
#> 5 4.50 4.666667 4.25 5.000000
#> 6 4.25 4.333333 3.75 4.333333
tail(df)
#>       BT       BS   BL      BLY
#> 251 3.00 3.666667 4.00 3.666667
#> 252 4.75 5.000000 4.00 4.666667
#> 253 3.75 4.000000 4.25 4.333333
#> 254 3.75 3.666667 3.00 4.000000
#> 255 3.50 4.000000 3.50 3.333333
#> 256 4.25 4.000000 3.50 4.333333
...
#>  $ X1: num  2.17 3.33 2.67 1.33 2 ...
#>  $ X2: num  3 3.5 3.5 2.33 2.17 ...
...
#>   ..$ time_1: num [1:32] 1.25 1.25 1.5 1 4 2.75 2.25 3 1.5 1 ...
#>   ..$ time_2: num [1:32] 1.25 1.25 2 1.25 3 4 2.5 3 2.25 1.25 ...
#>   ..$ time_3: num [1:32] 1.75 2 2.25 1.25 3.25 3.5 2.5 3 3.75 1.75 ...
#>   ..$ time_4: num [1:32] 3 1.25 2 2.25 1.5 2.5 2.5 3.5 3.5 1.5 ...
...
cor(Att_3) |> round(2)
#>        item01 item02 item03 item04 item05 item06
#> item01   1.00   0.53   0.76   0.43   0.69   0.64
#> item02   0.53   1.00   0.72   0.87   0.47   0.41
#> item03   0.76   0.72   1.00   0.71   0.71   0.66
...
#>  $ A1_1 : num  2 3 2 2 2 2 3 2 3 2 ...
#>  $ A1_2 : num  2 2 2 2 2 2 3 2 3 1 ...
#>  $ A1_3 : num  2 2 2 3 3 3 4 3 4 2 ...
#>  $ A1_4 : num  3 4 3 3 2 3 4 2 3 3 ...
#>  $ A2_1 : num  2 3 1 2 2 2 3 3 2 2 ...
#>  $ A2_2 : num  2 3 1 2 2 1 4 2 3 2 ...
#>  $ A2_3 : num  3 3 1 3 2 2 3 3 1 2 ...
#>  $ A2_4 : num  2 3 2 3 2 2 4 3 3 2 ...
#>  $ A2_5 : num  4 4 2 3 3 4 4 2 4 2 ...
#>  $ A3_1 : num  2 3 3 1 2 3 3 2 2 2 ...
#>  $ A3_2 : num  2 4 2 2 2 2 4 2 5 2 ...
#>  $ A3_3 : num  2 4 3 2 1 3 4 3 4 2 ...
#>  $ A3_4 : num  2 5 2 3 2 2 4 3 5 2 ...
#>  $ A3_5 : num  2 4 4 2 3 3 4 4 4 3 ...
#>  $ A3_6 : num  3 4 4 3 2 5 4 3 3 3 ...
#>  $ Int_1: num  4 1 6 2 6 3 8 0 4 0 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.93 2.29 1.07 1.00 0.81 0.63 0.60 0.53 0.47 0.43 0.37 0.25 0.22 0.17 0.13
    #> [16] 0.09
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.77 2.25 1.00 0.84 0.72 0.62 0.57 0.53 0.46 0.37 0.25 0.22 0.17 0.13 0.09
...
#>                alpha    0.799    0.691    0.860       4    64
#>          omega_total    0.870    0.813    0.905       4    64
#>        ordinal_alpha    0.764    0.605    0.811       4    64
#>  ordinal_omega_total    0.850    0.772    0.876       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
