...
#>  $ var1: num  2 3 4 3 3 2 3 1 2 3 ...
#>  $ var2: num  3 4 4 5 3 4 4 3 4 2 ...
#>  $ var3: num  2 5 5 5 2 5 5 1 2 1 ...
#>  $ var4: num  3 4 5 5 3 4 4 3 3 3 ...
```
...
#> 2 4.50 4.333333 4.25 3.333333
#> 3 4.25 4.000000 4.25 3.666667
#> 4 4.00 4.000000 2.75 4.333333
#> 5 3.50 3.666667 3.50 3.333333
#> 6 4.25 4.666667 3.50 4.666667
tail(df)
#>       BT       BS   BL      BLY
#> 251 5.00 4.666667 4.00 5.000000
#> 252 3.75 3.000000 3.00 4.000000
#> 253 3.00 4.000000 3.25 3.666667
#> 254 4.50 4.333333 4.00 4.333333
#> 255 3.50 4.333333 3.00 3.666667
#> 256 3.00 3.000000 3.25 3.333333
...
#>  $ X1: num  3.17 2.33 2.83 2.83 3 ...
#>  $ X2: num  3.67 4 2.33 3.83 4.83 ...
...
#>   ..$ time_1: num [1:32] 2 1.25 1 4 1.5 2.25 2 3 1.25 2.25 ...
#>   ..$ time_2: num [1:32] 3.5 1.25 1.5 4 2 3 2.5 2.25 2 3.25 ...
#>   ..$ time_3: num [1:32] 3.75 2.5 1.75 3.75 3 4 3.75 2.75 3 4.5 ...
#>   ..$ time_4: num [1:32] 2.75 3 1.75 2 3.25 2.5 3.25 2 3 4.25 ...
...
cor(Att_3) |> round(2)
#>        item01 item02 item03 item04 item05 item06
#> item01   1.00   0.71   0.63   0.49   0.58   0.70
#> item02   0.71   1.00   0.68   0.53   0.63   0.75
#> item03   0.63   0.68   1.00   0.47   0.55   0.66
#> item04   0.49   0.53   0.47   1.00   0.44   0.53
...
#>  $ A1_1 : num  2 2 1 2 3 3 3 3 1 3 ...
#>  $ A1_2 : num  1 2 2 2 3 3 4 3 1 2 ...
#>  $ A1_3 : num  2 2 3 2 3 4 4 3 2 3 ...
#>  $ A1_4 : num  3 4 4 4 3 4 4 4 3 3 ...
#>  $ A2_1 : num  2 2 2 4 2 3 3 3 2 2 ...
#>  $ A2_2 : num  1 3 2 3 2 3 4 2 1 3 ...
#>  $ A2_3 : num  2 3 2 4 3 3 4 4 2 3 ...
#>  $ A2_4 : num  2 3 3 3 2 4 4 3 2 3 ...
#>  $ A2_5 : num  3 4 3 3 3 4 3 2 2 4 ...
#>  $ A3_1 : num  2 2 2 2 3 3 2 3 2 2 ...
#>  $ A3_2 : num  1 2 2 2 3 3 3 3 2 2 ...
#>  $ A3_3 : num  1 1 2 3 4 4 3 3 2 2 ...
#>  $ A3_4 : num  2 2 2 3 2 4 4 3 3 2 ...
#>  $ A3_5 : num  3 3 3 3 3 3 4 4 3 3 ...
#>  $ A3_6 : num  2 3 3 3 4 5 3 4 3 3 ...
#>  $ Int_1: num  1 7 0 4 2 10 3 7 0 2 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.93 2.26 1.07 0.80 0.68 0.57 0.54 0.51 0.46 0.43 0.37 0.35 0.30 0.27 0.24
    #> [16] 0.21
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.77 2.23 0.80 0.74 0.68 0.55 0.52 0.47 0.45 0.39 0.35 0.32 0.28 0.24 0.21
...
#>                alpha    0.801    0.693    0.865       4    64
#>          omega_total    0.871    0.814    0.909       4    64
#>        ordinal_alpha    0.763    0.668    0.824       4    64
#>  ordinal_omega_total    0.850    0.802    0.884       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
