...
#>  $ var1: num  4 3 2 1 4 3 2 2 2 2 ...
#>  $ var2: num  2 3 4 3 3 3 4 3 2 4 ...
#>  $ var3: num  1 3 5 2 4 5 3 2 3 5 ...
#>  $ var4: num  3 4 5 3 4 4 4 3 3 4 ...
```
...
#> var3 0.345 0.70 1.000 0.850
#> var4 0.448 0.75 0.850 1.000
```
...
#> 2 3.00 4.000000 3.00 3.333333
#> 3 3.50 4.000000 3.75 4.000000
#> 4 3.75 4.333333 3.50 4.333333
#> 5 3.75 4.000000 4.00 4.333333
#> 6 3.25 3.333333 2.75 3.000000
tail(df)
#>       BT       BS   BL      BLY
#> 251 4.00 4.333333 4.25 4.666667
#> 252 3.75 4.333333 3.25 3.666667
#> 253 4.00 4.000000 3.50 3.333333
#> 254 4.25 4.000000 3.25 3.666667
...
#>  $ X1: num  2 2.83 3 3 2.67 ...
#>  $ X2: num  2.33 3.5 3.67 3.83 4.83 ...
...
#>   ..$ time_1: num [1:32] 1.75 3.5 2 2.25 1 2.5 3 2 1.75 2 ...
#>   ..$ time_2: num [1:32] 1.5 3 2 3 2 2 2 2.25 2.5 3.25 ...
#>   ..$ time_3: num [1:32] 2.25 4.5 3.25 3 4 1.75 3 2.75 3 4 ...
#>   ..$ time_4: num [1:32] 2.5 2.75 3.5 2.75 3 2.5 2 3.25 3.5 4.25 ...
...
#>  $ A1_1 : num  2 2 2 3 2 2 2 3 2 3 ...
#>  $ A1_2 : num  2 2 2 3 2 2 2 3 4 4 ...
#>  $ A1_3 : num  2 2 3 3 3 3 3 4 4 3 ...
#>  $ A1_4 : num  2 3 3 4 4 4 3 4 3 4 ...
#>  $ A2_1 : num  2 3 2 4 2 2 3 2 3 3 ...
#>  $ A2_2 : num  1 3 4 4 2 4 2 3 4 3 ...
#>  $ A2_3 : num  3 3 3 3 2 4 2 3 4 4 ...
#>  $ A2_4 : num  2 4 4 3 2 4 2 2 4 4 ...
#>  $ A2_5 : num  3 4 3 4 2 4 3 4 4 5 ...
#>  $ A3_1 : num  2 2 3 2 2 3 2 2 3 3 ...
#>  $ A3_2 : num  2 1 2 1 2 3 3 2 3 3 ...
#>  $ A3_3 : num  2 2 3 2 3 4 3 3 4 4 ...
#>  $ A3_4 : num  2 2 2 2 3 4 3 4 4 3 ...
#>  $ A3_5 : num  2 3 3 2 4 5 4 3 3 4 ...
#>  $ A3_6 : num  2 3 3 2 3 5 4 3 4 4 ...
#>  $ Int_1: num  0 0 1 8 3 8 1 7 1 5 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.98 2.27 1.12 0.73 0.66 0.61 0.57 0.47 0.44 0.40 0.37 0.36 0.33 0.26 0.23
    #> [16] 0.19
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.82 2.23 0.90 0.67 0.61 0.57 0.55 0.47 0.42 0.39 0.36 0.33 0.27 0.24 0.19
...
#>                alpha    0.801    0.744    0.860       4    64
#>          omega_total    0.871    0.840    0.905       4    64
#>        ordinal_alpha    0.760    0.667    0.803       4    64
#>  ordinal_omega_total    0.848    0.801    0.872       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
