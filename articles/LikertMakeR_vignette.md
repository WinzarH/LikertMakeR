...
#>  $ var1: num  3 4 4 4 3 2 3 1 3 2 ...
#>  $ var2: num  2 4 2 3 3 3 3 3 5 4 ...
#>  $ var3: num  2 5 2 3 2 4 3 2 4 3 ...
#>  $ var4: num  3 4 3 4 3 4 4 3 4 4 ...
```
...
head(df)
#>     BT       BS   BL      BLY
#> 1 4.25 3.333333 2.75 4.000000
#> 2 3.75 4.333333 3.00 4.333333
#> 3 4.00 4.000000 4.50 4.000000
#> 4 4.00 4.333333 3.75 4.333333
#> 5 4.00 3.666667 3.25 4.000000
#> 6 3.00 4.000000 3.25 3.666667
tail(df)
#>       BT       BS   BL      BLY
#> 251 4.00 4.666667 4.75 4.666667
#> 252 3.25 3.000000 1.50 2.333333
#> 253 3.75 4.000000 4.00 3.333333
#> 254 4.75 5.000000 4.25 5.000000
#> 255 4.50 4.666667 4.25 4.666667
#> 256 3.75 4.000000 3.25 3.666667
...
#>   ..$ time_1: num [1:32] 1.5 4 1.25 2.25 1.25 3.5 3 1.25 1 1.75 ...
#>   ..$ time_2: num [1:32] 2 3.5 2.5 2 2.5 3.5 3 2 2 2.75 ...
#>   ..$ time_3: num [1:32] 2.25 3.75 3.75 2.5 3.5 4 3.75 1.75 4.5 4.5 ...
#>   ..$ time_4: num [1:32] 1.5 2 3.25 3 3 3 3.25 1.5 4.25 4.25 ...
...
#>  $ A1_1 : num  1 1 3 2 2 3 3 3 2 3 ...
#>  $ A1_2 : num  2 2 2 2 2 3 3 3 2 2 ...
#>  $ A1_3 : num  3 2 3 3 4 3 3 4 2 2 ...
#>  $ A1_4 : num  3 2 4 4 4 4 2 3 3 2 ...
#>  $ A2_1 : num  2 1 2 3 4 2 3 3 2 2 ...
#>  $ A2_2 : num  1 2 2 2 3 2 4 3 2 3 ...
#>  $ A2_3 : num  2 2 2 3 3 4 4 4 2 2 ...
#>  $ A2_4 : num  1 3 3 3 4 3 4 3 2 3 ...
#>  $ A2_5 : num  3 3 3 4 4 4 4 4 2 4 ...
#>  $ A3_1 : num  3 2 3 2 2 4 2 2 2 2 ...
#>  $ A3_2 : num  3 1 3 3 2 3 3 2 2 3 ...
#>  $ A3_3 : num  4 1 3 2 3 4 3 3 2 3 ...
#>  $ A3_4 : num  3 2 3 3 2 5 4 2 2 4 ...
#>  $ A3_5 : num  3 2 4 4 3 5 3 4 3 3 ...
#>  $ A3_6 : num  4 3 4 4 2 5 3 4 3 3 ...
#>  $ Int_1: num  1 5 1 6 3 8 1 7 1 4 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.94 2.31 1.10 0.71 0.63 0.60 0.54 0.52 0.48 0.44 0.38 0.35 0.32 0.27 0.25
    #> [16] 0.18
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.78 2.27 0.83 0.66 0.63 0.55 0.53 0.50 0.46 0.40 0.36 0.32 0.28 0.26 0.18
...
#>                alpha    0.801    0.706    0.858       4    64
#>          omega_total    0.871    0.820    0.904       4    64
#>        ordinal_alpha    0.772    0.636    0.815       4    64
#>  ordinal_omega_total    0.855    0.785    0.878       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
