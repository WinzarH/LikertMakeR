...
#>  $ var1: num  1 3 1 3 3 4 3 3 2 3 ...
#>  $ var2: num  4 4 2 3 4 4 3 3 5 3 ...
#>  $ var3: num  5 4 3 4 4 5 3 5 5 4 ...
#>  $ var4: num  4 4 3 4 4 4 3 4 4 4 ...
```
...
head(df)
#>     BT       BS   BL      BLY
#> 1 4.50 4.333333 4.00 4.666667
#> 2 3.75 4.000000 4.00 4.000000
#> 3 4.25 4.333333 4.75 4.333333
#> 4 3.25 3.666667 3.50 3.000000
#> 5 4.75 5.000000 4.50 5.000000
#> 6 3.50 4.000000 3.25 4.333333
tail(df)
#>       BT       BS   BL      BLY
#> 251 4.00 4.000000 3.25 3.333333
#> 252 3.00 3.333333 3.00 3.333333
#> 253 4.00 4.333333 3.25 3.666667
#> 254 3.00 3.666667 3.25 2.666667
#> 255 3.75 4.333333 4.00 5.000000
#> 256 4.00 4.666667 3.50 4.666667
...
#>   ..$ time_1: num [1:32] 1.5 1 1.75 1.75 1.25 3 1.25 4 2.75 1.5 ...
#>   ..$ time_2: num [1:32] 2 1.75 2.75 2.5 1.75 3 1.25 3.75 3.5 1.25 ...
#>   ..$ time_3: num [1:32] 3 1.5 3.5 3.5 1.75 2.5 3.25 3.5 4.25 2 ...
#>   ..$ time_4: num [1:32] 3.25 3 3.5 3 2 2.25 2.5 1.75 3.5 1.5 ...
...
#> item03   0.79   0.72   1.00   0.70   0.70   0.66
#> item04   0.43   0.87   0.70   1.00   0.43   0.47
#> item05   0.71   0.47   0.70   0.43   1.00   0.43
#> item06   0.64   0.41   0.66   0.47   0.43   1.00
...
#>  $ A1_1 : num  2 3 3 3 2 3 3 4 3 2 ...
#>  $ A1_2 : num  1 2 2 1 1 3 3 3 3 2 ...
#>  $ A1_3 : num  2 2 2 2 3 4 3 4 4 3 ...
#>  $ A1_4 : num  3 4 5 3 3 4 4 5 3 3 ...
#>  $ A2_1 : num  2 2 3 2 3 4 3 3 3 2 ...
#>  $ A2_2 : num  2 3 2 2 3 4 3 2 4 3 ...
#>  $ A2_3 : num  2 3 4 1 3 3 4 4 3 3 ...
#>  $ A2_4 : num  3 3 4 1 3 4 3 4 4 2 ...
#>  $ A2_5 : num  2 4 4 3 4 5 4 4 3 3 ...
#>  $ A3_1 : num  2 2 3 3 2 4 3 2 3 2 ...
#>  $ A3_2 : num  2 2 3 2 1 3 4 3 4 2 ...
#>  $ A3_3 : num  3 3 4 3 2 4 4 3 4 2 ...
#>  $ A3_4 : num  3 3 3 2 1 4 4 3 5 2 ...
#>  $ A3_5 : num  4 3 4 4 3 5 4 4 3 1 ...
#>  $ A3_6 : num  5 4 4 4 3 4 3 3 5 3 ...
#>  $ Int_1: num  3 1 0 0 0 3 7 7 1 5 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.95 2.29 1.10 1.02 0.83 0.66 0.60 0.52 0.50 0.41 0.34 0.25 0.17 0.15 0.13
    #> [16] 0.09
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.79 2.26 1.02 0.85 0.74 0.65 0.59 0.51 0.41 0.37 0.25 0.18 0.16 0.13 0.09
...
#>                alpha    0.800    0.718    0.849       4    64
#>          omega_total    0.871    0.828    0.899       4    64
#>        ordinal_alpha    0.761    0.623    0.791       4    64
#>  ordinal_omega_total    0.849    0.782    0.866       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
