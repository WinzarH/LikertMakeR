...
#>  $ var1: num  3 4 3 3 2 3 3 2 1 2 ...
#>  $ var2: num  3 4 5 4 1 4 4 3 3 4 ...
#>  $ var3: num  2 5 5 4 1 4 3 1 4 3 ...
#>  $ var4: num  3 4 4 4 2 4 4 3 4 4 ...
```
...
head(df)
#>     BT       BS   BL      BLY
#> 1 4.50 4.333333 2.50 3.000000
#> 2 4.50 4.333333 4.00 4.000000
#> 3 3.75 4.000000 3.00 4.000000
#> 4 4.00 4.333333 2.25 3.666667
#> 5 3.00 3.666667 3.00 4.666667
#> 6 3.00 4.000000 3.75 3.333333
tail(df)
#>       BT       BS   BL      BLY
#> 251 4.25 4.000000 4.25 4.666667
#> 252 3.75 3.000000 1.50 3.333333
#> 253 2.50 3.666667 3.25 3.333333
#> 254 3.00 3.666667 3.25 3.666667
#> 255 4.50 4.333333 3.50 4.666667
#> 256 4.00 3.000000 2.50 3.333333
...
#>   ..$ time_1: num [1:32] 1.25 1.25 1.5 2 2 1.25 3.5 2.25 1.75 3.25 ...
#>   ..$ time_2: num [1:32] 2.5 2 2 3 1.5 2.25 2.5 2 3 3.5 ...
#>   ..$ time_3: num [1:32] 3 3 2 3.75 1 4.5 1.75 3 4.5 4.5 ...
#>   ..$ time_4: num [1:32] 2.25 3.5 2.75 3.5 3 3.25 1.5 2.75 4.25 4 ...
...
#> item04   0.50   0.53   0.47   1.00   0.44   0.52
#> item05   0.58   0.63   0.55   0.44   1.00   0.61
#> item06   0.70   0.75   0.66   0.52   0.61   1.00
...
#>  $ A1_1 : num  3 1 1 2 2 4 3 3 2 3 ...
#>  $ A1_2 : num  3 2 1 2 2 4 2 3 1 3 ...
#>  $ A1_3 : num  3 1 2 3 2 3 3 3 2 4 ...
#>  $ A1_4 : num  3 2 3 2 3 3 3 3 2 3 ...
#>  $ A2_1 : num  4 2 2 1 3 3 3 2 1 2 ...
#>  $ A2_2 : num  3 2 2 2 3 4 2 3 1 3 ...
#>  $ A2_3 : num  4 1 3 2 3 4 3 4 2 3 ...
#>  $ A2_4 : num  3 2 2 2 3 4 2 4 2 2 ...
#>  $ A2_5 : num  3 3 2 4 4 4 3 3 3 4 ...
#>  $ A3_1 : num  2 3 2 3 1 3 2 2 2 2 ...
#>  $ A3_2 : num  2 3 2 2 1 3 2 3 2 3 ...
#>  $ A3_3 : num  2 3 3 3 2 4 2 3 3 4 ...
#>  $ A3_4 : num  2 4 3 2 2 3 3 2 2 2 ...
#>  $ A3_5 : num  3 4 4 4 3 4 3 2 3 4 ...
#>  $ A3_6 : num  3 4 3 3 2 4 4 4 3 4 ...
#>  $ Int_1: num  1 1 0 1 3 8 1 7 1 2 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.99 2.21 1.07 0.74 0.65 0.62 0.54 0.51 0.45 0.42 0.37 0.34 0.32 0.30 0.24
    #> [16] 0.22
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.83 2.17 0.78 0.70 0.65 0.60 0.52 0.49 0.43 0.40 0.35 0.32 0.30 0.25 0.23
...
#>                alpha    0.800    0.707    0.859       4    64
#>          omega_total    0.870    0.821    0.905       4    64
#>        ordinal_alpha    0.765    0.660    0.819       4    64
#>  ordinal_omega_total    0.851    0.798    0.881       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
