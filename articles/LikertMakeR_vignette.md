...
#>  $ var1: num  3 3 2 3 2 2 2 2 2 2 ...
#>  $ var2: num  4 5 3 3 3 3 3 3 3 2 ...
#>  $ var3: num  5 5 1 3 5 3 1 5 3 3 ...
#>  $ var4: num  4 5 3 3 4 3 3 4 3 3 ...
```
...
head(df)
#>     BT       BS   BL      BLY
#> 1 4.00 4.333333 4.25 5.000000
#> 2 4.25 4.666667 4.00 5.000000
#> 3 3.50 3.666667 2.25 3.333333
#> 4 3.00 3.333333 3.25 3.000000
#> 5 3.00 4.333333 3.75 4.000000
#> 6 3.00 4.000000 4.25 3.000000
tail(df)
#>       BT       BS   BL      BLY
#> 251 3.00 3.000000 2.00 3.333333
#> 252 4.00 4.000000 4.00 3.666667
#> 253 3.50 4.000000 3.75 3.666667
#> 254 4.25 3.666667 2.50 3.333333
#> 255 4.00 3.666667 3.25 3.666667
#> 256 4.00 4.000000 3.00 4.000000
...
#>  $ X1: num  2.67 2.67 4.33 2.83 2.67 ...
#>  $ X2: num  3 4.17 3.5 2.33 1.83 ...
...
#>   ..$ time_1: num [1:32] 2.5 1.5 4 1.25 1.25 3 1.75 1.75 1.25 1.5 ...
#>   ..$ time_2: num [1:32] 1.75 2.25 3 1.5 1.75 2.75 4 2 1.25 2 ...
#>   ..$ time_3: num [1:32] 3.5 1.25 3 2.5 3.5 1.25 4.75 3.75 1.75 2.25 ...
#>   ..$ time_4: num [1:32] 2.25 2.25 2 2.5 3.5 1.25 4.75 3.5 2 1.5 ...
...
#> item02   0.53   1.00   0.70   0.86   0.47   0.41
#> item03   0.79   0.70   1.00   0.70   0.71   0.66
#> item04   0.43   0.86   0.70   1.00   0.43   0.46
#> item05   0.69   0.47   0.71   0.43   1.00   0.43
...
#>  $ A1_1 : num  2 2 2 2 2 2 3 2 2 1 ...
#>  $ A1_2 : num  2 2 2 2 2 1 3 2 1 2 ...
#>  $ A1_3 : num  3 3 2 3 3 2 4 2 2 2 ...
#>  $ A1_4 : num  3 3 3 2 4 3 3 3 3 3 ...
#>  $ A2_1 : num  2 3 2 2 2 1 4 2 1 1 ...
#>  $ A2_2 : num  2 3 2 2 3 1 4 2 2 2 ...
#>  $ A2_3 : num  3 3 2 4 3 2 3 2 2 2 ...
#>  $ A2_4 : num  3 4 2 2 3 2 5 1 1 2 ...
#>  $ A2_5 : num  4 5 4 2 3 2 4 2 3 3 ...
#>  $ A3_1 : num  2 3 4 1 2 1 3 3 2 2 ...
#>  $ A3_2 : num  3 3 3 1 2 1 4 3 2 2 ...
#>  $ A3_3 : num  3 3 4 1 3 2 4 4 2 2 ...
#>  $ A3_4 : num  4 4 3 2 3 2 5 3 2 2 ...
#>  $ A3_5 : num  4 3 4 3 4 3 5 4 3 3 ...
#>  $ A3_6 : num  4 4 4 2 3 2 4 4 2 2 ...
#>  $ Int_1: num  4 1 2 3 7 1 6 0 8 0 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.92 2.34 1.19 0.85 0.77 0.68 0.60 0.56 0.50 0.40 0.36 0.23 0.20 0.17 0.15
    #> [16] 0.09
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.76 2.31 0.99 0.80 0.72 0.62 0.59 0.54 0.46 0.36 0.23 0.21 0.17 0.15 0.10
...
#>                alpha    0.800    0.730    0.865       4    64
#>          omega_total    0.871    0.833    0.909       4    64
#>        ordinal_alpha    0.758    0.664    0.813       4    64
#>  ordinal_omega_total    0.847    0.799    0.877       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
