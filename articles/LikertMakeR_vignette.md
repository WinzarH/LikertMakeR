...
#>  $ var1: num  3 1 3 3 1 3 3 2 3 2 ...
#>  $ var2: num  3 2 4 3 1 2 4 2 4 4 ...
#>  $ var3: num  3 3 5 3 1 2 5 2 5 4 ...
#>  $ var4: num  4 3 5 4 2 3 4 3 5 4 ...
```
...
head(df)
#>     BT       BS   BL      BLY
#> 1 4.25 4.000000 3.25 4.000000
#> 2 4.75 4.333333 3.50 5.000000
#> 3 3.00 4.000000 3.00 3.333333
#> 4 4.00 4.333333 4.25 4.666667
#> 5 3.00 3.000000 2.50 3.666667
#> 6 4.00 4.000000 3.50 3.666667
tail(df)
#>       BT       BS   BL      BLY
#> 251 3.75 4.000000 4.00 4.000000
#> 252 3.75 3.666667 3.00 4.000000
#> 253 2.50 3.333333 3.00 3.000000
#> 254 4.25 4.666667 3.75 4.666667
#> 255 3.00 4.333333 2.75 4.333333
#> 256 3.00 3.000000 2.25 2.666667
...
#>  $ X1: num  3.17 3.5 3 3 3 ...
#>  $ X2: num  2.33 2.83 3.5 3.83 4.83 ...
...
#>   ..$ time_1: num [1:32] 2 2.5 1.25 3.5 1.5 2.5 1.25 1.25 1 2.25 ...
#>   ..$ time_2: num [1:32] 2.25 3.5 1.75 4 2 3 1.25 1.5 2 3.25 ...
#>   ..$ time_3: num [1:32] 1.75 4.5 3.75 3 3.25 3 1 2.5 2.75 4.5 ...
#>   ..$ time_4: num [1:32] 1.5 3 2.5 2 3.25 3.25 1.5 2.5 3.5 4.25 ...
...
#>  $ A1_1 : num  3 3 1 3 3 4 2 3 1 4 ...
#>  $ A1_2 : num  3 3 2 3 4 5 2 4 2 4 ...
#>  $ A1_3 : num  4 3 2 4 4 3 2 4 1 4 ...
#>  $ A1_4 : num  3 4 3 4 4 4 2 4 3 4 ...
#>  $ A2_1 : num  3 2 2 3 3 3 3 3 2 2 ...
#>  $ A2_2 : num  3 2 2 4 3 3 3 4 1 3 ...
#>  $ A2_3 : num  3 3 2 4 4 4 3 4 3 3 ...
#>  $ A2_4 : num  4 2 2 4 3 4 3 5 2 4 ...
#>  $ A2_5 : num  4 4 3 4 3 5 3 4 2 4 ...
#>  $ A3_1 : num  2 3 1 3 3 3 2 3 1 3 ...
#>  $ A3_2 : num  1 2 1 3 4 4 2 4 1 3 ...
#>  $ A3_3 : num  2 4 2 3 4 4 2 4 2 4 ...
#>  $ A3_4 : num  3 5 3 4 3 4 2 2 1 3 ...
#>  $ A3_5 : num  2 3 3 4 4 4 3 4 3 4 ...
#>  $ A3_6 : num  2 4 2 5 4 5 4 5 1 4 ...
#>  $ Int_1: num  2 1 1 9 7 8 0 3 0 5 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.94 2.25 1.14 0.80 0.63 0.60 0.54 0.50 0.47 0.41 0.37 0.32 0.31 0.28 0.22
    #> [16] 0.21
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.78 2.22 0.87 0.80 0.62 0.56 0.53 0.47 0.41 0.38 0.33 0.31 0.28 0.23 0.22
...
#>                alpha    0.801    0.719    0.850       4    64
#>          omega_total    0.871    0.827    0.899       4    64
#>        ordinal_alpha    0.764    0.661    0.807       4    64
#>  ordinal_omega_total    0.850    0.798    0.874       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
