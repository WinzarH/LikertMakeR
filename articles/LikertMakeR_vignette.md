...
#>  $ var1: num  3 2 3 2 2 3 4 1 4 4 ...
#>  $ var2: num  3 5 3 3 5 4 4 4 3 3 ...
#>  $ var3: num  5 5 3 5 4 4 3 4 3 4 ...
#>  $ var4: num  4 5 3 4 4 4 4 4 4 4 ...
```
...
#> 2 4.00 4.333333 3.75 4.000000
#> 3 4.50 4.666667 4.75 4.666667
#> 4 3.75 4.000000 4.00 4.000000
#> 5 4.25 4.666667 4.50 4.666667
#> 6 4.75 4.666667 3.50 5.000000
tail(df)
#>       BT       BS   BL      BLY
#> 251 3.75 3.666667 2.00 3.333333
#> 252 4.25 4.333333 4.00 4.333333
#> 253 3.25 4.000000 3.25 4.000000
#> 254 4.25 4.000000 3.25 4.000000
#> 255 3.25 4.000000 3.00 3.000000
#> 256 4.50 4.666667 4.25 5.000000
...
#>   ..$ time_1: num [1:32] 1.25 1.25 3 1 1.5 2.75 2 1.25 1.5 1.25 ...
#>   ..$ time_2: num [1:32] 2 3 4 1.25 1.25 2.75 1.75 2.25 3 1.25 ...
#>   ..$ time_3: num [1:32] 3.75 4 4.5 3.5 1.25 3 2.5 2.5 1.75 1.25 ...
#>   ..$ time_4: num [1:32] 3.5 3.5 4.5 2.75 2.25 2 2.5 3 2.75 1.5 ...
...
#> item03   0.79   0.71   1.00   0.71   0.71   0.66
#> item04   0.43   0.85   0.71   1.00   0.43   0.46
...
#>  $ A1_1 : num  2 2 2 2 2 4 4 2 4 2 ...
#>  $ A1_2 : num  2 2 2 2 3 3 3 3 3 1 ...
#>  $ A1_3 : num  3 3 2 4 2 3 3 3 3 2 ...
#>  $ A1_4 : num  3 4 3 3 4 4 4 4 4 3 ...
#>  $ A2_1 : num  1 2 2 3 3 3 3 2 3 2 ...
#>  $ A2_2 : num  1 3 2 2 2 2 4 1 4 2 ...
#>  $ A2_3 : num  2 3 3 3 3 3 4 3 3 3 ...
#>  $ A2_4 : num  2 3 1 3 3 3 4 3 3 3 ...
#>  $ A2_5 : num  3 3 3 4 4 4 4 4 3 3 ...
#>  $ A3_1 : num  3 3 2 2 2 3 3 2 4 1 ...
#>  $ A3_2 : num  3 2 2 4 2 3 3 3 3 2 ...
#>  $ A3_3 : num  3 3 2 3 2 4 3 3 4 2 ...
#>  $ A3_4 : num  3 2 2 5 2 4 4 4 4 2 ...
#>  $ A3_5 : num  4 4 3 4 4 4 4 3 5 2 ...
#>  $ A3_6 : num  4 4 2 3 2 4 3 5 4 2 ...
#>  $ Int_1: num  1 3 0 4 9 1 8 5 2 0 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.94 2.25 1.14 0.95 0.81 0.70 0.58 0.53 0.48 0.43 0.36 0.24 0.21 0.16 0.12
    #> [16] 0.10
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.78 2.21 1.00 0.82 0.73 0.70 0.56 0.53 0.45 0.36 0.24 0.21 0.17 0.12 0.10
...
#>                alpha    0.800    0.721    0.847       4    64
#>          omega_total    0.871    0.830    0.898       4    64
#>        ordinal_alpha    0.763    0.626    0.804       4    64
#>  ordinal_omega_total    0.850    0.782    0.872       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
