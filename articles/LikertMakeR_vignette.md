...
#>  $ var1: num  3 4 3 2 3 3 3 2 3 3 ...
#>  $ var2: num  3 3 4 4 3 4 3 2 2 2 ...
#>  $ var3: num  3 5 5 5 2 5 5 1 2 1 ...
#>  $ var4: num  4 5 5 4 3 4 4 3 3 2 ...
```
...
head(df)
#>     BT       BS   BL      BLY
#> 1 4.25 4.333333 2.25 4.333333
#> 2 4.50 4.666667 4.50 5.000000
#> 3 3.50 4.000000 3.50 4.000000
#> 4 3.75 3.666667 3.25 3.666667
#> 5 4.00 4.000000 4.00 4.333333
#> 6 4.25 4.333333 4.00 4.666667
tail(df)
#>       BT       BS   BL      BLY
#> 251 4.25 4.666667 4.50 5.000000
#> 252 2.25 2.666667 1.50 3.333333
#> 253 3.75 3.333333 1.50 3.333333
#> 254 2.50 3.333333 2.75 2.666667
#> 255 4.00 4.000000 4.00 4.333333
#> 256 3.00 4.000000 3.25 3.333333
...
#>   ..$ time_1: num [1:32] 1.25 2.5 1.5 2.75 1.5 2.25 2 4 1 2.5 ...
#>   ..$ time_2: num [1:32] 1.5 4.5 2.5 3 2 2.5 3 3.25 1.5 3.5 ...
#>   ..$ time_3: num [1:32] 1 4.5 3.25 2 1.75 2.75 4 3.25 3 4.5 ...
#>   ..$ time_4: num [1:32] 1.5 4 3.25 1.5 2.75 4.25 4 2 3 4.25 ...
...
#>  $ A1_1 : num  3 3 3 3 2 3 2 3 2 2 ...
#>  $ A1_2 : num  2 3 4 5 2 5 2 3 3 2 ...
#>  $ A1_3 : num  3 4 3 3 2 5 2 4 3 2 ...
#>  $ A1_4 : num  3 3 4 3 3 4 3 4 4 3 ...
#>  $ A2_1 : num  3 3 3 3 1 4 2 3 2 3 ...
#>  $ A2_2 : num  3 4 3 2 1 3 3 2 2 3 ...
#>  $ A2_3 : num  3 3 4 3 2 4 2 3 3 2 ...
#>  $ A2_4 : num  5 3 4 3 2 5 3 2 2 3 ...
#>  $ A2_5 : num  4 3 4 3 2 5 4 3 3 3 ...
#>  $ A3_1 : num  2 3 3 3 2 3 1 3 3 2 ...
#>  $ A3_2 : num  2 3 4 2 2 3 1 3 3 2 ...
#>  $ A3_3 : num  3 4 4 3 3 4 2 4 4 2 ...
#>  $ A3_4 : num  4 4 4 4 2 3 2 3 4 2 ...
#>  $ A3_5 : num  4 4 3 4 3 4 3 5 3 3 ...
#>  $ A3_6 : num  2 4 4 4 3 4 2 5 4 3 ...
#>  $ Int_1: num  1 1 0 7 2 5 1 9 2 3 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.95 2.28 1.08 0.74 0.66 0.60 0.56 0.53 0.47 0.45 0.39 0.34 0.28 0.25 0.22
    #> [16] 0.20
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.79 2.25 0.83 0.67 0.61 0.58 0.54 0.50 0.47 0.43 0.34 0.28 0.27 0.24 0.21
...
#>                alpha    0.801    0.702    0.852       4    64
#>          omega_total    0.871    0.819    0.901       4    64
#>        ordinal_alpha    0.759    0.610    0.816       4    64
#>  ordinal_omega_total    0.847    0.773    0.879       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
