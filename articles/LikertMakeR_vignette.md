...
#>  $ var1: num  3 3 4 3 2 2 3 2 2 3 ...
#>  $ var2: num  2 4 4 3 1 4 4 3 3 4 ...
#>  $ var3: num  1 3 5 3 1 5 5 1 4 4 ...
#>  $ var4: num  2 4 5 4 3 4 4 3 4 4 ...
```
...
head(df)
#>     BT       BS   BL      BLY
#> 1 3.25 4.000000 2.75 3.666667
#> 2 4.00 4.000000 3.50 4.000000
#> 3 3.50 4.000000 3.00 3.333333
#> 4 4.25 4.333333 4.00 4.333333
#> 5 3.25 3.666667 1.50 4.333333
#> 6 4.25 4.000000 3.75 4.000000
tail(df)
#>       BT       BS   BL      BLY
#> 251 4.50 4.666667 4.50 4.666667
#> 252 4.00 4.333333 3.25 4.333333
#> 253 3.75 4.000000 3.50 4.666667
#> 254 3.50 4.333333 4.00 2.666667
#> 255 4.50 4.666667 4.25 4.333333
#> 256 3.00 3.666667 2.75 3.333333
...
#>  $ X1: num  2.33 2.83 2.83 2.5 2 ...
#>  $ X2: num  2.33 3 3.67 3.83 4.83 ...
...
#>   ..$ time_1: num [1:32] 1.25 1.5 1.25 2.5 2.5 3.5 1.75 1.25 1 3.5 ...
#>   ..$ time_2: num [1:32] 2 1.75 1.5 2.5 4.5 3.25 1.25 1.5 2.25 3.5 ...
#>   ..$ time_3: num [1:32] 2.5 1 2.25 3.75 4.5 2.75 1.75 3 3.75 4.5 ...
#>   ..$ time_4: num [1:32] 3 2.5 3 1.5 3.25 2 2 3.5 4 4.25 ...
...
#>  $ A1_1 : num  1 3 2 2 1 3 3 4 2 3 ...
#>  $ A1_2 : num  1 3 2 2 1 4 3 3 2 4 ...
#>  $ A1_3 : num  2 3 2 2 2 4 4 3 2 4 ...
#>  $ A1_4 : num  3 3 3 3 3 4 4 4 2 4 ...
#>  $ A2_1 : num  2 3 3 2 2 3 2 3 2 3 ...
#>  $ A2_2 : num  1 3 2 2 2 2 3 3 2 3 ...
#>  $ A2_3 : num  2 3 1 2 3 3 3 4 3 4 ...
#>  $ A2_4 : num  2 3 3 3 2 2 4 3 2 4 ...
#>  $ A2_5 : num  3 4 4 3 3 3 5 5 3 4 ...
#>  $ A3_1 : num  2 3 3 1 2 3 3 3 2 2 ...
#>  $ A3_2 : num  2 3 3 2 2 3 2 3 2 3 ...
#>  $ A3_3 : num  2 4 4 3 2 4 4 4 2 4 ...
#>  $ A3_4 : num  2 3 2 3 4 4 5 4 2 4 ...
#>  $ A3_5 : num  3 5 4 3 3 4 4 4 3 4 ...
#>  $ A3_6 : num  2 4 4 2 3 4 4 4 2 4 ...
#>  $ Int_1: num  3 1 1 0 0 8 1 5 0 1 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.96 2.27 1.07 0.73 0.67 0.60 0.57 0.52 0.44 0.43 0.40 0.35 0.29 0.25 0.23
    #> [16] 0.22
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.80 2.23 0.77 0.72 0.65 0.59 0.52 0.49 0.44 0.41 0.37 0.30 0.25 0.24 0.22
...
#>                alpha    0.801    0.679    0.874       4    64
#>          omega_total    0.871    0.808    0.914       4    64
#>        ordinal_alpha    0.768    0.613    0.833       4    64
#>  ordinal_omega_total    0.853    0.775    0.889       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
