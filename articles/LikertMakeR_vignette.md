...
#>  $ var1: num  2 2 2 1 3 3 3 3 1 4 ...
#>  $ var2: num  3 4 2 3 4 5 3 1 4 5 ...
#>  $ var3: num  4 5 2 3 5 5 4 1 2 5 ...
#>  $ var4: num  4 4 3 3 4 4 4 2 3 5 ...
```
...
head(df)
#>     BT       BS   BL      BLY
#> 1 3.25 3.666667 4.25 4.333333
#> 2 4.25 4.333333 3.00 4.000000
#> 3 4.75 4.333333 3.50 4.333333
#> 4 3.50 3.666667 3.25 4.666667
#> 5 4.50 4.666667 4.25 4.666667
#> 6 4.25 4.000000 2.50 4.333333
tail(df)
#>       BT       BS   BL      BLY
#> 251 3.25 3.333333 2.00 3.333333
#> 252 4.00 3.666667 3.50 3.333333
#> 253 3.75 4.000000 3.25 3.666667
#> 254 3.00 4.000000 2.00 4.000000
#> 255 3.50 3.666667 2.75 3.333333
#> 256 4.50 4.666667 4.00 4.666667
...
#>  $ X1: num  4.33 2.67 3.17 2.83 2 ...
#>  $ X2: num  3 3.5 4 2.17 1.83 ...
...
#>   ..$ time_1: num [1:32] 1 1.5 3 2 4 1.75 1.75 3 1.25 2.25 ...
#>   ..$ time_2: num [1:32] 1.25 1.75 3 2.75 2.5 2.25 2.25 3.75 1.25 3 ...
#>   ..$ time_3: num [1:32] 3.5 1.25 2.5 3.25 3.5 1.75 1.75 3.75 2.5 3.25 ...
#>   ..$ time_4: num [1:32] 3.25 1.5 2 2.75 2.5 1.25 2.25 3 2.5 2.25 ...
...
cor(Att_3) |> round(2)
#>        item01 item02 item03 item04 item05 item06
#> item01   1.00   0.53   0.79   0.43   0.71   0.63
#> item02   0.53   1.00   0.72   0.86   0.47   0.41
#> item03   0.79   0.72   1.00   0.71   0.71   0.66
#> item04   0.43   0.86   0.71   1.00   0.43   0.46
...
#>  $ A1_1 : num  4 2 2 2 3 2 2 2 1 2 ...
#>  $ A1_2 : num  3 2 1 3 2 2 2 2 1 2 ...
#>  $ A1_3 : num  2 3 2 2 4 3 3 3 2 3 ...
#>  $ A1_4 : num  4 4 3 4 3 4 3 3 2 3 ...
#>  $ A2_1 : num  3 2 2 1 3 2 3 2 2 3 ...
#>  $ A2_2 : num  1 2 2 1 3 3 3 2 2 2 ...
#>  $ A2_3 : num  3 4 3 2 3 3 3 3 2 3 ...
#>  $ A2_4 : num  3 3 2 1 4 3 3 2 2 4 ...
#>  $ A2_5 : num  4 3 3 2 4 4 4 3 3 4 ...
#>  $ A3_1 : num  2 3 1 3 2 2 2 2 2 2 ...
#>  $ A3_2 : num  3 3 1 3 3 3 1 2 1 2 ...
#>  $ A3_3 : num  3 3 2 4 3 3 2 3 2 2 ...
#>  $ A3_4 : num  4 3 2 4 3 3 2 3 2 2 ...
#>  $ A3_5 : num  4 4 2 4 4 4 3 3 3 3 ...
#>  $ A3_6 : num  2 4 3 4 3 3 2 4 3 2 ...
#>  $ Int_1: num  4 4 1 4 2 1 6 7 1 2 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.94 2.25 1.14 1.00 0.76 0.69 0.65 0.54 0.47 0.37 0.35 0.23 0.22 0.18 0.12
    #> [16] 0.09
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.78 2.22 1.00 0.93 0.73 0.65 0.57 0.54 0.38 0.35 0.25 0.22 0.18 0.12 0.10
...
#>                alpha    0.800    0.698    0.868       4    64
#>          omega_total    0.871    0.818    0.910       4    64
#>        ordinal_alpha    0.767    0.635    0.824       4    64
#>  ordinal_omega_total    0.852    0.786    0.884       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
