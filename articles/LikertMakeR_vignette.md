...
#>  $ var1: num  3 3 1 2 3 4 1 4 1 4 ...
#>  $ var2: num  5 4 2 2 3 3 3 3 3 4 ...
#>  $ var3: num  5 5 2 2 3 5 3 4 1 4 ...
#>  $ var4: num  5 5 3 3 3 4 3 4 3 4 ...
```
...
cor(df) |> round(3)
#>       var1  var2  var3  var4
#> var1 1.000 0.250 0.350 0.448
#> var2 0.250 1.000 0.706 0.750
#> var3 0.350 0.706 1.000 0.843
#> var4 0.448 0.750 0.843 1.000
```
...
head(df)
#>     BT       BS   BL      BLY
#> 1 3.25 4.000000 4.25 4.666667
#> 2 4.25 4.666667 2.75 4.333333
#> 3 4.50 4.666667 4.25 4.333333
#> 4 3.75 4.000000 3.50 3.000000
#> 5 4.00 4.333333 4.50 4.666667
#> 6 4.50 4.333333 4.00 4.333333
tail(df)
#>       BT       BS   BL      BLY
#> 251 4.00 3.666667 2.00 3.666667
#> 252 4.25 4.000000 4.00 4.000000
#> 253 4.25 4.333333 3.75 4.333333
#> 254 3.00 3.333333 3.00 3.333333
#> 255 3.75 4.000000 3.75 3.333333
#> 256 3.50 3.333333 2.00 3.666667
...
#>   ..$ time_1: num [1:32] 1 1 2.75 2.5 3 2.75 1.75 3 1.5 1.5 ...
#>   ..$ time_2: num [1:32] 1.75 1.25 2.75 3 4.25 2.5 3 3.5 1.75 1.75 ...
#>   ..$ time_3: num [1:32] 2.5 2.25 2.5 3.25 2.5 2 3.75 3.75 2.5 2 ...
#>   ..$ time_4: num [1:32] 2.5 2.75 2 2.75 2.25 1.25 3.25 3 2.25 1.5 ...
...
#>  $ A1_1 : num  2 3 2 2 4 2 3 2 2 2 ...
#>  $ A1_2 : num  1 3 1 3 4 3 4 3 2 1 ...
#>  $ A1_3 : num  3 3 2 4 3 3 4 3 3 2 ...
#>  $ A1_4 : num  3 4 2 3 5 4 4 4 2 2 ...
#>  $ A2_1 : num  1 3 1 2 4 3 3 3 2 2 ...
#>  $ A2_2 : num  1 2 1 2 2 3 4 4 2 1 ...
#>  $ A2_3 : num  2 4 3 3 4 3 4 3 2 2 ...
#>  $ A2_4 : num  2 4 1 3 4 4 3 3 3 2 ...
#>  $ A2_5 : num  2 4 3 3 4 4 4 4 4 3 ...
#>  $ A3_1 : num  1 3 1 2 3 2 3 3 1 2 ...
#>  $ A3_2 : num  1 1 1 2 3 2 4 4 2 1 ...
#>  $ A3_3 : num  1 3 2 2 4 3 4 4 2 2 ...
#>  $ A3_4 : num  2 2 1 2 4 2 4 4 3 2 ...
#>  $ A3_5 : num  1 3 2 3 4 4 4 4 3 3 ...
#>  $ A3_6 : num  2 4 2 3 4 3 3 4 3 4 ...
#>  $ Int_1: num  4 5 0 4 1 4 6 0 0 0 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.95 2.29 1.17 0.97 0.80 0.65 0.59 0.55 0.45 0.39 0.33 0.25 0.20 0.17 0.14
    #> [16] 0.09
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.79 2.26 1.06 0.84 0.71 0.64 0.55 0.51 0.42 0.34 0.25 0.20 0.17 0.14 0.10
...
#>                alpha    0.800    0.697    0.845       4    64
#>          omega_total    0.871    0.816    0.897       4    64
#>        ordinal_alpha    0.763    0.604    0.805       4    64
#>  ordinal_omega_total    0.850    0.772    0.874       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
