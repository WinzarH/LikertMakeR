...
#>  $ var1: num  4 4 1 3 3 3 2 3 3 2 ...
#>  $ var2: num  1 3 3 4 3 3 4 2 4 4 ...
#>  $ var3: num  2 3 3 4 2 2 5 2 5 3 ...
#>  $ var4: num  3 4 4 4 3 4 4 3 5 4 ...
```
...
head(df)
#>     BT       BS   BL      BLY
#> 1 3.75 3.666667 3.50 3.000000
#> 2 4.75 4.666667 4.50 5.000000
#> 3 2.75 3.666667 3.00 3.333333
#> 4 4.25 4.333333 2.25 3.666667
#> 5 4.00 3.666667 4.00 3.333333
#> 6 3.00 3.666667 3.25 3.666667
tail(df)
#>      BT       BS   BL      BLY
#> 251 4.5 4.666667 4.00 4.666667
#> 252 2.5 3.000000 1.50 2.666667
#> 253 2.5 3.666667 3.75 2.666667
#> 254 3.0 3.333333 3.00 3.666667
#> 255 5.0 4.666667 4.50 4.666667
#> 256 3.0 2.666667 3.25 2.666667
...
#>  $ X1: num  1.33 1.5 3 4.33 2.83 ...
#>  $ X2: num  2.33 3.83 3.67 3.67 4.83 ...
...
#>   ..$ time_1: num [1:32] 1.25 1.75 1.25 2.25 2.25 1.75 2 2.25 2 3.25 ...
#>   ..$ time_2: num [1:32] 2 2.5 2.25 3.5 1.5 2.75 3 3 1.75 4.5 ...
#>   ..$ time_3: num [1:32] 1.75 3.75 3.75 3.5 2.25 2.5 3 2.75 2 4.5 ...
#>   ..$ time_4: num [1:32] 1.5 3.25 3.25 2 1.5 2.5 2.5 1.5 1.25 4.25 ...
...
#>  $ A1_1 : num  2 3 2 3 3 3 2 1 3 1 ...
#>  $ A1_2 : num  1 2 2 4 3 3 2 1 2 1 ...
#>  $ A1_3 : num  2 3 2 4 5 3 2 3 4 2 ...
#>  $ A1_4 : num  3 3 3 4 4 4 3 4 3 2 ...
#>  $ A2_1 : num  2 2 3 3 4 3 2 2 2 2 ...
#>  $ A2_2 : num  3 2 2 2 4 4 2 2 2 2 ...
#>  $ A2_3 : num  2 2 3 3 4 3 3 3 4 4 ...
#>  $ A2_4 : num  3 3 3 2 4 4 1 2 2 4 ...
#>  $ A2_5 : num  4 4 3 3 4 4 4 2 4 4 ...
#>  $ A3_1 : num  2 2 2 3 3 3 3 2 2 2 ...
#>  $ A3_2 : num  2 2 2 4 4 2 3 2 2 2 ...
#>  $ A3_3 : num  1 4 2 3 4 3 3 3 2 2 ...
#>  $ A3_4 : num  2 4 2 3 4 2 2 2 3 3 ...
#>  $ A3_5 : num  3 3 3 4 3 4 4 4 4 3 ...
#>  $ A3_6 : num  3 3 3 4 4 3 4 4 3 4 ...
#>  $ Int_1: num  1 1 1 9 2 8 1 6 8 1 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.95 2.27 1.09 0.68 0.64 0.61 0.59 0.53 0.47 0.40 0.38 0.35 0.33 0.26 0.25
    #> [16] 0.20
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.79 2.23 0.79 0.68 0.62 0.60 0.54 0.50 0.45 0.39 0.36 0.35 0.26 0.25 0.20
...
#>                alpha    0.801    0.731    0.851       4    64
#>          omega_total    0.871    0.834    0.900       4    64
#>        ordinal_alpha    0.773    0.676    0.818       4    64
#>  ordinal_omega_total    0.855    0.806    0.881       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
