...
#>  $ var1: num  3 3 1 2 2 3 3 3 3 3 ...
#>  $ var2: num  2 4 2 4 3 4 3 2 3 4 ...
#>  $ var3: num  4 5 2 3 4 5 5 1 2 4 ...
#>  $ var4: num  4 4 3 4 4 4 4 3 3 4 ...
```
...
head(df)
#>     BT       BS   BL      BLY
#> 1 4.00 4.000000 3.00 4.000000
#> 2 4.25 4.000000 3.25 4.000000
#> 3 3.00 2.666667 3.00 2.666667
#> 4 3.75 4.000000 1.50 2.666667
#> 5 3.25 4.000000 3.25 4.000000
#> 6 3.00 3.666667 3.50 4.333333
tail(df)
#>       BT       BS   BL      BLY
#> 251 4.50 4.666667 4.50 4.666667
#> 252 4.00 4.333333 4.00 4.000000
#> 253 3.25 3.333333 2.25 3.333333
#> 254 4.25 4.333333 4.00 4.666667
#> 255 4.00 4.666667 4.50 4.666667
#> 256 3.00 2.666667 3.25 3.333333
...
#>   ..$ time_1: num [1:32] 2.5 1.75 2.25 3.5 2 2.5 1 2 3.25 1.75 ...
#>   ..$ time_2: num [1:32] 4.75 2.25 2 3.75 3.25 1.5 3.25 3 2.75 2.75 ...
#>   ..$ time_3: num [1:32] 4 2.5 1.5 3.75 4 1.25 4.25 3.5 2.5 3 ...
#>   ..$ time_4: num [1:32] 4.25 2 1.5 4.25 3.5 1.5 2.75 3.25 2.25 2.5 ...
...
#>  $ A1_1 : num  2 3 3 2 1 2 4 1 3 3 ...
#>  $ A1_2 : num  2 4 4 3 2 1 3 2 3 3 ...
#>  $ A1_3 : num  2 3 4 4 3 2 4 2 3 2 ...
#>  $ A1_4 : num  3 4 4 4 2 2 4 2 4 4 ...
#>  $ A2_1 : num  2 3 3 3 2 2 3 2 3 3 ...
#>  $ A2_2 : num  2 3 3 2 2 2 3 2 2 3 ...
#>  $ A2_3 : num  3 3 4 3 3 2 4 2 4 3 ...
#>  $ A2_4 : num  3 4 3 3 2 2 3 1 5 2 ...
#>  $ A2_5 : num  3 4 4 4 3 2 4 3 4 4 ...
#>  $ A3_1 : num  2 3 4 2 1 2 4 1 3 3 ...
#>  $ A3_2 : num  1 3 5 2 2 2 4 2 3 4 ...
#>  $ A3_3 : num  2 4 4 3 3 2 4 2 4 4 ...
#>  $ A3_4 : num  3 3 4 2 2 3 4 2 3 5 ...
#>  $ A3_5 : num  3 4 5 3 2 3 4 3 4 4 ...
#>  $ A3_6 : num  2 4 5 3 4 3 5 1 4 5 ...
#>  $ Int_1: num  0 6 8 9 6 2 6 3 3 2 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.96 2.24 1.08 0.68 0.67 0.64 0.61 0.51 0.44 0.42 0.37 0.35 0.33 0.28 0.24
    #> [16] 0.16
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.80 2.21 0.79 0.68 0.65 0.61 0.57 0.46 0.42 0.40 0.35 0.34 0.30 0.26 0.16
...
#>                alpha    0.799    0.716    0.850       4    64
#>          omega_total    0.870    0.825    0.899       4    64
#>        ordinal_alpha    0.759    0.655    0.798       4    64
#>  ordinal_omega_total    0.847    0.796    0.869       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
