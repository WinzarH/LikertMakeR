...
#>  $ var1: num  1 2 5 3 3 4 3 2 2 3 ...
#>  $ var2: num  4 3 5 1 3 4 3 3 3 4 ...
#>  $ var3: num  3 4 5 3 3 4 4 1 2 4 ...
#>  $ var4: num  4 4 5 3 4 4 4 3 3 4 ...
```
...
cor(df) |> round(3)
#>       var1 var2  var3  var4
#> var1 1.000 0.25 0.350 0.458
#> var2 0.250 1.00 0.700 0.750
#> var3 0.350 0.70 1.000 0.843
#> var4 0.458 0.75 0.843 1.000
```
...
head(df)
#>     BT       BS   BL      BLY
#> 1 3.75 4.333333 3.75 4.000000
#> 2 3.75 4.000000 3.75 4.333333
#> 3 3.50 3.666667 4.00 4.000000
#> 4 4.00 4.000000 3.50 4.000000
#> 5 3.25 4.000000 3.50 2.666667
#> 6 3.50 3.666667 3.50 2.666667
tail(df)
#>       BT       BS   BL      BLY
#> 251 4.25 4.666667 4.00 4.666667
#> 252 3.50 3.000000 1.50 2.666667
#> 253 2.50 3.333333 2.75 3.000000
#> 254 3.75 4.000000 4.00 4.000000
#> 255 4.50 4.333333 4.25 4.333333
#> 256 4.00 3.666667 3.25 3.333333
...
#>  $ X1: num  2.67 2 2.33 3.5 2.83 ...
#>  $ X2: num  2.17 2.83 3.67 3.83 4.83 ...
...
#>   ..$ time_1: num [1:32] 1.75 1.25 1.25 2.5 1.25 2 1.75 2 1 4 ...
#>   ..$ time_2: num [1:32] 3 2.5 1.5 3 1.5 2.5 2.25 2 3 3.25 ...
#>   ..$ time_3: num [1:32] 4 3.75 2.75 2.5 1 3.75 2.5 2.75 3 4 ...
#>   ..$ time_4: num [1:32] 3.25 4.25 3 1.5 1.75 3.5 2.75 2.5 3.5 4.25 ...
...
#> reached maximum of 16384 iterations
#> Variable  2 :  item02  -
#> best solution in 609 iterations
#> Variable  3 :  item03  -
#> best solution in 1339 iterations
#> Variable  4 :  item04  -
#> reached maximum of 16384 iterations
#> 
#> Arranging data to match correlations
...
#> reached maximum of 16384 iterations
#> Variable  2 :  item02  -
#> best solution in 1427 iterations
#> Variable  3 :  item03  -
#> reached maximum of 16384 iterations
#> Variable  4 :  item04  -
...
#> reached maximum of 16384 iterations
#> Variable  2 :  item02  -
#> best solution in 1159 iterations
#> Variable  3 :  item03  -
#> best solution in 1033 iterations
#> Variable  4 :  item04  -
#> reached maximum of 16384 iterations
#> Variable  5 :  item05  -
#> reached maximum of 16384 iterations
#> Variable  6 :  item06  -
#> best solution in 3174 iterations
#> 
#> Arranging data to match correlations
#> 
#> Successfully generated correlated variables
...
intent <- lfast(n, mean = 4.0, sd = 3, lowerbound = 0, upperbound = 10) |>
  data.frame()
#> best solution in 176 iterations
names(intent) <- "int"
```
...
cor(Att_1) |> round(2)
#>        item01 item02 item03 item04
#> item01   1.00   0.48   0.60   0.44
#> item02   0.48   1.00   0.55   0.41
#> item03   0.60   0.55   1.00   0.52
#> item04   0.44   0.41   0.52   1.00
...
cor(Att_2) |> round(2)
#>        item01 item02 item03 item04 item05
#> item01   1.00   0.58   0.46   0.58   0.43
#> item02   0.58   1.00   0.55   0.70   0.53
#> item03   0.46   0.55   1.00   0.55   0.42
#> item04   0.58   0.70   0.55   1.00   0.53
#> item05   0.43   0.53   0.42   0.53   1.00
...
cor(Att_3) |> round(2)
#>        item01 item02 item03 item04 item05 item06
#> item01   1.00   0.71   0.63   0.50   0.58   0.70
#> item02   0.71   1.00   0.68   0.53   0.63   0.75
#> item03   0.63   0.68   1.00   0.47   0.55   0.66
#> item04   0.50   0.53   0.47   1.00   0.44   0.53
#> item05   0.58   0.63   0.55   0.44   1.00   0.61
#> item06   0.70   0.75   0.66   0.53   0.61   1.00
...
#>  $ A1_1 : num  3 1 2 3 4 3 3 2 2 2 ...
#>  $ A1_2 : num  4 2 3 2 3 2 4 2 2 2 ...
#>  $ A1_3 : num  4 2 3 3 4 3 5 3 3 2 ...
#>  $ A1_4 : num  4 3 4 3 4 4 4 4 4 3 ...
#>  $ A2_1 : num  3 2 3 3 3 3 4 3 2 1 ...
#>  $ A2_2 : num  3 1 3 2 2 3 3 4 1 2 ...
#>  $ A2_3 : num  4 2 3 4 4 4 3 4 2 2 ...
#>  $ A2_4 : num  4 2 4 4 4 4 4 4 1 2 ...
#>  $ A2_5 : num  5 3 4 4 4 4 4 4 2 3 ...
#>  $ A3_1 : num  3 2 2 2 2 3 3 2 2 2 ...
#>  $ A3_2 : num  3 2 2 2 3 4 2 2 2 2 ...
#>  $ A3_3 : num  4 3 2 1 4 4 2 3 3 3 ...
#>  $ A3_4 : num  4 2 2 4 3 5 3 3 4 4 ...
#>  $ A3_5 : num  3 3 3 3 4 4 4 3 3 3 ...
#>  $ A3_6 : num  5 4 3 3 4 5 4 4 3 4 ...
#>  $ Int_1: num  7 1 6 0 3 8 8 4 1 1 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.96 2.23 1.11 0.71 0.61 0.61 0.57 0.54 0.49 0.41 0.38 0.34 0.30 0.27 0.25
    #> [16] 0.20
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.80 2.19 0.81 0.69 0.61 0.59 0.54 0.52 0.42 0.40 0.37 0.32 0.27 0.25 0.20
...
#>              lambda6    0.758       4    64
#>        ordinal_alpha    0.773       4    64
#>  ordinal_omega_total    0.855       4    64
#>                                                notes
...
#>                alpha    0.801    0.694    0.856       4    64
#>          omega_total    0.871    0.815    0.904       4    64
#>        ordinal_alpha    0.773    0.627    0.822       4    64
#>  ordinal_omega_total    0.855    0.782    0.883       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
