...
#>  $ var1: num  3 3 3 1 3 3 1 5 2 4 ...
#>  $ var2: num  3 5 2 4 4 5 2 4 3 5 ...
#>  $ var3: num  5 5 3 5 3 5 2 5 3 4 ...
#>  $ var4: num  4 5 3 4 4 5 3 4 4 4 ...
...
head(df)
#>     BT       BS   BL      BLY
#> 1 2.75 3.333333 3.25 2.666667
#> 2 4.00 3.666667 1.75 3.000000
#> 3 4.50 4.666667 4.25 5.000000
#> 4 3.50 3.666667 2.00 3.000000
#> 5 4.75 4.333333 3.25 4.333333
#> 6 4.50 4.666667 4.75 4.333333
tail(df)
#>      BT       BS   BL      BLY
#> 251 3.0 4.000000 3.00 3.333333
#> 252 4.5 4.666667 4.00 3.333333
#> 253 3.5 3.666667 3.00 3.666667
#> 254 3.0 4.000000 3.00 3.000000
#> 255 4.0 4.333333 4.25 3.333333
#> 256 3.0 3.666667 3.25 3.333333
...
#>  $ X1: num  1.67 2.67 3.17 2.83 1.67 ...
...
#>   ..$ time_1: num [1:32] 1 2.75 1.75 3 2.75 1.75 2.5 3 3.5 1.25 ...
#>   ..$ time_2: num [1:32] 1.75 2.25 1.25 3.5 2.5 1.75 2.75 3 2.75 1.75 ...
#>   ..$ time_3: num [1:32] 2 2.5 1.75 3.75 3 2 3.25 3.5 2.5 1.5 ...
#>   ..$ time_4: num [1:32] 2.25 1.5 2 3 2.25 2 2.5 4 2.25 1.5 ...
...
#> item02   0.53   1.00   0.71   0.87   0.47   0.42
#> item03   0.79   0.71   1.00   0.70   0.70   0.66
#> item04   0.43   0.87   0.70   1.00   0.43   0.46
#> item05   0.69   0.47   0.70   0.43   1.00   0.42
#> item06   0.64   0.42   0.66   0.46   0.42   1.00
...
#>  $ A1_1 : num  2 4 3 3 2 2 2 2 2 1 ...
#>  $ A1_2 : num  3 3 3 2 2 3 3 3 3 2 ...
#>  $ A1_3 : num  3 4 3 3 4 3 3 3 3 3 ...
#>  $ A1_4 : num  4 4 5 3 2 4 4 4 4 2 ...
#>  $ A2_1 : num  2 3 2 3 2 3 2 2 2 2 ...
#>  $ A2_2 : num  1 3 2 4 3 4 2 2 3 1 ...
#>  $ A2_3 : num  3 4 3 4 3 3 4 3 3 3 ...
#>  $ A2_4 : num  3 4 3 4 2 4 3 2 3 2 ...
#>  $ A2_5 : num  3 4 4 4 2 3 4 4 3 2 ...
#>  $ A3_1 : num  2 3 3 2 3 2 3 3 3 1 ...
#>  $ A3_2 : num  2 3 2 2 3 3 3 2 3 2 ...
#>  $ A3_3 : num  3 4 3 2 3 2 3 4 4 1 ...
#>  $ A3_4 : num  3 4 2 2 4 3 3 3 4 3 ...
#>  $ A3_5 : num  3 4 4 3 4 3 3 5 4 3 ...
#>  $ A3_6 : num  3 4 3 2 4 3 3 4 4 2 ...
#>  $ Int_1: num  4 9 5 4 2 0 1 4 1 0 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.92 2.27 1.17 0.90 0.79 0.67 0.61 0.59 0.48 0.43 0.33 0.26 0.21 0.16 0.13
    #> [16] 0.07
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.76 2.23 1.02 0.85 0.72 0.65 0.61 0.55 0.43 0.34 0.26 0.22 0.16 0.13 0.08
