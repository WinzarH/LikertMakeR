...
#>  $ var1: num  3 2 5 4 1 4 2 3 2 3 ...
#>  $ var2: num  2 3 3 4 3 4 3 2 4 4 ...
#>  $ var3: num  1 3 5 5 4 5 1 2 5 5 ...
#>  $ var4: num  3 3 4 4 4 4 3 3 4 5 ...
```
...
head(df)
#>     BT       BS   BL      BLY
#> 1 3.50 4.333333 2.75 3.666667
#> 2 4.00 4.666667 4.50 4.666667
#> 3 3.00 3.666667 3.50 2.666667
#> 4 4.25 4.666667 4.50 4.333333
#> 5 2.75 3.333333 1.75 3.666667
#> 6 4.25 4.666667 4.00 4.000000
tail(df)
#>       BT       BS   BL      BLY
#> 251 4.25 4.333333 4.50 4.666667
#> 252 2.50 2.666667 1.50 1.333333
#> 253 2.50 3.333333 2.25 2.666667
#> 254 4.00 4.000000 3.50 4.000000
#> 255 4.00 4.000000 4.50 4.333333
#> 256 2.50 3.000000 2.75 3.333333
...
#>  $ X1: num  1.67 1.83 3.17 1.67 2.17 ...
#>  $ X2: num  1.5 2.5 3.5 2.83 3.83 ...
...
#>   ..$ time_1: num [1:32] 2.25 1 1.25 2.75 1.75 3.5 2.5 2.75 1.25 1.5 ...
#>   ..$ time_2: num [1:32] 4 1 3 3 1.5 4.25 3 3 2.5 1.25 ...
#>   ..$ time_3: num [1:32] 4.25 2.75 3.75 3.25 1.25 4.75 4 2.5 3.25 1.75 ...
#>   ..$ time_4: num [1:32] 4.25 2 4.25 1.75 1.5 3.75 2.25 2.75 2.75 2.25 ...
...
#>  $ A1_1 : num  4 2 3 2 3 3 4 2 3 4 ...
#>  $ A1_2 : num  3 2 3 3 4 2 4 2 2 3 ...
#>  $ A1_3 : num  4 3 4 3 4 4 4 3 4 5 ...
#>  $ A1_4 : num  4 3 4 3 4 3 4 2 3 4 ...
#>  $ A2_1 : num  4 4 3 2 2 3 3 2 2 4 ...
#>  $ A2_2 : num  5 3 4 2 3 3 4 2 3 4 ...
#>  $ A2_3 : num  4 4 4 2 4 4 3 3 3 4 ...
#>  $ A2_4 : num  3 3 4 3 4 3 4 3 3 3 ...
#>  $ A2_5 : num  4 4 4 3 4 5 4 3 3 4 ...
#>  $ A3_1 : num  3 1 4 2 2 3 3 2 3 2 ...
#>  $ A3_2 : num  3 1 4 2 4 2 3 2 3 5 ...
#>  $ A3_3 : num  4 3 4 3 4 2 4 3 4 4 ...
#>  $ A3_4 : num  4 2 4 1 4 3 4 2 3 5 ...
#>  $ A3_5 : num  4 3 5 3 5 3 4 3 4 4 ...
#>  $ A3_6 : num  4 3 5 3 4 3 5 3 4 5 ...
#>  $ Int_1: num  2 1 1 8 4 6 9 0 3 3 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.99 2.21 1.10 0.69 0.66 0.61 0.56 0.52 0.49 0.43 0.37 0.36 0.32 0.28 0.22
    #> [16] 0.20
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.83 2.18 0.79 0.68 0.62 0.61 0.54 0.49 0.44 0.43 0.36 0.32 0.28 0.23 0.21
...
#>                alpha    0.799    0.657    0.870       4    64
#>          omega_total    0.870    0.798    0.912       4    64
#>        ordinal_alpha    0.769    0.595    0.837       4    64
#>  ordinal_omega_total    0.853    0.768    0.891       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
