...
#>  $ var1: num  3 4 3 4 1 4 2 3 5 4 ...
#>  $ var2: num  2 3 3 3 2 3 4 1 3 3 ...
#>  $ var3: num  2 3 4 3 2 3 4 1 4 5 ...
...
head(df)
#>     BT       BS   BL      BLY
#> 1 4.25 4.000000 2.75 3.000000
#> 2 4.75 4.666667 4.50 5.000000
#> 3 4.00 4.000000 3.75 4.000000
#> 4 3.75 4.333333 4.00 4.333333
#> 5 3.00 3.666667 1.75 3.666667
#> 6 3.50 4.333333 3.50 4.000000
tail(df)
#>       BT       BS   BL      BLY
#> 251 4.50 4.666667 4.50 4.666667
#> 252 3.50 3.333333 3.75 3.666667
#> 253 2.50 2.333333 2.75 3.333333
#> 254 4.25 4.333333 4.50 4.666667
#> 255 4.50 4.666667 3.25 4.666667
#> 256 3.50 3.333333 2.25 3.666667
...
#>  $ X1: num  1.67 2.67 2.83 3 1.5 ...
#>  $ X2: num  2.33 2.83 4 3.67 4.83 ...
...
#>   ..$ time_1: num [1:32] 1.5 1 2 4 1.75 1.25 1.5 1.25 1.25 2.25 ...
#>   ..$ time_2: num [1:32] 3.5 1.5 2 4.5 2 1.25 2 1.5 2.5 3.25 ...
#>   ..$ time_3: num [1:32] 4.5 1 1 4 2.5 2.25 3.25 2.75 3.75 3 ...
#>   ..$ time_4: num [1:32] 3.5 2.5 1.5 2.75 2.5 2.75 3.25 2.75 4.25 4.25 ...
...
#>  $ A1_1 : num  2 2 4 2 1 3 3 1 2 2 ...
#>  $ A1_2 : num  2 1 3 3 2 3 2 2 2 1 ...
#>  $ A1_3 : num  3 2 4 3 1 4 2 3 2 3 ...
#>  $ A1_4 : num  4 3 4 4 3 3 3 4 2 3 ...
#>  $ A2_1 : num  2 2 3 2 3 3 3 2 3 2 ...
#>  $ A2_2 : num  2 2 4 3 1 3 3 1 3 2 ...
#>  $ A2_3 : num  4 3 4 3 2 3 2 2 3 2 ...
#>  $ A2_4 : num  2 2 4 4 2 3 4 3 4 2 ...
#>  $ A2_5 : num  3 2 4 5 3 3 4 2 3 3 ...
#>  $ A3_1 : num  2 2 3 3 2 2 2 3 2 2 ...
#>  $ A3_2 : num  2 3 3 3 3 3 3 2 2 2 ...
#>  $ A3_3 : num  2 3 4 2 3 3 4 3 4 1 ...
#>  $ A3_4 : num  2 3 4 4 3 3 4 3 2 2 ...
#>  $ A3_5 : num  3 4 4 4 4 4 3 4 4 3 ...
#>  $ A3_6 : num  2 4 4 4 4 4 4 4 3 2 ...
#>  $ Int_1: num  2 1 7 7 1 0 1 7 1 1 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 6.95 2.29 1.08 0.72 0.67 0.58 0.55 0.48 0.46 0.42 0.40 0.37 0.34 0.27 0.25
    #> [16] 0.18
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.79 2.25 0.84 0.72 0.58 0.57 0.53 0.47 0.43 0.41 0.37 0.34 0.28 0.25 0.18
...
#>                alpha    0.801    0.709    0.855       4    64
#>          omega_total    0.871    0.822    0.903       4    64
#>        ordinal_alpha    0.765    0.648    0.808       4    64
#>  ordinal_omega_total    0.851    0.792    0.875       4    64
#>                                                notes
#>                                 Pearson correlations
#>                                 1-factor eigen omega
#>                              Polychoric correlations
