...
#>  $ var1: num  4 2 5 3 1 3 3 1 3 2 ...
#>  $ var2: num  5 4 5 4 3 3 2 2 3 2 ...
#>  $ var3: num  5 5 5 5 1 4 2 1 3 3 ...
#>  $ var4: num  5 4 5 4 3 4 3 2 4 3 ...
...
cor(df) |> round(3)
#>       var1 var2  var3  var4
#> var1 1.000 0.25 0.355 0.448
#> var2 0.250 1.00 0.700 0.750
#> var3 0.355 0.70 1.000 0.843
...
head(df)
#>     BT       BS   BL      BLY
#> 1 4.25 4.000000 4.00 4.333333
#> 2 3.50 3.333333 2.75 4.000000
#> 3 3.75 4.333333 4.50 4.333333
#> 4 4.00 4.333333 4.50 4.666667
#> 5 4.00 4.000000 3.00 2.333333
#> 6 3.25 4.333333 4.25 4.333333
tail(df)
#>       BT       BS   BL      BLY
#> 251 4.75 4.666667 5.00 4.666667
#> 252 3.00 3.333333 3.50 4.000000
#> 253 4.25 4.333333 4.00 3.666667
#> 254 4.00 4.333333 3.75 3.666667
#> 255 4.25 4.000000 3.50 4.333333
#> 256 4.25 4.666667 3.75 4.333333
...
#>  $ X1: num  2 3.67 3.17 3.17 2.33 ...
#>  $ X2: num  2.5 3.67 3.5 3.5 4 ...
...
#>   ..$ time_1: num [1:32] 1.25 1.25 3.25 2 2.25 2.5 1 1.25 2.5 1.5 ...
#>   ..$ time_2: num [1:32] 2.25 2 4.25 3 1.5 2.25 1.25 2 2.75 1.5 ...
#>   ..$ time_3: num [1:32] 2.5 1.75 4.75 3.25 2 2.25 3 4.5 2.75 2.5 ...
#>   ..$ time_4: num [1:32] 1.75 2.5 3.75 4 3.25 1.75 2.75 4.5 3.25 3.75 ...
...
#> [4,] 0.42 0.53 0.65 1.00 0.82 0.84
...
#>  $ A1_1 : num  2 2 3 2 2 3 3 2 3 2 ...
#>  $ A1_2 : num  2 4 3 2 2 2 3 2 2 1 ...
#>  $ A1_3 : num  4 4 3 3 2 4 3 3 3 3 ...
#>  $ A1_4 : num  3 4 4 3 3 4 4 3 3 3 ...
#>  $ A2_1 : num  3 3 4 2 2 2 2 2 2 2 ...
#>  $ A2_2 : num  4 3 2 3 2 2 4 2 4 2 ...
#>  $ A2_3 : num  4 4 3 3 2 3 4 2 3 2 ...
#>  $ A2_4 : num  3 4 4 3 2 3 4 3 3 2 ...
#>  $ A2_5 : num  4 4 4 4 3 3 4 3 4 3 ...
#>  $ A3_1 : num  3 3 3 3 1 2 3 2 3 2 ...
#>  $ A3_2 : num  3 3 2 1 2 2 1 2 3 1 ...
#>  $ A3_3 : num  4 3 3 2 3 3 1 1 3 2 ...
#>  $ A3_4 : num  4 4 2 3 2 3 1 2 4 2 ...
#>  $ A3_5 : num  5 4 3 3 3 4 3 2 4 2 ...
#>  $ A3_6 : num  4 4 3 3 3 4 2 2 4 2 ...
#>  $ Int_1: num  0 7 8 3 0 2 1 0 0 3 ...
```
...
![](LikertMakeR_vignette_files/figure-html/fig7-1.png)
    ...
    #>  [1] 7.03 2.37 1.18 0.95 0.84 0.70 0.57 0.50 0.39 0.34 0.33 0.24 0.19 0.15 0.13
    #> [16] 0.09
...
![](LikertMakeR_vignette_files/figure-html/fig7a-1.png)
    ...
    #>  [1] 6.87 2.34 1.04 0.85 0.75 0.70 0.55 0.40 0.37 0.33 0.24 0.19 0.15 0.13 0.09
