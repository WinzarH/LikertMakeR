...
#>  $ Q1: num  3 3 1 2 2 4 2 1 2 1 ...
#>  $ Q2: num  4 3 4 2 2 4 2 1 4 4 ...
#>  $ Q3: num  2 2 5 1 1 5 3 2 5 1 ...
#>  $ Q4: num  4 3 4 3 2 5 3 3 4 3 ...
...
cor(df1) |> round(3)
#>       Q1    Q2    Q3    Q4
#> Q1 1.000 0.250 0.386 0.530
#> Q2 0.250 1.000 0.514 0.707
...
#>  $ JS : num  3.75 4.75 2.75 3.75 3.25 2.5 4.5 3.75 3.75 3.25 ...
#>  $ OC : num  3 4.25 2 3.5 3 1.25 4 3.75 3.5 3.5 ...
#>  $ PSS: num  3.33 3.33 3 3 2.33 ...
#>  $ WE : num  4 4 3 3.33 4 ...
#>  $ TI : num  2.67 1 4 2.67 2.33 ...
...
cor(df2) |> round(3)
#>         JS     OC   PSS     WE     TI
#> JS   1.000  0.721  0.58  0.649 -0.549
#> OC   0.721  1.000  0.54  0.600 -0.601
#> PSS  0.580  0.540  1.00  0.570 -0.450
#> WE   0.649  0.600  0.57  1.000 -0.501
#> TI  -0.549 -0.601 -0.45 -0.501  1.000
```
