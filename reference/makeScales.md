...
#>  $ Q1: num  2 3 4 1 2 4 4 1 2 3 ...
#>  $ Q2: num  3 4 2 2 3 4 2 1 4 4 ...
#>  $ Q3: num  1 4 5 3 2 5 1 2 5 3 ...
#>  $ Q4: num  3 4 4 3 3 5 3 3 4 4 ...
...
#>  $ JS : num  4.5 3.5 2.5 3.5 3.5 3.25 4.25 3.5 4.5 4.5 ...
#>  $ OC : num  3.75 3.25 3.75 3.25 2.5 3.5 3.25 3.75 3.5 4 ...
#>  $ PSS: num  3.33 3.33 3 3 2.33 ...
#>  $ WE : num  4.33 4 3.33 3.67 3.33 ...
#>  $ TI : num  1.67 1.67 4 1 2.67 ...
...
cor(df2) |> round(3)
#>         JS     OC   PSS     WE     TI
#> JS   1.000  0.718  0.58  0.650 -0.550
#> OC   0.718  1.000  0.54  0.600 -0.599
#> PSS  0.580  0.540  1.00  0.570 -0.450
#> WE   0.650  0.600  0.57  1.000 -0.499
#> TI  -0.550 -0.599 -0.45 -0.499  1.000
```
