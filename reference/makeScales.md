...
#>  $ Q1: num  1 3 3 2 2 4 3 2 3 1 ...
#>  $ Q2: num  4 4 4 1 2 4 3 2 4 2 ...
#>  $ Q3: num  3 4 5 1 2 5 1 2 5 3 ...
#>  $ Q4: num  4 4 4 2 3 5 3 3 4 3 ...
...
#>  $ JS : num  4.5 3.25 3.25 3.25 2.25 3.75 3.75 4.25 3.75 4.75 ...
#>  $ OC : num  3.5 3.5 3.5 3.25 2.25 3 3.25 3.5 4.5 4.25 ...
#>  $ PSS: num  4.67 3.67 3.67 2.67 2.33 ...
#>  $ WE : num  4 3 3.33 2.67 2.33 ...
#>  $ TI : num  2.33 2.67 3.67 2.33 3.33 ...
...
#> WE   0.65  0.600  0.57  1.000 -0.501
#> TI  -0.55 -0.599 -0.45 -0.501  1.000
```
