...
#>  $ Q1: num  4 4 4 1 2 3 2 1 3 2 ...
#>  $ Q2: num  4 4 2 2 1 4 3 2 3 3 ...
#>  $ Q3: num  5 3 4 2 2 4 1 2 3 2 ...
#>  $ Q4: num  5 4 4 3 2 4 3 3 4 3 ...
...
#>  $ JS : num  2.75 3.5 2.5 3.5 3 3.75 2.75 4.5 4.5 3 ...
#>  $ OC : num  1.25 2.25 2 2.75 1.25 3.25 3.25 4.25 3.75 3.25 ...
#>  $ PSS: num  3.67 3.67 2 3.67 2.33 ...
#>  $ WE : num  2.67 4.33 4 3.67 2.33 ...
#>  $ TI : num  3 2.33 4 1.67 2 ...
...
cor(df2) |> round(3)
#>        JS     OC    PSS     WE     TI
#> JS   1.00  0.720  0.580  0.650 -0.550
#> OC   0.72  1.000  0.539  0.600 -0.601
#> PSS  0.58  0.539  1.000  0.570 -0.450
#> WE   0.65  0.600  0.570  1.000 -0.501
#> TI  -0.55 -0.601 -0.450 -0.501  1.000
```
