...
#>  $ Q1: num  4 3 4 2 1 4 3 1 3 2 ...
#>  $ Q2: num  4 2 2 2 2 4 2 1 3 3 ...
#>  $ Q3: num  3 3 4 1 1 5 2 2 4 2 ...
...
#>  $ JS : num  3.5 4.25 2.75 4 2.5 3.5 3.5 4.5 3.5 3.75 ...
#>  $ OC : num  2.25 4.25 3 3.5 3.25 4.25 3.75 4.75 3.75 4.5 ...
#>  $ PSS: num  3 3.67 3.67 2.67 2.33 ...
...
cor(df2) |> round(3)
#>         JS     OC    PSS     WE     TI
#> JS   1.000  0.720  0.580  0.650 -0.549
#> OC   0.720  1.000  0.540  0.601 -0.600
#> PSS  0.580  0.540  1.000  0.570 -0.451
#> WE   0.650  0.601  0.570  1.000 -0.499
#> TI  -0.549 -0.600 -0.451 -0.499  1.000
```
