...
#>  $ Q1: num  3 4 4 2 2 3 2 1 1 2 ...
#>  $ Q2: num  3 3 3 4 1 4 2 2 4 4 ...
#>  $ Q3: num  3 3 5 5 1 4 3 2 2 2 ...
#>  $ Q4: num  4 4 4 4 2 4 3 3 3 3 ...
...
#>  $ JS : num  2.5 3.5 3.75 2.75 3 4 3.75 4.5 4.5 5 ...
#>  $ OC : num  2.5 3 4.25 2.75 3.25 4 4 4.5 4.5 4.25 ...
#>  $ PSS: num  3.67 2.67 3.67 3.33 2.33 ...
#>  $ WE : num  4.33 3 3.67 3.33 2.33 ...
#>  $ TI : num  2.67 1.33 2.67 1.67 3.33 ...
...
cor(df2) |> round(3)
#>         JS     OC   PSS     WE     TI
#> JS   1.000  0.719  0.58  0.650 -0.549
