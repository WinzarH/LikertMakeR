...
#>  $ Q1: num  4 4 3 3 2 3 1 2 2 1 ...
#>  $ Q2: num  2 4 4 3 2 4 3 1 2 2 ...
#>  $ Q3: num  3 5 2 2 1 5 2 3 4 2 ...
#>  $ Q4: num  4 4 4 3 2 4 3 3 3 3 ...
...
#>  $ JS : num  4.5 3.5 3 4 3.5 3.75 4.25 4.25 4.5 5 ...
#>  $ OC : num  4.25 3 3.5 4 2.75 3.75 4 4.75 3.75 4 ...
#>  $ PSS: num  4 3.33 3 3.67 2.33 ...
#>  $ WE : num  4.67 4 3 3.67 2.33 ...
#>  $ TI : num  1.33 2.33 4 1.67 2.33 ...
...
cor(df2) |> round(3)
#>         JS     OC    PSS     WE     TI
#> JS   1.000  0.720  0.580  0.649 -0.549
#> OC   0.720  1.000  0.539  0.600 -0.600
#> PSS  0.580  0.539  1.000  0.570 -0.450
#> WE   0.649  0.600  0.570  1.000 -0.501
#> TI  -0.549 -0.600 -0.450 -0.501  1.000
```
