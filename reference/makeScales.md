...
#>  $ Q1: num  4 2 1 3 1 2 2 2 3 4 ...
#>  $ Q2: num  2 2 3 3 1 4 3 4 2 3 ...
#>  $ Q3: num  3 1 1 1 1 4 1 5 4 4 ...
#>  $ Q4: num  3 3 3 3 2 4 3 4 4 4 ...
...
#>  $ JS : num  4.25 4.5 4 4 4 3.75 4.75 3.5 5 3.5 ...
#>  $ OC : num  4 4.5 4.5 4.25 3.75 4 3.75 3 4 3.25 ...
#>  $ PSS: num  3.33 5 4.33 2.67 3.67 ...
#>  $ WE : num  4.33 4 4.67 3.67 4.33 ...
#>  $ TI : num  2.33 1.67 1.33 1.67 1.33 ...
...
cor(df2) |> round(3)
#>         JS     OC    PSS     WE     TI
#> JS   1.000  0.720  0.580  0.649 -0.550
#> OC   0.720  1.000  0.540  0.600 -0.599
#> PSS  0.580  0.540  1.000  0.571 -0.450
#> WE   0.649  0.600  0.571  1.000 -0.499
#> TI  -0.550 -0.599 -0.450 -0.499  1.000
```
