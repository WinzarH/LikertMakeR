...
#>  $ Q1: num  1 1 3 3 2 4 2 4 2 4 ...
#>  $ Q2: num  3 2 2 4 1 4 2 3 2 3 ...
#>  $ Q3: num  3 4 1 4 3 5 1 4 1 5 ...
#>  $ Q4: num  3 3 3 4 3 5 2 4 3 4 ...
...
#>  $ JS : num  3.5 4 4.75 3.25 4 4.25 4.25 3.5 3.5 3.5 ...
#>  $ OC : num  3.25 4.25 4.75 3.25 3 4 4 2.5 2.5 3.5 ...
#>  $ PSS: num  4.67 3 4 4 2.67 ...
#>  $ WE : num  4 4.33 4 3.33 4.33 ...
#>  $ TI : num  3 2.67 1.33 2 1.33 ...
...
cor(df2) |> round(3)
#>         JS     OC    PSS     WE     TI
#> JS   1.000  0.720  0.580  0.649 -0.551
#> OC   0.720  1.000  0.541  0.600 -0.600
#> PSS  0.580  0.541  1.000  0.571 -0.450
#> WE   0.649  0.600  0.571  1.000 -0.501
#> TI  -0.551 -0.600 -0.450 -0.501  1.000
```
