...
#>  $ Q1: num  2 3 3 3 2 4 2 2 1 3 ...
#>  $ Q2: num  3 2 2 4 1 4 3 5 3 4 ...
#>  $ Q3: num  1 1 1 4 1 5 3 3 1 4 ...
#>  $ Q4: num  3 3 3 4 2 5 3 4 3 4 ...
...
#>  $ JS : num  4 4 4.25 4.75 4.5 3.5 4.25 2.5 5 3.25 ...
#>  $ OC : num  4.5 3.25 4.5 4.25 4.25 3.75 4 2.5 4 2.75 ...
#>  $ PSS: num  3.67 3.67 4 4.67 4.67 ...
#>  $ WE : num  4.33 3.67 4 4.67 4.33 ...
#>  $ TI : num  1.67 2.67 1.67 1.33 1.33 ...
...
cor(df2) |> round(3)
#>         JS    OC    PSS     WE     TI
#> JS   1.000  0.72  0.580  0.649 -0.550
#> OC   0.720  1.00  0.540  0.600 -0.600
#> PSS  0.580  0.54  1.000  0.571 -0.450
#> WE   0.649  0.60  0.571  1.000 -0.501
#> TI  -0.550 -0.60 -0.450 -0.501  1.000
```
