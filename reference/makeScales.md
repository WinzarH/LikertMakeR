...
#>  $ Q1: num  2 3 2 1 1 3 2 4 4 3 ...
#>  $ Q2: num  4 4 3 2 2 4 2 1 4 2 ...
#>  $ Q3: num  4 4 1 1 2 3 1 3 2 2 ...
#>  $ Q4: num  4 4 3 2 3 4 3 3 4 3 ...
...
#>  $ JS : num  3 2.25 2.5 3.25 3 4 3.5 4.5 4.25 4.5 ...
#>  $ OC : num  2.25 3.25 3.25 4.25 3 4 4.75 4.25 4.5 4.25 ...
#>  $ PSS: num  3.67 3.67 3 3.67 2.33 ...
#>  $ WE : num  3.33 3.67 4 4.33 2.33 ...
#>  $ TI : num  3.33 2 4 1 2.67 ...
...
cor(df2) |> round(3)
#>         JS     OC   PSS     WE     TI
#> JS   1.000  0.719  0.58  0.650 -0.550
#> OC   0.719  1.000  0.54  0.600 -0.600
#> PSS  0.580  0.540  1.00  0.570 -0.450
#> WE   0.650  0.600  0.57  1.000 -0.499
#> TI  -0.550 -0.600 -0.45 -0.499  1.000
```
