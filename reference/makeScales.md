...
#>  $ Q1: num  1 4 4 1 2 3 1 3 3 3 ...
#>  $ Q2: num  2 3 2 3 1 4 2 4 3 3 ...
#>  $ Q3: num  3 4 1 1 3 4 1 4 4 5 ...
#>  $ Q4: num  3 4 3 3 3 5 2 4 4 4 ...
...
#>  $ JS : num  2.5 3.5 4.75 4 4.75 3 3.5 2.75 3.75 4.25 ...
#>  $ OC : num  3.25 2.75 4.75 4.25 4.25 3.25 3.25 2.5 4 4 ...
#>  $ PSS: num  3.33 3.67 4 3.33 5 ...
#>  $ WE : num  4 3.67 4.33 3.67 4.67 ...
#>  $ TI : num  2 2.67 2 2.33 1.67 ...
...
cor(df2) |> round(3)
#>         JS     OC    PSS     WE     TI
#> JS   1.000  0.719  0.580  0.649 -0.550
#> OC   0.719  1.000  0.540  0.600 -0.601
#> PSS  0.580  0.540  1.000  0.571 -0.450
#> WE   0.649  0.600  0.571  1.000 -0.499
#> TI  -0.550 -0.601 -0.450 -0.499  1.000
```
