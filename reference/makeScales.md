...
#>  $ Q1: num  2 3 4 2 2 3 1 2 4 1 ...
#>  $ Q2: num  4 4 4 2 2 4 1 3 4 2 ...
#>  $ Q3: num  3 4 4 1 1 5 1 2 2 2 ...
#>  $ Q4: num  4 4 4 3 3 5 2 3 4 3 ...
...
#>  $ JS : num  3.25 3.75 2.5 2.75 3.25 3.5 5 3.25 4.5 4 ...
#>  $ OC : num  2.25 3.5 2 2.5 3.25 3.75 4.25 3 4.5 4.75 ...
#>  $ PSS: num  3.33 3.33 3 2 2.33 ...
#>  $ WE : num  3.33 4 3.67 3 2.33 ...
#>  $ TI : num  3.33 1.33 3.33 4 2 ...
...
cor(df2) |> round(3)
#>         JS     OC    PSS     WE     TI
#> JS   1.000  0.720  0.579  0.650 -0.550
#> OC   0.720  1.000  0.540  0.598 -0.600
#> PSS  0.579  0.540  1.000  0.570 -0.450
#> WE   0.650  0.598  0.570  1.000 -0.501
#> TI  -0.550 -0.600 -0.450 -0.501  1.000
```
