...
#>  $ Q1: num  2 3 3 2 1 4 2 4 1 2 ...
#>  $ Q2: num  3 2 3 4 2 4 3 3 1 3 ...
#>  $ Q3: num  1 3 1 4 1 5 3 4 1 4 ...
...
#>  $ JS : num  4.25 4 4.75 3 4 3.25 4.75 3 3.5 3.5 ...
#>  $ OC : num  4.5 3.5 5 3.25 4.25 3 4.25 2.75 4.25 3.25 ...
#>  $ PSS: num  4.33 3.67 4.33 3.33 4 ...
#>  $ WE : num  3.67 4.33 4.67 3.67 4.67 ...
#>  $ TI : num  1.33 2 1.33 2 2.67 ...
...
cor(df2) |> round(3)
#>         JS     OC    PSS     WE     TI
#> JS   1.000  0.720  0.580  0.651 -0.549
#> OC   0.720  1.000  0.540  0.600 -0.601
#> PSS  0.580  0.540  1.000  0.571 -0.450
#> WE   0.651  0.600  0.571  1.000 -0.499
#> TI  -0.549 -0.601 -0.450 -0.499  1.000
```
