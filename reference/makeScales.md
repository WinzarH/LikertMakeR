...
#>  $ Q1: num  2 3 2 1 1 4 3 2 2 4 ...
#>  $ Q2: num  3 3 2 4 2 4 1 3 2 3 ...
#>  $ Q3: num  1 4 1 1 3 4 1 4 1 5 ...
#>  $ Q4: num  3 4 2 3 3 4 3 4 3 4 ...
...
#>  $ JS : num  3.25 2 4.75 4.75 4.5 3.5 4.5 2.5 3.25 4.25 ...
#>  $ OC : num  3.25 2.25 4.5 3.75 4.75 2.75 4.5 3.5 3.5 3.75 ...
#>  $ PSS: num  2.67 3.33 4 4.67 5 ...
#>  $ WE : num  3.67 3.67 4.33 4.33 4.33 ...
#>  $ TI : num  3 3 2.33 2 1.33 ...
...
cor(df2) |> round(3)
#>         JS     OC    PSS     WE     TI
#> JS   1.000  0.720  0.580  0.651 -0.550
#> OC   0.720  1.000  0.540  0.601 -0.601
#> PSS  0.580  0.540  1.000  0.571 -0.451
#> WE   0.651  0.601  0.571  1.000 -0.499
#> TI  -0.550 -0.601 -0.451 -0.499  1.000
```
