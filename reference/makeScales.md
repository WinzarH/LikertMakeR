...
#>  $ Q1: num  2 1 1 3 1 4 2 3 4 2 ...
#>  $ Q2: num  3 3 4 3 1 5 2 3 2 2 ...
#>  $ Q3: num  3 3 1 4 1 4 1 4 1 4 ...
#>  $ Q4: num  4 3 3 4 2 5 3 4 3 3 ...
...
#>  $ JS : num  3.25 3.25 3.75 4.75 4.5 4 4.25 3 3.25 4.5 ...
#>  $ OC : num  3 3.5 3.5 4.25 4.25 3 4.25 2.75 4 4.5 ...
#>  $ PSS: num  2.33 3.67 3.67 4 3.67 ...
#>  $ WE : num  3 3.67 4.67 4.33 4.33 ...
#>  $ TI : num  3 2.33 1.67 1.33 1.33 ...
...
cor(df2) |> round(3)
#>         JS     OC    PSS     WE     TI
#> JS   1.000  0.721  0.580  0.651 -0.550
#> OC   0.721  1.000  0.540  0.600 -0.600
#> PSS  0.580  0.540  1.000  0.571 -0.451
#> WE   0.651  0.600  0.571  1.000 -0.501
#> TI  -0.550 -0.600 -0.451 -0.501  1.000
```
