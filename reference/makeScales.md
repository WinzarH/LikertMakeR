...
#>  $ Q1: num  1 4 2 1 1 3 3 3 2 4 ...
#>  $ Q2: num  3 3 2 3 1 3 4 2 3 4 ...
#>  $ Q3: num  1 4 3 4 1 3 1 1 1 5 ...
#>  $ Q4: num  3 4 3 4 2 4 3 3 3 5 ...
...
#>  $ JS : num  3.5 3.25 4.75 4.75 4.75 4.25 2.5 4.25 4 4.25 ...
#>  $ OC : num  2.75 3.5 4.75 4 4.75 4.25 3.5 4 4 4.5 ...
#>  $ PSS: num  3 2.33 4 4.33 4.33 ...
#>  $ WE : num  3 3.33 4.33 4.33 4.33 ...
#>  $ TI : num  3 2.67 1 1.33 1.33 ...
...
cor(df2) |> round(3)
#>         JS    OC    PSS     WE     TI
#> JS   1.000  0.72  0.580  0.651 -0.551
#> OC   0.720  1.00  0.540  0.600 -0.600
#> PSS  0.580  0.54  1.000  0.571 -0.450
#> WE   0.651  0.60  0.571  1.000 -0.499
#> TI  -0.551 -0.60 -0.450 -0.499  1.000
```
