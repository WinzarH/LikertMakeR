...
#>  $ Q1: num  3 4 3 3 2 3 2 1 1 4 ...
#>  $ Q2: num  4 3 3 4 2 4 4 1 4 2 ...
#>  $ Q3: num  4 5 3 2 1 5 5 1 1 3 ...
#>  $ Q4: num  4 4 4 3 3 5 4 2 3 3 ...
...
cor(df1) |> round(3)
#>       Q1    Q2    Q3    Q4
#> Q1 1.000 0.313 0.429 0.530
#> Q2 0.313 1.000 0.472 0.707
#> Q3 0.429 0.472 1.000 0.788
#> Q4 0.530 0.707 0.788 1.000
...
#>  $ JS : num  3.5 3.75 2.5 3 3.5 3.5 4.25 4.5 5 4 ...
#>  $ OC : num  2.25 3.5 2 1.25 3.25 4 3.75 4.75 4 3.75 ...
#>  $ PSS: num  3.33 3.67 3 2.67 2.67 ...
#>  $ WE : num  3.67 4 3 2.67 4 ...
#>  $ TI : num  4 2.33 4 3.33 2 ...
...
cor(df2) |> round(3)
#>         JS     OC   PSS     WE     TI
#> JS   1.000  0.720  0.58  0.650 -0.549
#> OC   0.720  1.000  0.54  0.601 -0.600
#> PSS  0.580  0.540  1.00  0.570 -0.450
#> WE   0.650  0.601  0.57  1.000 -0.501
#> TI  -0.549 -0.600 -0.45 -0.501  1.000
```
