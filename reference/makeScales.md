...
#>  $ Q1: num  1 3 2 3 1 4 2 2 2 4 ...
#>  $ Q2: num  3 1 2 5 2 4 2 3 3 3 ...
#>  $ Q3: num  3 1 4 4 1 5 1 4 1 5 ...
...
#>  $ JS : num  4 2.75 4.75 4.25 4.25 3.5 4.75 4.5 3.25 4.5 ...
#>  $ OC : num  4.5 3 4.5 4.25 4.75 3.25 4.25 4.5 4.25 4.25 ...
#>  $ PSS: num  4 2 4.67 4 4.33 ...
#>  $ WE : num  4 3.67 4.67 3.67 4.33 ...
#>  $ TI : num  3 2.67 1 2.33 1.33 ...
...
cor(df2) |> round(3)
#>         JS    OC    PSS     WE     TI
#> JS   1.000  0.72  0.581  0.651 -0.550
#> OC   0.720  1.00  0.540  0.600 -0.600
#> PSS  0.581  0.54  1.000  0.571 -0.450
#> WE   0.651  0.60  0.571  1.000 -0.499
#> TI  -0.550 -0.60 -0.450 -0.499  1.000
```
