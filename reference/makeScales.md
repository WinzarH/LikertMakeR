...
#>  $ Q1: num  2 4 4 3 1 2 2 2 3 1 ...
#>  $ Q2: num  4 4 4 2 4 4 2 2 4 2 ...
#>  $ Q3: num  4 5 5 2 2 4 1 3 3 1 ...
#>  $ Q4: num  4 4 5 3 3 4 2 3 4 3 ...
...
cor(df1) |> round(3)
#>       Q1    Q2    Q3    Q4
#> Q1 1.000 0.313 0.429 0.619
#> Q2 0.313 1.000 0.557 0.707
#> Q3 0.429 0.557 1.000 0.788
...
#>  $ JS : num  3.25 3 4 3.5 2.5 3 4.25 3.75 3.5 3.25 ...
#>  $ OC : num  2.5 2.75 3.5 2.75 1.25 3.25 4.5 4 3.5 4 ...
#>  $ PSS: num  3.67 2.67 4.33 3 2.33 ...
#>  $ WE : num  4.67 3.33 4 2.67 2.33 ...
#>  $ TI : num  2.33 3 3.67 1.67 3 ...
...
cor(df2) |> round(3)
#>        JS    OC   PSS     WE     TI
#> JS   1.00  0.72  0.58  0.650 -0.550
#> OC   0.72  1.00  0.54  0.600 -0.600
#> PSS  0.58  0.54  1.00  0.570 -0.450
#> WE   0.65  0.60  0.57  1.000 -0.501
#> TI  -0.55 -0.60 -0.45 -0.501  1.000
```
