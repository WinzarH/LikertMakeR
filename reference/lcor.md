...
#> best solution in 31 iterations
#> reached maximum of 1024 iterations
#> reached maximum of 1024 iterations

cor(mydat3) |> round(3)
#>        x1     x2     x3
#> x1  1.000 -0.031 -0.241
#> x2 -0.031  1.000 -0.085
#> x3 -0.241 -0.085  1.000
...
cor(new3) |> round(3)
#>       X1    X2    X3
#> X1 1.000 0.499 0.750
#> X2 0.499 1.000 0.249
#> X3 0.750 0.249 1.000
```
