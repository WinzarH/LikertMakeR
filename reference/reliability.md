...
#>            coef_name estimate ci_lower ci_upper n_items
#>                alpha    0.799    0.714    0.866       4
#>          omega_total    0.869    0.824    0.909       4
#>        ordinal_alpha    0.765    0.653    0.822       4
#>  ordinal_omega_total    0.850    0.794    0.883       4
#>  n_obs                                               notes
#>     64                                Pearson correlations
#>     64                                1-factor eigen omega
#>     64                             Polychoric correlations
#>     64 Polychoric correlations | Ordinal CIs via bootstrap
# }
```
