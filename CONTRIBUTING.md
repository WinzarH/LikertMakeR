...
This outlines how to propose a change to LikertMakeR. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("WinzarH/LikertMakeR", fork = TRUE)`.
...
Please note that the LikertMakeR project is released with a [Contributor
Code of
Conduct](https://winzarh.github.io/LikertMakeR/CODE_OF_CONDUCT.md). By
