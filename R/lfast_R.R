...
#' @name lfast_R
#' @description \code{lfast_R()} generates random discrete values from a
...
#' \code{lfast_R()} takes repeated samples selecting a vector that best
#' fits the desired moments, while \code{lfast()} takes just one sample.
#' \code{lfast_R()} is slightly slower than \code{lfast()}.
#'
#'
...
#' )
#'
#' x <- lfast_R(256, 2, 1.8, 0, 10)
#'
lfast_R <- function(n, mean, sd, lowerbound, upperbound, items = 1) {
